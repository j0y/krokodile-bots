...
from smartbots.strategy import ExplorationStrategy, GatheringStrategy
...
class AIBrainProtocol(asyncio.DatagramProtocol):
    ...
    def __init__(self, manager: BotManager, recorder: SpatialRecorder | None) -> None:
    ...
    def datagram_received(self, data: bytes, addr: tuple[str, int]) -> None:
        ...
        # Record positions for spatial mapping
