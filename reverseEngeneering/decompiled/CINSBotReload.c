...

{
  ...
  iVar1 = unaff_EBX + 0x4107fd /* vtable for CountdownTimer+0x8 */;
  ...
  *in_stack_00000004 = iVar3 + 8;
  pcVar2 = (code *)(unaff_EBX + -0x4e724b /* CountdownTimer::NetworkStateChanged */);
...

{
  ...
  if ((*(int *)(in_stack_0000000c + 0xb338) == -1) ||
    ...
    piVar5 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x974 /* CINSNextBot::GetVisionInterface */))(in_stack_0000000c,uVar7);
...

{
  ...
  if (cVar1 != '\0') {
    ...
    if ((*(float *)(unaff_EBX + 0x1fc0cf /* typeinfo name for CTraceFilterSkipTwoEntitiesAndCheckTeamMask+0x30 */) < (float)fVar4) &&
  ...
  if (*(float *)((int)param_2 + 0x58) <= (float)fVar4 &&
    ...
    if ((cVar1 == '\0') || (cVar1 = CINSPlayer::IsCrouched(this_03), cVar1 == '\0')) {
      ...
      if (iVar3 == 0) {
        (**(code **)(*in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_0000000c);
        CINSBotBody::SetPosture();
      }
      else {
        (**(code **)(*in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))();
        CINSBotBody::SetPosture();
      }
    }
    fVar4 = (float10)CountdownTimer::Now();
    fVar5 = (float)fVar4 + *(float *)(unaff_EBX + 0x1f8dab /* typeinfo name for ISaveRestoreOps+0x67 */);
...

{
  ...
  return extraout_ECX + 0x25679b /* "Reloading" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x46cd63 /* vtable for CINSBotReload+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x46cef3 /* vtable for CINSBotReload+0x198 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x47c193 /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46cd1a /* vtable for CINSBotReload+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x46ceaa /* vtable for CINSBotReload+0x198 */;
