...

{
  ...
  *(undefined1 *)(iVar3 + 0x38) = *(undefined1 *)((int)in_stack_0000000c + 0x228f);
  piVar1 = *(int **)(unaff_EBX + 0x469e77 /* &g_pGameRules */);
  ...
  if (**(int **)(unaff_EBX + 0x46a2cd /* &g_pGameRules */) != 0) {
    ...
    if (iVar3 == iVar4) {
      ...
      if (cVar1 == '\0') {
        ...
        *(undefined4 *)((int)param_2 + 0x28) = 0;
        *(undefined4 *)((int)param_2 + 0x2c) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x246117 /* "Patrolling the world" */;
        return param_1;
      }
    }
    else {
...
LAB_0073c706:
      ...
      iVar4 = 1;
      iVar3 = **(int **)(unaff_EBX + 0x46a6f1 /* &g_pObjectiveResource */);
...

{
  ...
  return extraout_ECX + 0x1f60c0 /* "Survival" */;
}
  ...
  if (in_stack_00000008 != (int *)0x0) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        fVar6 = ((float)*(int *)(**(int **)(unaff_EBX + 0x469c64 /* &g_pGameRules */) + 1000) +
                *(float *)(unaff_EBX + 0x17be7c /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x30 */)) * *(float *)(unaff_EBX + 0x1f6eac /* typeinfo name for CINSRules_Survival+0x20 */);
        if (*(float *)(unaff_EBX + 0x17be80 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x34 */) <= fVar6) {
          fVar6 = *(float *)(unaff_EBX + 0x17be80 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x34 */);
        }
        if (fVar6 <= *(float *)(unaff_EBX + 0x17be74 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x28 */)) {
          fVar6 = *(float *)(unaff_EBX + 0x17be74 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x28 */);
        }
        cVar4 = ((float)fVar5 <=
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45d7b3 /* vtable for CINSBotActionSurvival+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x45d94b /* vtable for CINSBotActionSurvival+0x1a0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46a363 /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45d76a /* vtable for CINSBotActionSurvival+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x45d902 /* vtable for CINSBotActionSurvival+0x1a0 */;
