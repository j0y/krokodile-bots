...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x481c3d /* vtable for CINSBotCaptureFlag+0x8 */ /* vtable for CINSBotCaptureFlag+0x8 */;
  *(int *)(param_1 + 4) = unaff_EBX + 0x481dd1 /* vtable for CINSBotCaptureFlag+0x19c */ /* vtable for CINSBotCaptureFlag+0x19c */;
  ...
  *(undefined4 *)(param_1 + 0x34) = 0;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4e3e5b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
  *(undefined4 *)(param_1 + 0x48b0) = 0;
  iVar2 = unaff_EBX + 0x413bed /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
  ...
  *(undefined4 *)(param_1 + 0x48b4) = 0xbf800000 /* -1.0f */;
  ...
  iVar4 = *(int *)(unaff_EBX + 0x492685 /* &vtable for IntervalTimer */ /* &vtable for IntervalTimer */);
  ...
  *(int *)(param_1 + 0x38) = in_stack_0000000c;
  puVar3 = (undefined4 *)(unaff_EBX + 0x5d7d55 /* CINSBotCaptureFlag::m_pCapturer */ /* CINSBotCaptureFlag::m_pCapturer */ + in_stack_0000000c * 4);
  if (param_2 != 0) {
...

{
  ...
  if (1 < iVar5 - 2U) {
    ...
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x26bc62 /* "Bot is not on a playteam" */ /* "Bot is not on a playteam" */;
    return param_1;
  }
  ...
  if ((in_stack_0000000c != pCVar6) && (bVar8)) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x26be04 /* "Flag carrier that wasn't us? Bailing." */ /* "Flag carrier that wasn't us? Bailing." */;
    return param_1;
  }
  ...
  *(bool *)((int)param_2 + 0x48c4) = bVar8;
  ...
  fVar10 = *(float *)(unaff_EBX + 0x214858 /* -0.01f */ /* -0.01f */);
  *(float *)((int)param_2 + 0x48b8) = local_58;
  *(float *)((int)param_2 + 0x48bc) = local_54;
  *(float *)((int)param_2 + 0x48c0) = local_50;
  if (((((fVar10 < local_58) && (fVar1 = *(float *)(unaff_EBX + 0x2106bc /* 0.01f */ /* 0.01f */), local_58 < fVar1)) &&
  ...
  if (*(char *)((int)param_2 + 0x48c4) == '\0') {
    if ((*(char *)((int)param_2 + 0x48c5) != '\0') &&
       ...
       *(float *)(unaff_EBX + 0x238570 /* 70.0f */ /* 70.0f */))) {
      piVar7 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_0000000c);
      (**(code **)(*piVar7 + 0xd4 /* PlayerBody::AimHeadTowards */))(piVar7,local_60,5,0x3f800000 /* 1.0f */,0,unaff_EBX + 0x26bdec /* "Look at object to use" */ /* "Look at object to use" */);
      ...
      if ((*(float *)((int)param_2 + 0x48fc) <= (float)fVar9 &&
         ...
         *(float *)(unaff_EBX + 0x210694 /* 0.7f */ /* 0.7f */) <= fVar10 && fVar10 != *(float *)(unaff_EBX + 0x210694 /* 0.7f */ /* 0.7f */)))
      {
        (**(code **)(*(int *)in_stack_0000000c + 0x8d8 /* NextBotPlayer::PressUseButton */))(in_stack_0000000c,0x3f000000 /* 0.5f */);
        fVar9 = (float10)CountdownTimer::Now();
        fVar10 = (float)fVar9 + *(float *)(unaff_EBX + 0x1a41a0 /* 1.0f */ /* 1.0f */);
...

{
  ...
  *(undefined4 *)(extraout_ECX + 0x5d7e0b /* CINSBotCaptureFlag::m_pCapturer */ /* CINSBotCaptureFlag::m_pCapturer */ + *(int *)(param_1 + 0x38) * 4) = 0xffffffff;
  *(undefined4 *)(extraout_ECX + 0x5d7e0b /* CINSBotCaptureFlag::m_pCapturer */ /* CINSBotCaptureFlag::m_pCapturer */ + *(int *)(param_1 + 0x38) * 4) = 0xffffffff;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  return extraout_ECX + 0x26b82b /* "Capturing Flag" */ /* "Capturing Flag" */;
}
...

{
  ...
  if (*(char *)(in_stack_00000008 + 0x48c4) != '\0') {
    iVar2 = (uint)(*(int *)(in_stack_00000008 + 0x38) == 0) * 0xc + **(int **)(unaff_EBX + 0x492492 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */)
    ;
  ...
  uVar1 = *(uint *)(**(int **)(unaff_EBX + 0x492492 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x7cc +
  ...
  puVar4 = *(undefined4 **)(unaff_EBX + 0x491d42 /* &vec3_origin */ /* &vec3_origin */);
LAB_00714936:
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4812ba /* vtable for CINSBotCaptureFlag+0x8 */ /* vtable for CINSBotCaptureFlag+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x48144e /* vtable for CINSBotCaptureFlag+0x19c */ /* vtable for CINSBotCaptureFlag+0x19c */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48124a /* vtable for CINSBotCaptureFlag+0x8 */ /* vtable for CINSBotCaptureFlag+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4813de /* vtable for CINSBotCaptureFlag+0x19c */ /* vtable for CINSBotCaptureFlag+0x19c */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
