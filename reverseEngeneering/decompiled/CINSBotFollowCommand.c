...

{
  ...
  param_2[9] = 0;
  param_2[10] = 0;
  *param_2 = unaff_EBX + 0x476c4a;
  param_2[1] = unaff_EBX + 0x476dda;
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x261067;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x476b43;
  in_stack_00000004[1] = extraout_ECX + 0x476cd3;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x486d13));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x476afa;
  in_stack_00000004[1] = unaff_EBX + 0x476c8a;
