...

{
  ...
  if (iVar5 != 0) {
    ...
    if (iVar5 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x246f52;
      return param_1;
    }
  }
  ...
  if (cVar3 == '\0') {
    ...
    if (cVar3 != '\0') {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x248ae3;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    if (1 < iVar5 - 2U) {
      ...
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x246f6b;
      return param_1;
    }
    uVar16 = 0;
    fVar12 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                (this_04,(float)in_stack_0000000c,0x41f00000);
    *(bool *)((int)param_2 + 0x38) = (float)fVar12 < *(float *)(unaff_EBX + 0x1ea421);
    iVar8 = GetTargetObjective((CINSNextBot *)param_2);
    bVar11 = *(int *)(**(int **)(unaff_EBX + 0x46d6b1) + 0x6f0 + iVar8 * 4) == 5;
    if (*(char *)((int)param_2 + 0x38) == '\0') {
      if (!bVar11) {
        uVar2 = *(uint *)(*(int *)(unaff_EBX + 0x46d231) + iVar8 * 4);
        if ((((uVar2 == 0xffffffff) ||
             (iVar1 = **(int **)(unaff_EBX + 0x46d16d) + (uVar2 & 0xffff) * 0x18,
             *(uint *)(iVar1 + 8) != uVar2 >> 0x10)) || (*(int *)(iVar1 + 4) == 0)) ||
           (*(int *)(*(int *)(unaff_EBX + 0x46d231) + iVar8 * 4) == -1)) {
          ...
          *(undefined4 *)((int)param_2 + 0x28) = 0;
          *(undefined4 *)((int)param_2 + 0x2c) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x248d48;
          return param_1;
        }
        iVar5 = (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x46d28d) + 0x334))
                          ((int *)**(undefined4 **)(unaff_EBX + 0x46d28d),iVar5,uVar16);
        if (iVar5 != 0) {
          ...
          if (*(float *)(unaff_EBX + 0x1ed749) <= fVar13 &&
              fVar13 != *(float *)(unaff_EBX + 0x1ed749)) {
            CINSNextBot::UpdateChasePath(pCVar10,in_stack_0000000c);
            goto LAB_007396dd;
          }
        }
      }
      iVar5 = CINSNavMesh::GetRandomControlPointArea(**(int **)(unaff_EBX + 0x46d04d));
      if (iVar5 != 0) {
      ...
      piVar4 = *(int **)(unaff_EBX + 0x46d04d);
      if (bVar11) {
        iVar5 = CINSNavMesh::GetRandomControlPointArea(*piVar4);
        if (iVar5 == 0) {
          Warning(unaff_EBX + 0x248d61,iVar8 == 0);
        }
        else {
          CNavArea::GetRandomPoint();
    ...
    Warning(unaff_EBX + 0x248d61,iVar8);
  }
LAB_007396dd:
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45fed3;
  in_stack_00000004[1] = extraout_ECX + 0x460067;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46d5e3));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45fe8a;
  in_stack_00000004[1] = unaff_EBX + 0x46001e;
