...

{
  ...
  if (*(float *)((int)param_2 + 0x40) <= (float)fVar14 &&
    ...
    if (bVar13) {
      ...
      if (*(float *)(unaff_EBX + 0x1f1f71) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x1f1f71)) {
...
LAB_0074218d:
      ...
      if (*(float *)(unaff_EBX + 0x23fad9) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x23fad9)) {
        pVVar10 = local_28;
        cVar3 = CINSBotFireRPG::HasRPGTarget((CINSNextBot *)in_stack_0000000c,pVVar10);
        if (cVar3 != '\0') {
          piVar6 = (int *)(*(int **)(unaff_EBX + 0x464ce5))[7];
          if (piVar6 == *(int **)(unaff_EBX + 0x464ce5)) {
          ...
          if ((float)fVar14 + local_50 < *pfVar1 || (float)fVar14 + local_50 == *pfVar1) {
            ...
            *(int *)(param_1 + 8) = unaff_EBX + 0x240dda;
            return param_1;
          }
        }
      }
...
LAB_00741c53:
      ...
      if (cVar3 != '\0') {
        ...
        *(undefined4 *)param_1 = 2;
        *(void **)(param_1 + 4) = pvVar11;
        *(int *)(param_1 + 8) = unaff_EBX + 0x240dc6;
        return param_1;
      }
      if (bVar13) goto LAB_0074218d;
    }
    cVar3 = (**(code **)(*(int *)in_stack_0000000c + 0x8ac))(in_stack_0000000c,pVVar10);
    if (cVar3 == '\0') {
      fVar14 = (float10)CountdownTimer::Now();
      this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x1e2b95));
      ...
      if (*(int *)((int)param_2 + 0x3c) != 0x40800000) {
        (**(code **)(*(int *)((int)param_2 + 0x38) + 4))(iVar9,(int)param_2 + 0x3c);
        *(undefined4 *)((int)param_2 + 0x3c) = 0x40800000;
        this_08 = extraout_ECX_04;
      }
    }
    else {
      fVar14 = (float10)CountdownTimer::Now();
      this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x176f49));
      if (*(CINSNextBot **)((int)param_2 + 0x40) != this_08) {
        (**(code **)(*(int *)((int)param_2 + 0x38) + 4))(iVar9,(int)param_2 + 0x40);
        *(CINSNextBot **)((int)param_2 + 0x40) = this_08;
...
LAB_00741d1f:
    *(undefined4 *)((int)param_2 + 0x94) = 0xffffffff;
    ...
    if (*(float *)((int)param_2 + 0x7c) <= (float)fVar14 &&
      ...
      if (cVar3 != '\0') {
        uVar7 = (**(code **)(*piVar5 + 0x10))(piVar5);
        pCVar8 = (CBaseEntity *)(**(code **)(*(int *)in_stack_0000000c + 0x974))(in_stack_0000000c);
        ...
        if (((iVar9 != *(int *)((int)param_2 + 0x94)) && (bVar13)) &&
          ...
          piVar5 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x97c))(in_stack_0000000c,uVar7);
          iVar12 = (**(code **)(*piVar5 + 0xcc))(piVar5,in_stack_0000000c + 0x2060);
          if (iVar12 != 1) {
        ...
        fVar14 = (float10)CountdownTimer::Now();
        this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x1e25e5));
        ...
        if (*(int *)((int)param_2 + 0x78) != 0x41200000) {
          (**(code **)(*(int *)((int)param_2 + 0x74) + 4))((int)param_2 + 0x74,(int)param_2 + 0x78);
          *(undefined4 *)((int)param_2 + 0x78) = 0x41200000;
  ...
  if (((!bVar13) && (cVar3 = CINSNextBot::ShouldReload(this_08), cVar3 != '\0')) &&
     ((cVar3 = (**(code **)(*piVar4 + 0x658))(piVar4), cVar3 != '\0' &&
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar12 = *(int *)(unaff_EBX + 0x464e2d);
    piVar4[0xf] = 0;
    piVar4[1] = iVar12 + 0x198;
    iVar9 = unaff_EBX + 0x3e65ed;
    *piVar4 = iVar12 + 8;
    pcVar2 = (code *)(unaff_EBX + -0x51145b);
    piVar4[0xe] = iVar9;
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x240de9;
    return param_1;
  }
  fVar14 = (float10)CountdownTimer::Now();
  if (*(float *)((int)param_2 + 0x90) <= (float)fVar14 &&
    ...
    fVar14 = (float10)CountdownTimer::Now();
    fVar15 = (float)fVar14 + *(float *)(unaff_EBX + 0x1e2b8d);
    ...
    if (*(int *)((int)param_2 + 0x8c) != 0x3f000000) {
      (**(code **)(*(int *)((int)param_2 + 0x88) + 4))((int)param_2 + 0x88,(int)param_2 + 0x8c);
      *(undefined4 *)((int)param_2 + 0x8c) = 0x3f000000;
    }
  }
LAB_00741de8:
  *(undefined4 *)param_1 = 0;
...

{
  ...
  if ((*(uint *)(local_38 + (uVar4 & 0xffff) * 0x18 + 8) == uVar4 >> 0x10) &&
    ...
    if (cVar3 != '\0') {
      ...
      if (iVar5 == iVar6) {
        piVar7 = (int *)(**(code **)(*in_stack_0000000c + 0x974))(in_stack_0000000c);
        uVar4 = *(uint *)(in_stack_00000010 + 0x28);
        iVar5 = 0;
        if ((uVar4 != 0xffffffff) &&
    ...
    if (iVar5 != iVar6) {
      if ((*(byte *)(in_stack_00000010 + 0x3c) & 8) != 0) {
        ...
        if (((uVar4 != 0xffffffff) &&
          ...
          (**(code **)(*piVar7 + 0xe8))(piVar7,local_3c);
        }
        pvVar8 = ::operator_new(100);
        CINSBotRetreatToCover::CINSBotRetreatToCover(this_01,SUB41(pvVar8,0),0.0);
        *(undefined4 *)param_1 = 2;
        *(int *)(param_1 + 8) = unaff_EBX + 0x241e31;
        *(void **)(param_1 + 4) = pvVar8;
        *(undefined4 *)(param_1 + 0xc) = 2;
        return param_1;
      }
      piVar7 = (int *)(**(code **)(*in_stack_0000000c + 0x974))(in_stack_0000000c);
      iVar5 = (**(code **)(*piVar7 + 0xd0))(piVar7,0);
      if ((iVar5 != 0) ||
         (cVar3 = (**(code **)(*in_stack_0000000c + 0x8ac))(in_stack_0000000c), cVar3 != '\0')) {
        uVar4 = *(uint *)(in_stack_00000010 + 0x28);
        ...
        if (*(float *)(unaff_EBX + 0x20b091) <= fVar10 * fVar10 + fVar12 * fVar12 + fVar11 * fVar11)
        {
          piVar7 = (int *)(**(code **)(*in_stack_0000000c + 0x974))(in_stack_0000000c);
          local_34 = 0;
          uVar4 = *(uint *)(in_stack_00000010 + 0x28);
          ...
          cVar3 = (**(code **)(*piVar7 + 0x104))(piVar7,local_34,1,0);
      ...
      (**(code **)(*piVar7 + 0xe8))(piVar7,local_34);
      ...
      (*pcVar2)(piVar7,local_28,3,0x3f800000,0,unaff_EBX + 0x241e51);
    }
  }
LAB_00740fb0:
  *(undefined4 *)param_1 = 0;
...

{
  ...
  if (((cVar1 == '\0') && (iVar2 = __dynamic_cast(), iVar2 != 0)) &&
     ...
     *(float *)(unaff_EBX + 0x1780b4) <= (float)fVar4 &&
     (float)fVar4 != *(float *)(unaff_EBX + 0x1780b4))) {
    this_00 = this;
    ...
    if (SQRT(fVar5 * fVar5 + fVar7 * fVar7 + fVar6 * fVar6) < (float)fVar4) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x241f1d;
      *(undefined4 *)(param_1 + 0xc) = 1;
      return param_1;
    }
  }
...

{
  ...
  piVar1 = (int *)(**(code **)(*piVar1 + 0xd0))(piVar1,0);
  if (piVar1 != (int *)0x0) {
...

{
  ...
  if ((in_stack_00000010 != (CBaseEntity *)0x0) && (param_3 != (CBaseCombatWeapon *)0x0)) {
    ...
    if (cVar2 != '\0') {
      ...
      if (iVar4 == iVar5) {
        piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        iVar4 = 0;
        if (*(int *)(in_stack_00000010 + 0x20) != 0) {
          iVar4 = *(int *)(in_stack_00000010 + 0x20) -
                  *(int *)(**(int **)(unaff_EBX + 0x466165) + 0x5c) >> 4;
        }
        (**(code **)(*piVar3 + 0xec))(piVar3,iVar4);
      }
    }
    piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
    piVar3 = (int *)(**(code **)(*piVar3 + 0xd0))(piVar3,1);
    ...
    if (piVar3 != (int *)0x0) {
      ...
      if (cVar2 != '\0') {
        piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        (**(code **)(*piVar3 + 0xe8))(piVar3,in_stack_00000010);
        *(undefined4 *)param_1 = 0;
        *(undefined4 *)(param_1 + 4) = 0;
        *(undefined4 *)(param_1 + 8) = 0;
        *(undefined4 *)(param_1 + 0xc) = 1;
    ...
    iVar4 = (**(code **)(*(int *)param_3 + 0x548))(param_3);
    if (iVar4 != 0) {
      iVar4 = (**(code **)(*(int *)in_stack_00000010 + 0x548))(in_stack_00000010);
      if (iVar4 != 0) {
        piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x548))(param_3);
        pcVar1 = *(code **)(*piVar3 + 0x84);
        uVar6 = (**(code **)(*(int *)in_stack_00000010 + 0x548))(in_stack_00000010);
    ...
    cVar2 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3);
    if (cVar2 == '\0') {
      piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
      cVar2 = (**(code **)(*piVar3 + 0x104))(piVar3,in_stack_00000010,1,0);
      if (cVar2 != '\0') {
        piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
        pcVar1 = *(code **)(*piVar3 + 0xd4);
        if (((byte)in_stack_00000010[0xd1] & 8) != 0) {
          CBaseEntity::CalcAbsolutePosition(this_02);
        }
        CINSNextBot::GetViewPosition(local_28);
        (*pcVar1)(piVar3,local_28,3,0x3f400000,0,unaff_EBX + 0x24221f);
      }
    }
  }
  *(undefined4 *)param_1 = 0;
...

{
  ...
  pfVar12 = (float *)(**(code **)(*(int *)param_2 + 0x260))(param_2);
  fVar1 = *pfVar12;
  fVar2 = pfVar12[1];
  fVar3 = pfVar12[2];
  fVar4 = *pfVar11;
  fVar5 = pfVar11[1];
  fVar6 = pfVar11[2];
  piVar7 = (int *)(*(int **)(unaff_EBX + 0x464f81))[7];
  if (piVar7 == *(int **)(unaff_EBX + 0x464f81)) {
  ...
  fVar4 = pfVar11[1];
  fVar5 = pfVar12[2];
  piVar7 = (int *)(*(int **)(unaff_EBX + 0x465049))[7];
  fVar6 = pfVar11[2];
  if (piVar7 == *(int **)(unaff_EBX + 0x465049)) {
    fVar13 = (float)((uint)piVar7 ^ piVar7[0xb]);
    this_00 = extraout_ECX;
  }
  else {
  ...
  if (iVar10 == 0) {
    ...
    if (bVar8) {
      fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                  (this_00,(float)param_2,0x3f800000);
      if (*(float *)(unaff_EBX + 0x1f6635) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x1f6635)) {
        RandomFloat(0x40a00000,0x41200000,uVar17);
        (**(code **)(*(int *)param_2 + 0x970))(param_2);
        CINSBotBody::SetPosture();
        return;
      }
      RandomFloat(0x40a00000,0x41000000,uVar17);
      (**(code **)(*(int *)param_2 + 0x970))(param_2);
      CINSBotBody::SetPosture();
      return;
    }
    fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                (this_00,(float)param_2,0x3f800000);
    if (*(float *)(unaff_EBX + 0x1e30a1) <= (float)fVar14 &&
        (float)fVar14 != *(float *)(unaff_EBX + 0x1e30a1)) {
      RandomFloat(0x41000000,0x41400000,uVar17);
      (**(code **)(*(int *)param_2 + 0x970))(param_2);
      goto LAB_007418a7;
    }
    RandomFloat(0x41000000,0x41400000,uVar17);
    ...
    if (iVar10 == 1) {
      ...
      if (bVar8) {
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000);
        if ((float)fVar14 < *(float *)(unaff_EBX + 0x1e23e1) ||
            (float)fVar14 == *(float *)(unaff_EBX + 0x1e23e1)) {
          return;
        }
        uVar16 = 0x40c00000;
        uVar15 = 0x40400000;
        ...
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000);
        if (*(float *)(unaff_EBX + 0x1e30a5) <= (float)fVar14 &&
            (float)fVar14 != *(float *)(unaff_EBX + 0x1e30a5)) {
          RandomFloat(0x40400000,0x40c00000,uVar17);
          (**(code **)(*(int *)param_2 + 0x970))(param_2);
LAB_007418a7:
          CINSBotBody::SetPosture();
          return;
        ...
        if (bVar9) {
          uVar17 = 0;
          fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                      (this_01,(float)param_2,0x3f800000);
          if (*(float *)(unaff_EBX + 0x1e7b09) <= (float)fVar14 &&
              (float)fVar14 != *(float *)(unaff_EBX + 0x1e7b09)) {
            RandomFloat(0x40400000,0x40c00000,uVar17);
            (**(code **)(*(int *)param_2 + 0x970))(param_2);
            goto LAB_007418a7;
          }
      ...
      if (bVar8) {
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000);
        if ((float)fVar14 < *(float *)(unaff_EBX + 0x1e30ad) ||
            (float)fVar14 == *(float *)(unaff_EBX + 0x1e30ad)) {
          return;
        }
      }
      else if (bVar9) {
        ...
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000);
        if (*(float *)(unaff_EBX + 0x1e30ad) <= (float)fVar14 &&
            (float)fVar14 != *(float *)(unaff_EBX + 0x1e30ad)) {
          RandomFloat(0x40400000,0x40c00000,uVar17);
          (**(code **)(*(int *)param_2 + 0x970))(param_2);
          goto LAB_007418a7;
      ...
      RandomFloat(0x40400000,0x40c00000);
      (**(code **)(*(int *)param_2 + 0x970))(param_2);
    }
  }
  CINSBotBody::SetPosture();
  ...
  if ((iVar3 != 0) && (param_3 != (Vector *)0x0)) {
    ...
    if (iVar3 != iVar4) {
      ...
      if (cVar2 != '\0') {
        ...
        if (iVar3 == iVar4) {
          piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
          iVar3 = 0;
          if (*(int *)(in_stack_00000010 + 0x20) != 0) {
            iVar3 = *(int *)(in_stack_00000010 + 0x20) -
                    *(int *)(**(int **)(&DAT_004665ef + unaff_EBX) + 0x5c) >> 4;
          }
          (**(code **)(*piVar5 + 0xec))(piVar5,iVar3);
        }
      }
      cVar2 = (**(code **)(*(int *)param_3 + 0x8a8))(param_3);
      if (cVar2 == '\0') {
        piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        iVar3 = (**(code **)(*piVar5 + 0xd0))(piVar5,0);
        if (iVar3 == 0) {
          piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
          cVar2 = (**(code **)(*piVar5 + 0x104))(piVar5,in_stack_00000010,1,0);
          if (cVar2 != '\0') {
            cVar2 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3);
            if (cVar2 == '\0') {
              piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
              pcVar1 = *(code **)(*piVar5 + 0xd4);
              CINSNextBot::GetViewPosition(local_28);
              (*pcVar1)(piVar5,local_28,2,0x3f800000,0,unaff_EBX + 0x242694);
              goto LAB_007402c7;
            }
          }
          CINSNextBot::AddInvestigation
          ...
          piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))();
          (**(code **)(*piVar5 + 0xe8))(piVar5,in_stack_00000010);
        }
      }
    }
  }
  ...
  if ((iVar3 != 0) && (param_3 != (Vector *)0x0)) {
    ...
    if (cVar2 != '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        if (iVar3 == iVar5) {
          piVar4 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
          iVar3 = 0;
          if (*(int *)(in_stack_00000010 + 0x20) != 0) {
            iVar3 = *(int *)(in_stack_00000010 + 0x20) -
                    *(int *)(**(int **)(unaff_EBX + 0x46682f) + 0x5c) >> 4;
          }
          (**(code **)(*piVar4 + 0xec))(piVar4,iVar3);
        }
      }
      cVar2 = (**(code **)(*(int *)param_3 + 0x8a8))(param_3);
      if (cVar2 == '\0') {
        piVar4 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        cVar2 = (**(code **)(*piVar4 + 0x104))(piVar4,in_stack_00000010,0,0);
        if (cVar2 == '\0') {
          CINSNextBot::AddInvestigation
          ...
          piVar4 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
          iVar3 = (**(code **)(*piVar4 + 0xd0))(piVar4,0);
          if (iVar3 == 0) {
            cVar2 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3);
            if (cVar2 == '\0') {
              piVar4 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
              pcVar1 = *(code **)(*piVar4 + 0xd4);
              CINSNextBot::GetViewPosition(local_28);
              (*pcVar1)(piVar4,local_28,2,0x3f800000,0,unaff_EBX + 0x242997);
            }
          }
        }
      }
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4580b3;
  in_stack_00000004[1] = extraout_ECX + 0x45824b;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x457ffa;
  in_stack_00000004[1] = unaff_EBX + 0x458192;
