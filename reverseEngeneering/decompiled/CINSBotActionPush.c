...

{
  ...
  if (cVar2 != '\0') {
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x247357;
    return param_1;
  }
  ...
  if (iVar5 != 0) {
    ...
    if (iVar5 == 1) {
      ...
      *(void **)(param_1 + 4) = pvVar3;
      *(undefined4 *)param_1 = 2;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2456bc;
      return param_1;
    }
  }
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 != '\0') {
      ...
      *(undefined4 *)param_1 = 2;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24724d;
      return param_1;
    }
    ...
    if ((iVar5 == 2) + 2 == iVar1) {
      ...
      *(void **)(param_1 + 4) = pvVar3;
      *(undefined4 *)param_1 = 2;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2473eb;
      return param_1;
    }
    if (1 < iVar1 - 2U) {
      pvVar3 = ::operator_new(0x88);
      ...
      *(void **)(param_1 + 4) = pvVar3;
      *(undefined4 *)param_1 = 2;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24740f;
      return param_1;
    }
    iVar5 = CINSNavMesh::GetRandomControlPointArea(**(int **)(unaff_EBX + 0x46b7b7));
    if (iVar5 == 0) {
      Warning(unaff_EBX + 0x2474cb,this_00);
    }
    else {
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45ec13;
  in_stack_00000004[1] = extraout_ECX + 0x45eda7;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46bd63));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45ebca;
  in_stack_00000004[1] = unaff_EBX + 0x45ed5e;
