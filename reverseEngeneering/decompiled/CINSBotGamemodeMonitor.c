    ...
    if (cVar4 == '\0') {
      ...
      if (cVar4 != '\0') {
        ...
        *(undefined1 *)((int)piVar5 + 0x31) = 0;
        piVar5[0xb] = 0;
        piVar5[0xd] = 0;
        iVar2 = *(int *)(unaff_EBX + 0x468945);
        piVar5[0x10] = 0;
        piVar5[1] = iVar2 + 0x1a4;
        piVar5[0xf] = unaff_EBX + 0x3ea1ad;
        *piVar5 = iVar2 + 8;
      ...
      if (cVar4 == '\0') {
        ...
        if ((cVar4 == '\0') && (cVar4 = CINSRules::IsInvasion(this_04), cVar4 == '\0')) {
          ...
          if (cVar4 != '\0') {
            ...
            *(undefined1 *)((int)piVar5 + 0x31) = 0;
            piVar5[0xb] = 0;
            piVar5[0xd] = 0;
            iVar2 = *(int *)(unaff_EBX + 0x468565);
            piVar5[1] = iVar2 + 0x19c;
            *piVar5 = iVar2 + 8;
            CINSPathFollower::CINSPathFollower(this_18);
            piVar5[0x122c] = 0;
            piVar5[0x122b] = unaff_EBX + 0x3ea1ad;
        ...
        *(undefined1 *)((int)piVar5 + 0x31) = 0;
        piVar5[0xb] = 0;
        piVar5[0xd] = 0;
        iVar2 = *(int *)(unaff_EBX + 0x468eb9);
        *piVar5 = iVar2 + 8;
        piVar5[1] = iVar2 + 0x19c;
      }
    }
    else {
      iVar2 = unaff_EBX + 0x3ea1ad;
      ...
      *(undefined1 *)((int)piVar5 + 0x31) = 0;
      piVar5[0xb] = 0;
      piVar5[0xd] = 0;
      iVar3 = *(int *)(unaff_EBX + 0x468b5d);
      piVar5[0x10] = iVar2;
      piVar5[0x11] = 0;
      piVar5[1] = iVar3 + 0x1a4;
      *piVar5 = iVar3 + 8;
      pcVar1 = (code *)(unaff_EBX + -0x50d89b);
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45c013;
  in_stack_00000004[1] = extraout_ECX + 0x45c1a3;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x4687e3));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45bfca;
  in_stack_00000004[1] = unaff_EBX + 0x45c15a;
