...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x48365d;
  in_stack_00000004[1] = unaff_EBX + 0x483805;
  piVar1 = in_stack_00000004 + 0xe;
  in_stack_00000004[0xe] = unaff_EBX + 0x4159ed;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x4e205b))(piVar1,in_stack_00000004 + 0xf);
  ...
  in_stack_00000004[0x11] = unaff_EBX + 0x4159ed;
  (*(code *)(unaff_EBX + -0x4e205b))(piVar2,in_stack_00000004 + 0x12);
...

{
  ...
  pfVar1 = *(float **)(unaff_EBX + 0x494792);
...

{
  ...
  if (fVar9 < (float)fVar8) {
    ...
    if (cVar2 == '\0') {
      ...
      uVar12 = 0x3f0ccccd;
      uVar11 = 7;
      iVar3 = unaff_EBX + 0x26e201;
      uVar10 = 3;
      CINSBotBody::SetPosture();
    }
    else {
      (**(code **)(*(int *)in_stack_0000000c + 0x970))(in_stack_0000000c);
      iVar3 = unaff_EBX + 0x26e1ea;
LAB_007124a6:
      uVar12 = 0x3f0ccccd;
      uVar11 = 7;
      uVar10 = 1;
...
LAB_007123b8:
        ...
        uVar10 = 0;
        fVar8 = (float10)CINSNextBot::GetDesiredAttackRange(pCVar4,in_stack_0000000c);
        if (((fVar9 <= (float)fVar8 * *(float *)(unaff_EBX + 0x211812)) ||
...
LAB_007123d8:
  ...
  fVar8 = (float10)CountdownTimer::Now();
  fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x2124da);
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4834c3;
  in_stack_00000004[1] = extraout_ECX + 0x48366b;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x494813));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48347a;
  in_stack_00000004[1] = unaff_EBX + 0x483622;
