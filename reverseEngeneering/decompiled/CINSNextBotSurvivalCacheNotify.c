...

{
  ...
  if ((**(int **)(unaff_EBX + 0x43f85b) != 0) && (**(int **)(unaff_EBX + 0x43fc7f) != 0)) {
    ...
    if (iVar5 != 0) {
      ...
      if (cVar4 != '\0') {
        ...
        pfVar2 = *(float **)(unaff_EBX + 0x43f52f);
        if (((*pfVar2 != *pfVar1) || (pfVar2[1] != pfVar1[1])) || (pfVar2[2] != pfVar1[2])) {
          uVar13 = 1;
          iVar5 = __dynamic_cast(in_stack_00000008,*(undefined4 *)(unaff_EBX + 0x43ff33),
                                 *(undefined4 *)(unaff_EBX + 0x43f98b),0x2060);
          if (iVar5 != 0) {
            piVar6 = (int *)(*(int **)(unaff_EBX + 0x43fd5b))[7];
            if (piVar6 == *(int **)(unaff_EBX + 0x43fd5b)) {
            ...
            piVar6 = (int *)(*(int **)(unaff_EBX + 0x43fd4b))[7];
            if (piVar6 == *(int **)(unaff_EBX + 0x43fd4b)) {
            ...
            fVar15 = ((float)*(int *)(**(int **)(unaff_EBX + 0x43f85b) + 1000) +
                     *(float *)(unaff_EBX + 0x21fec3)) * *(float *)(unaff_EBX + 0x21fec7);
            if (*(float *)(unaff_EBX + 0x151a77) <= fVar15) {
              fVar15 = *(float *)(unaff_EBX + 0x151a77);
            }
            if (fVar15 <= *(float *)(unaff_EBX + 0x151a6b)) {
              fVar15 = *(float *)(unaff_EBX + 0x151a6b);
            }
