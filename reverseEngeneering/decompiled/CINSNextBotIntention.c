...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x452ccb;
  *(int *)(param_1 + 0x14) = unaff_EBX + 0x452dcb;
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x45e983);
  *piVar2 = iVar1 + 8;
  piVar2[1] = iVar1 + 0x1a4;
  puVar3 = (undefined4 *)::operator_new(0x50);
  *puVar3 = &UNK_004539cb + unaff_EBX;
  puVar3[1] = unaff_EBX + 0x453abb;
  CFmtStrN<32,false>::CFmtStrN
            (this_00,(char *)(puVar3 + 3),&UNK_00230f37 + unaff_EBX,unaff_EBX + 0x2115be);
  puVar3[0xf] = 0;
  puVar3[0x10] = 0;
  puVar3[0x11] = 0;
  puVar3[0x12] = 0;
...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x45e805);
  *piVar2 = iVar1 + 8;
  piVar2[1] = iVar1 + 0x1a4;
  piVar3 = (int *)::operator_new(0x50);
  *piVar3 = unaff_EBX + 0x45384d;
  piVar3[1] = unaff_EBX + 0x45393d;
  CFmtStrN<32,false>::CFmtStrN
            (this_00,(char *)(piVar3 + 3),unaff_EBX + 0x230db9,unaff_EBX + 0x211440);
  piVar3[0xf] = 0;
  piVar3[0x10] = 0;
  piVar3[0x11] = 0;
  piVar3[0x12] = 0;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4582ea;
  in_stack_00000004[5] = unaff_EBX + 0x4583ea;
  piVar1 = (int *)in_stack_00000004[6];
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 4))(piVar1);
  }
  in_stack_00000004[5] = unaff_EBX + 0x3e622a;
  *in_stack_00000004 = unaff_EBX + 0x3e616a;
  return;
}
