...

{
  ...
  this = extraout_ECX;
  if (*(int *)(param_2 + 0x48c8) != -0x40800000) {
    (**(code **)(*(int *)(param_2 + 0x48c0) + 4))(param_2 + 0x48c0,param_2 + 0x48c8);
    *(undefined4 *)(param_2 + 0x48c8) = 0xbf800000;
  ...
  if (((float)fVar11 < *(float *)((int)param_2 + 0x48d4) ||
    ...
    if (*(float *)((int)param_2 + 0x48e0) <= (float)fVar11 &&
      ...
      if (iVar6 == 0) {
        ...
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24e579;
        return param_1;
      }
      fVar11 = (float10)RandomFloat(0x3fc00000,0x40000000);
      fVar12 = (float)fVar11;
      fVar11 = (float10)CountdownTimer::Now();
      ...
      **(int **)(unaff_EBX + 0x4730a1) = **(int **)(unaff_EBX + 0x4730a1) + 1;
      local_5c = 0;
      if (0 < iVar10) {
        iVar10 = 0;
        do {
...
LAB_00733cca:
      ...
      if ((iVar6 != 0) && (0 < *(int *)(iVar6 + 0x13c))) {
        ...
        do {
          iVar2 = *(int *)(*(int *)(iVar6 + 0x134) + iVar10 * 8);
          if (((iVar2 != 0) && (*(int *)(iVar2 + 0x148) != **(int **)(unaff_EBX + 0x4730a1))) &&
             (*(int *)(iVar2 + 0x148) = **(int **)(unaff_EBX + 0x4730a1),
             *(char *)(iVar10 * 8 + *(int *)(iVar6 + 0x134) + 4) != '\0')) {
            if (local_58 == (CINSPathFollower *)0x0) break;
            local_70 = 3;
            do {
              CNavArea::GetRandomPoint();
              local_44 = *(float *)(unaff_EBX + 0x22a675) + local_20;
              local_4c = local_28;
              local_48 = local_24;
              cVar5 = (**(code **)(*(int *)local_58 + 0x444))(local_58,&local_4c,1,local_58);
              if (cVar5 != '\0') {
...
LAB_00733de0:
      if (0 < (int)local_60) {
        ...
        (*pcVar3)(piVar7,local_40,3,fVar12,0,unaff_EBX + 0x24e59d);
      }
      local_60 = (Vector *)0x0;
      *(undefined4 *)param_1 = 0;
      *(undefined4 *)(param_1 + 4) = 0;
      *(undefined4 *)(param_1 + 8) = 0;
      ...
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x472e9d) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x472e9d),local_6c[0]);
      return param_1;
    }
  }
  else {
    ...
    if (*(float *)((int)param_2 + 0x48c8) <= (float)fVar11 &&
      ...
      fVar11 = (float10)CountdownTimer::Now();
      fVar12 = (float)fVar11 + *(float *)(unaff_EBX + 0x220c65);
      ...
      if (*(int *)((int)param_2 + 0x48c4) != 0x40200000) {
        (**(code **)(*(int *)((int)param_2 + 0x48c0) + 4))
                  ((int)param_2 + 0x48c0,(int)param_2 + 0x48c4);
        *(undefined4 *)((int)param_2 + 0x48c4) = 0x40200000;
      }
      ...
      if (((*(uint *)((int)param_2 + 0x48bc) < 0x10) &&
          (piVar7 = (int *)(**(int **)(unaff_EBX + 0x472cdd) + 0x974 +
    ...
    if (*(int *)((int)param_2 + 0x443c) < 1) {
      ...
      if (cVar5 == '\0') {
        *(undefined4 *)param_1 = 3;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24e563;
        return param_1;
      }
      ...
      CINSPathFollower::ComputePath
                (in_stack_0000000c + 0x2060,(INextBot *)((int)param_2 + 0x38),pCVar9,
                 (int)param_2 + 0x48a8,0,(float)fVar11,0,0x41f00000);
...

{
  ...
  piVar2 = (int *)(**(int **)(unaff_EBX + 0x472efd) + 0x974 +
...
LAB_007338af:
  ...
  if (-1 < local_3c[2]) {
    if (local_3c[0] != 0) {
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x4730bd) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x4730bd),local_3c[0]);
      local_3c[0] = 0;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4647fa;
  in_stack_00000004[1] = unaff_EBX + 0x46498a;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46478a;
  in_stack_00000004[1] = unaff_EBX + 0x46491a;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
