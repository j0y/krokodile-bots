...

{
  ...
  _param_1[2] = 0;
  *_param_1 = unaff_EBX + 0x468a1d;
  _param_1[1] = unaff_EBX + 0x468bb5;
  piVar1 = *(int **)(unaff_EBX + 0x476ec1);
  _param_1[3] = 0;
  _param_1[4] = 0;
  _param_1[8] = 0;
  iVar2 = *piVar1;
  ...
  *(undefined1 *)((int)_param_1 + 0x31) = 0;
  _param_1[0xb] = 0;
  _param_1[0x10] = iVar3;
  _param_1[0x11] = unaff_EBX + 0x3f8aad;
  _param_1[0xd] = 0;
  _param_1[0xf] = iVar2;
  _param_1[0x12] = 0;
  (*(code *)(unaff_EBX + -0x4fef9b))(_param_1 + 0x11,_param_1 + 0x12);
  _param_1[0x13] = -0x40800000;
  (**(code **)(_param_1[0x11] + 4))(_param_1 + 0x11,_param_1 + 0x13);
  _param_1[0x17] = 0;
  _param_1[0x16] = unaff_EBX + 0x3f8aad;
  (*(code *)(unaff_EBX + -0x4fef9b))(_param_1 + 0x16,_param_1 + 0x17);
...

{
  ...
  *(undefined1 *)(param_2 + 0xc) = 0;
  ...
  param_2[0x11] = unaff_EBX + 0x3f896d;
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  param_2[0xb] = 0;
  param_2[0xd] = 0;
  param_2[0x12] = 0;
  (*(code *)(unaff_EBX + -0x4ff0db))(param_2 + 0x11,param_2 + 0x12);
  param_2[0x13] = 0xbf800000;
  (**(code **)(param_2[0x11] + 4))(param_2 + 0x11,param_2 + 0x13);
  param_2[0x17] = 0;
  param_2[0x16] = unaff_EBX + 0x3f896d;
  (*(code *)(unaff_EBX + -0x4ff0db))(param_2 + 0x16,param_2 + 0x17);
...

{
  ...
  __i686_get_pc_thunk_bx();
  pfVar1 = *(float **)(unaff_EBX + 0x477d51);
...
LAB_0072ebf0:
  ...
  if ((*pfVar1 != *(float *)(param_2 + 0x38)) ||
    ...
    if (cVar2 == '\0') {
      iVar4 = __dynamic_cast(piVar3,*(undefined4 *)(unaff_EBX + 0x478889),
      ...
      if (iVar4 == 0) {
        ...
        *(int *)(param_1 + 8) = unaff_EBX + 0x253291;
        return param_1;
      }
      fVar6 = (float10)CBaseDetonator::GetDetonateDamage();
      if (*(float *)(unaff_EBX + 0x18a28d) <= (float)fVar6 &&
          (float)fVar6 != *(float *)(unaff_EBX + 0x18a28d)) {
        this_02 = this_01;
    ...
    uVar10 = (**(code **)(*in_stack_0000000c + 0x96c))(in_stack_0000000c,uVar10);
...
LAB_0072eb2e:
  ...
  *(undefined4 *)param_1 = 1;
  *(void **)(param_1 + 4) = pvVar5;
  *(int *)(param_1 + 8) = unaff_EBX + 0x253255;
  return param_1;
}
...

{
  ...
  if ((cVar4 != '\0') &&
     ...
     *(float *)(unaff_EBX + 0x1f5711) <= (float)fVar8 &&
     (float)fVar8 != *(float *)(unaff_EBX + 0x1f5711))) {
    *(undefined4 *)param_1 = 3;
    *(int *)(param_1 + 8) = unaff_EBX + 0x252a5a;
    *(undefined4 *)(param_1 + 4) = 0;
    return param_1;
  }
  if ((0.0 < *(float *)((int)param_2 + 0x60)) &&
    ...
    if (*(char *)((int)param_2 + 0x50) == '\0') {
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x252863;
      return param_1;
    }
    piVar5 = (int *)::operator_new(0x5c);
    pcVar1 = (code *)(unaff_EBX + -0x4fe8eb);
    piVar5[8] = 0;
    piVar5[9] = 0;
    piVar5[10] = 0;
    piVar5[3] = 0;
  ...
  if (*(float *)(unaff_EBX + 0x20e9ad) <= (float)fVar8) {
    fVar8 = (float10)CountdownTimer::Now();
    if (*(float *)((int)param_2 + 0x4c) <= (float)fVar8 &&
      ...
      if (((piVar5 == (int *)0x0) ||
        ...
        if (cVar4 == '\0') {
          piVar5 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x974))(in_stack_0000000c);
          cVar4 = (**(code **)(*piVar5 + 0x108))(piVar5,iVar3,1);
          if (cVar4 != '\0') {
            piVar5 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x970))(in_stack_0000000c);
            (**(code **)(*piVar5 + 0xd4))(piVar5,iVar3,3,0x3f000000,0,unaff_EBX + 0x252b61);
          }
        }
      }
      else {
        ...
        (*pcVar1)(piVar6,uVar7,3,0x3f800000,0,unaff_EBX + 0x252b35);
        CINSNextBot::FireWeaponAtEnemy(this_02);
      }
      fVar8 = (float10)CountdownTimer::Now();
      fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x1f4a31);
  ...
  if (*(char *)((int)param_2 + 0x50) == '\0') {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x251887;
    return param_1;
  }
  piVar5 = (int *)::operator_new(0x5c);
  piVar5[8] = 0;
  ...
  *(undefined4 *)param_1 = 1;
  *(int **)(param_1 + 4) = piVar5;
  *(int *)(param_1 + 8) = unaff_EBX + 0x252b09;
  return param_1;
}
...

{
  ...
  if (*(char *)(iVar2 + 0x50) == '\0') {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x252c07;
    ...
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3f9327;
    pcVar1 = (code *)(unaff_EBX + -0x4fe721);
    piVar3[0xe] = iVar2;
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x252caf;
    *(undefined4 *)(param_1 + 0xc) = 1;
  }
  return param_1;
}
...

{
  ...
  if (*(char *)(iVar2 + 0x50) == '\0') {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar2 = *(int *)(unaff_EBX + 0x477d37);
    piVar3[0xf] = 0;
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3f94f7;
    pcVar1 = (code *)(unaff_EBX + -0x4fe551);
    piVar3[0xe] = iVar2;
    (*pcVar1)(piVar3 + 0xe,piVar3 + 0xf);
    piVar3[0x10] = -0x40800000;
    (**(code **)(piVar3[0xe] + 4))(piVar3 + 0xe,piVar3 + 0x10);
...

{
  ...
  *(undefined4 *)param_1 = 3;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x2532f3;
  *(undefined4 *)(param_1 + 0xc) = 1;
  return;
}
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x251e86;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x468733;
  in_stack_00000004[1] = (int)(&UNK_004688cb + extraout_ECX);
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x477783));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4686ea;
