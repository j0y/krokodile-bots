...

{
  ...
  *in_stack_00000004 = &UNK_0048459d + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x484745;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x4e0f1b))(puVar1,in_stack_00000004 + 0xf);
  ...
  (*(code *)(unaff_EBX + -0x4e0f1b))(puVar2,in_stack_00000004 + 0x12);
...

{
  ...
  pfVar2 = *(float **)(unaff_EBX + 0x495922);
...

{
  ...
  if (fVar7 < (float)fVar9) {
    ...
    if (cVar2 == '\0') {
      ...
      uVar12 = 0x3f0ccccd;
      uVar11 = 7;
      iVar3 = unaff_EBX + 0x26f341;
      uVar10 = 3;
      CINSBotBody::SetPosture();
    }
    else {
      (**(code **)(*(int *)in_stack_0000000c + 0x970))(in_stack_0000000c);
      iVar3 = unaff_EBX + 0x26f32a;
LAB_00711366:
      uVar12 = 0x3f0ccccd;
      uVar11 = 7;
      uVar10 = 1;
...
LAB_00711278:
        ...
        uVar10 = 0;
        fVar9 = (float10)CINSNextBot::GetDesiredAttackRange(pCVar4,in_stack_0000000c);
        if (((fVar7 <= (float)fVar9 * *(float *)(unaff_EBX + 0x212952)) ||
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x484403;
  in_stack_00000004[1] = (int)(&UNK_004845ab + extraout_ECX);
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x495953));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4843ba;
  in_stack_00000004[1] = unaff_EBX + 0x484562;
