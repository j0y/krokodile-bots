...

{
  ...
  return extraout_ECX + 0x2508ca /* "Special Action" */ /* "Special Action" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x467053 /* vtable for CINSBotSpecialAction+0x8 */ /* vtable for CINSBotSpecialAction+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x4671e3 /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */;
...

{
  ...
  *in_stack_00000004 = &UNK_0046700a + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x46719a /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */;
