...

{
  ...
  *(int *)((int)param_1 + 4) = unaff_EBX + 0x46bc95;
  ...
  *(undefined4 *)((int)param_1 + 0x48cc) = 0xbf800000;
  ...
  *(undefined4 *)((int)param_1 + 0x48e0) = 0xbf800000;
  ...
  *(undefined4 *)((int)param_1 + 0x48ec) = 0xbf800000;
...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x46b87d;
  *(int *)(param_1 + 4) = unaff_EBX + 0x46ba15;
  ...
  *(int *)(param_1 + 0x38) = unaff_EBX + 0x467d1d;
  pcVar1 = (code *)(unaff_EBX + -0x4fbf3b);
  iVar2 = param_1 + 0x48a8;
  iVar3 = unaff_EBX + 0x3fbb0d;
  *(int *)(param_1 + 0x48a8) = iVar3;
  (*pcVar1)(iVar2,param_1 + 0x48ac);
  *(undefined4 *)(param_1 + 0x48b0) = 0xbf800000;
  (**(code **)(*(int *)(param_1 + 0x48a8) + 4))(iVar2,param_1 + 0x48b0);
  *(undefined4 *)(param_1 + 0x48b4) = 0xffffffff;
  if (*(int *)(param_1 + 0x48b0) != -0x40800000) {
    (**(code **)(*(int *)(param_1 + 0x48a8) + 4))(iVar2,param_1 + 0x48b0);
    *(undefined4 *)(param_1 + 0x48b0) = 0xbf800000;
  }
  ...
  *(undefined4 *)(param_1 + 0x48e0) = 0xbf800000;
...

{
  ...
  if (*(float *)(unaff_EBX + 0x1f8b91) <= *(float *)(param_2 + 0x48d4)) {
    fVar12 = *(float *)(unaff_EBX + 0x1f8b91);
  }
  ...
  *(undefined4 *)(param_2 + 0x4814) = 0x428a0000;
  ...
  bVar10 = *(int *)(*(int *)(unaff_EBX + 0x47ad99) + 0x100c) != 0;
  if ((bVar10) &&
     (iVar5 = *(int *)(*(int *)(unaff_EBX + 0x47ad99) + 0x19b8), iVar4 = ThreadGetCurrentId(),
     iVar5 == iVar4)) {
    pcVar7 = *(char **)(*(int *)(unaff_EBX + 0x47ad99) + 0x1014);
    if (*(undefined **)pcVar7 != &UNK_00255c9d + unaff_EBX) {
      pcVar7 = (char *)CVProfNode::GetSubNode
                                 (pcVar7,(int)(&UNK_00255c9d + unaff_EBX),(char *)0x0,
                                  unaff_EBX + 0x25508e);
      *(char **)(*(int *)(unaff_EBX + 0x47ad99) + 0x1014) = pcVar7;
    }
    puVar1 = (uint *)(*(int *)(pcVar7 + 0x70) * 8 +
                      *(int *)(*(int *)(unaff_EBX + 0x47ad99) + 0x10a0) + 4);
    *puVar1 = *puVar1 | 4;
    CVProfNode::EnterScope();
    *(undefined1 *)(*(int *)(unaff_EBX + 0x47ad99) + 0x1010) = 0;
  }
  uVar2 = *(uint *)(param_2 + 0x48b4);
  if (((uVar2 == 0xffffffff) ||
      (iVar5 = **(int **)(unaff_EBX + 0x47abfd) + (uVar2 & 0xffff) * 0x18,
    ...
    if (cVar3 != '\0') {
      ...
      uVar16 = (undefined4)
               ((ulonglong)(double)*(float *)(**(int **)(unaff_EBX + 0x47acc5) + 0xc) >> 0x20);
  ...
  if (((bVar10) &&
      ((*(char *)(*(int *)(unaff_EBX + 0x47ad99) + 0x1010) == '\0' ||
       (this_02 = *(CINSNextBot **)(*(int *)(unaff_EBX + 0x47ad99) + 0x100c),
       this_02 != (CINSNextBot *)0x0)))) &&
     (iVar5 = *(int *)(*(int *)(unaff_EBX + 0x47ad99) + 0x19b8),
     iVar4 = ThreadGetCurrentId(uVar15,piVar6), this_02 = extraout_ECX_00, iVar5 == iVar4)) {
    cVar3 = CVProfNode::ExitScope();
    if (cVar3 == '\0') {
      pCVar9 = *(CINSNextBot **)(*(int *)(unaff_EBX + 0x47ad99) + 0x1014);
    }
    else {
      pCVar9 = *(CINSNextBot **)(*(int *)(*(int *)(unaff_EBX + 0x47ad99) + 0x1014) + 100);
      *(CINSNextBot **)(*(int *)(unaff_EBX + 0x47ad99) + 0x1014) = pCVar9;
    }
    this_02 = *(CINSNextBot **)(unaff_EBX + 0x47ad99);
    this_02[0x1010] = (CINSNextBot)(pCVar9 == this_02 + 0x1018);
  }
  CINSNextBot::ResetIdleStatus(this_02);
  cVar3 = (**(code **)(*local_30 + 0x158))(local_30);
  if (((cVar3 == '\0') &&
      (iVar5 = __dynamic_cast(local_30,*(undefined4 *)(unaff_EBX + 0x47b529),
                              *(undefined4 *)(unaff_EBX + 0x47b051),0), iVar5 != 0)) &&
     (fVar11 = (float10)CBaseDetonator::GetDetonateDamage(),
     *(float *)(unaff_EBX + 0x18cf2d) <= (float)fVar11 &&
     (float)fVar11 != *(float *)(unaff_EBX + 0x18cf2d))) {
    pCVar8 = this_03;
...

{
  ...
  if ((cVar2 != '\0') &&
     ...
     *(float *)(unaff_EBX + 0x1f8fd8) <= (float)fVar5 &&
     (float)fVar5 != *(float *)(unaff_EBX + 0x1f8fd8))) {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x25611a;
    return param_1;
  }
  if ((0.0 < *(float *)((int)param_2 + 0x48e0)) &&
    ...
    if (*(char *)((int)param_2 + 0x48d0) == '\0') {
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x25612a;
      return param_1;
    }
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar4 = *(int *)(unaff_EBX + 0x47b264);
    piVar3[0xf] = 0;
    piVar3[1] = iVar4 + 0x198;
    *piVar3 = iVar4 + 8;
    iVar4 = unaff_EBX + 0x3fca24;
    pcVar1 = (code *)(unaff_EBX + -0x4fb024);
    piVar3[0xe] = iVar4;
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x2562b4;
    return param_1;
  }
  fVar5 = (float10)CountdownTimer::Now();
  if (*(float *)((int)param_2 + 0x48cc) <= (float)fVar5 &&
    ...
    if ((in_stack_0000000c[0x2cce] == -1) ||
      ...
      if ((piVar3 == (int *)0x0) ||
        ...
        *(undefined1 *)((int)param_2 + 0x48f0) = 1;
        RandomFloat(0x3ecccccd,0x3f19999a);
    ...
    piVar3 = (int *)(*(int **)(unaff_EBX + 0x47b5fc))[7];
    if (piVar3 == *(int **)(unaff_EBX + 0x47b5fc)) {
...

{
  ...
  if (*(char *)(iVar2 + 0x48d0) == '\0') {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar2 = *(int *)(unaff_EBX + 0x47b867);
    piVar3[0xf] = 0;
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3fd027;
    pcVar1 = (code *)(unaff_EBX + -0x4faa21);
    piVar3[0xe] = iVar2;
    (*pcVar1)(piVar3 + 0xe,piVar3 + 0xf);
    piVar3[0x10] = -0x40800000;
    (**(code **)(piVar3[0xe] + 4))(piVar3 + 0xe,piVar3 + 0x10);
    ...
    *(undefined4 *)param_1 = 1;
    *(int **)(param_1 + 4) = piVar3;
    *(int *)(param_1 + 8) = unaff_EBX + 0x256757;
...

{
  ...
  if (*(char *)(iVar2 + 0x48d0) == '\0') {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    ...
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3fcc87;
    pcVar1 = (code *)(unaff_EBX + -0x4fadc1);
    piVar3[0xe] = iVar2;
    (*pcVar1)(piVar3 + 0xe,piVar3 + 0xf);
    piVar3[0x10] = -0x40800000;
    (**(code **)(piVar3[0xe] + 4))(piVar3 + 0xe,piVar3 + 0x10);
...

{
  ...
  if (*(char *)(iVar3 + 0x48d0) == '\0') {
    ...
    *piVar4 = iVar3 + 8;
    ...
    pcVar2 = (code *)(unaff_EBX + -0x4fabf1);
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x256587;
    *(undefined4 *)(param_1 + 0xc) = 2;
  }
  return param_1;
}
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x254ee6;
  *(undefined4 *)(param_1 + 0xc) = 2;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46b58a;
  in_stack_00000004[1] = unaff_EBX + 0x46b722;
  in_stack_00000004[0xe] = unaff_EBX + 0x467a2a;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46b50a;
  in_stack_00000004[1] = unaff_EBX + 0x46b6a2;
  in_stack_00000004[0xe] = unaff_EBX + 0x4679aa;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
