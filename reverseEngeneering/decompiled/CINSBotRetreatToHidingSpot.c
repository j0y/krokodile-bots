...

{
  ...
  *(undefined1 *)((int)_param_1 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x5003db))(_param_1 + 0x122d,_param_1 + 0x122e);
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x25205d;
  return param_1;
}
...

{
  ...
  if (iVar6 == 0) {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x251890;
    return param_1;
  }
  if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
    ...
    if (fVar2 < (float)fVar9 - *(float *)((int)param_2 + 0x48d8)) {
      if (*(char *)((int)param_2 + 0x48cc) == '\0') {
        *(undefined4 *)param_1 = 3;
        *(int *)(param_1 + 8) = unaff_EBX + 0x2514f3;
        *(undefined4 *)(param_1 + 4) = 0;
        return param_1;
      }
      ...
      *(undefined1 *)((int)piVar4 + 0x31) = 0;
      piVar4[0xb] = 0;
      piVar4[0xd] = 0;
      iVar6 = *(int *)(unaff_EBX + 0x47662d);
      piVar4[0xf] = 0;
      piVar4[1] = iVar6 + 0x198;
      iVar5 = unaff_EBX + 0x3f7ded;
      *piVar4 = iVar6 + 8;
      pcVar1 = (code *)(unaff_EBX + -0x4ffc5b);
      piVar4[0xe] = iVar5;
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x251909;
      *(int **)(param_1 + 4) = piVar4;
      return param_1;
    }
    if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
      if (iVar5 != 0) {
        piVar4 = (int *)(*(int **)(unaff_EBX + 0x476641))[7];
        if (piVar4 != *(int **)(unaff_EBX + 0x476641)) {
        ...
        if (puVar7 == (undefined4 *)0x0) {
          if (*(char *)((int)param_2 + 0x48cc) == '\0') {
            *(undefined4 *)param_1 = 3;
            *(undefined4 *)(param_1 + 4) = 0;
            *(int *)(param_1 + 8) = unaff_EBX + 0x251961;
            return param_1;
          }
          piVar4 = (int *)::operator_new(0x5c);
          pcVar1 = (code *)(unaff_EBX + -0x4ffc5b);
          ...
          *(undefined4 *)param_1 = 1;
          *(int **)(param_1 + 4) = piVar4;
          *(int *)(param_1 + 8) = unaff_EBX + 0x251935;
          return param_1;
        }
...

{
  ...
  if (param_2[0x48cc] == (Path)0x0) {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x476c9a);
    piVar4[0xf] = 0;
    piVar4[1] = iVar3 + 0x198;
    iVar1 = unaff_EBX + 0x3f845a;
    *piVar4 = iVar3 + 8;
    pcVar2 = (code *)(unaff_EBX + -0x4ff5ee);
    piVar4[0xe] = iVar1;
    ...
    *(undefined4 *)param_1 = 1;
    *(int **)(param_1 + 4) = piVar4;
    *(int *)(param_1 + 8) = unaff_EBX + 0x251b8a;
...

{
  ...
  if (*(char *)(iVar2 + 0x48cc) == '\0') {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar2 = *(int *)(unaff_EBX + 0x476a77);
    piVar3[0xf] = 0;
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3f8237;
    pcVar1 = (code *)(unaff_EBX + -0x4ff811);
    piVar3[0xe] = iVar2;
...

{
  ...
  if (cVar2 != '\0') {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x47689d);
    piVar4[0xf] = 0;
    *piVar4 = iVar3 + 8;
    piVar4[1] = iVar3 + 0x198;
    iVar3 = unaff_EBX + 0x3f805d;
    piVar4[0xe] = iVar3;
    pcVar1 = (code *)(unaff_EBX + -0x4ff9eb);
    (*pcVar1)(piVar4 + 0xe,piVar4 + 0xf);
    piVar4[0x10] = -0x40800000;
    (**(code **)(piVar4[0xe] + 4))(piVar4 + 0xe,piVar4 + 0x10);
    piVar4[0x12] = 0;
  ...
  *(undefined4 *)param_1 = 3;
  *(int *)(param_1 + 8) = unaff_EBX + 0x251b3d;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 0xc) = 3;
  return param_1;
}
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x252138;
  *(undefined4 *)(param_1 + 0xc) = 3;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46758a;
  in_stack_00000004[1] = unaff_EBX + 0x467722;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46751a;
  in_stack_00000004[1] = unaff_EBX + 0x4676b2;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
