...

{
  ...
  _param_1[8] = 0;
  *_param_1 = unaff_EBX + 0x4677dd /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  _param_1[9] = 0;
  _param_1[10] = 0;
  _param_1[3] = 0;
  _param_1[4] = 0;
...

{
  ...
  piVar1 = *(int **)(unaff_EBX + 0x476df1 /* &ins_bot_retreat_to_hidingspot_range */);
  ...
  if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
    ...
    if (fVar2 < (float)fVar9 - *(float *)((int)param_2 + 0x48d8)) {
      ...
      *(undefined1 *)((int)piVar4 + 0x31) = 0;
      piVar4[0xb] = 0;
      piVar4[0xd] = 0;
      iVar6 = *(int *)(unaff_EBX + 0x47662d /* &vtable for CINSBotReload */);
      piVar4[0xf] = 0;
    ...
    if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
      if (iVar5 != 0) {
        piVar4 = (int *)(*(int **)(unaff_EBX + 0x476641 /* &ins_bot_retreat_to_hidingspot_range */))[7];
        if (piVar4 != *(int **)(unaff_EBX + 0x476641 /* &ins_bot_retreat_to_hidingspot_range */)) {
...
" */;
          ...
          *(undefined1 *)((int)piVar4 + 0x31) = 0;
          piVar4[0xb] = 0;
          piVar4[0xd] = 0;
          iVar5 = *(int *)(unaff_EBX + 0x47662d /* &vtable for CINSBotReload */);
          piVar4[0xf] = 0;
...

{
  ...
  return extraout_ECX + 0x250ebe /* "Retreating to hiding spot" */;
}
...

{
  ...
  if (param_2[0x48cc] == (Path)0x0) {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x476c9a /* &vtable for CINSBotReload */);
    piVar4[0xf] = 0;
    piVar4[1] = iVar3 + 0x198;
    iVar1 = unaff_EBX + 0x3f845a /* vtable for CountdownTimer+0x8 */;
    *piVar4 = iVar3 + 8;
...

{
  ...
  if (*(char *)(iVar2 + 0x48cc) == '\0') {
    *param_1 = 3;
    param_1[1] = 0;
    param_1[2] = unaff_EBX + 0x25198b /* "We couldn't get to target's position!" */;
    param_1[3] = 3;
  }
  else {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar2 = *(int *)(unaff_EBX + 0x476a77 /* &vtable for CINSBotReload */);
    piVar3[0xf] = 0;
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3f8237 /* vtable for CountdownTimer+0x8 */;
    ...
    *param_1 = 1;
    param_1[1] = piVar3;
    param_1[2] = unaff_EBX + 0x251967 /* "Doing reload after OnMoveToFailure" */;
    param_1[3] = 3;
  }
  return param_1;
}
...

{
  ...
  if (cVar2 != '\0') {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x47689d /* &vtable for CINSBotReload */);
    piVar4[0xf] = 0;
    *piVar4 = iVar3 + 8;
    piVar4[1] = iVar3 + 0x198;
    iVar3 = unaff_EBX + 0x3f805d /* vtable for CountdownTimer+0x8 */;
    piVar4[0xe] = iVar3;
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x252138 /* "Sustaining retreat from fire." */;
  *(undefined4 *)(param_1 + 0xc) = 3;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46758a /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x467722 /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46751a /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4676b2 /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
