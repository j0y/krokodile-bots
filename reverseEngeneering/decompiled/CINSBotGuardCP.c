...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x4768ad;
  *(int *)(param_1 + 4) = unaff_EBX + 0x476a3d;
  puVar3 = *(undefined4 **)(unaff_EBX + 0x485cf1);
  ...
  *(undefined4 *)(param_1 + 0x44) = uVar5;
  puVar3 = *(undefined4 **)(unaff_EBX + 0x486465);
  ...
  *(undefined4 *)(param_1 + 0x50) = uVar4;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f016b);
  *(undefined4 *)(param_1 + 0x48c8) = 0;
  iVar2 = unaff_EBX + 0x4078dd;
  ...
  *(undefined4 *)(param_1 + 0x48d8) = 0xbf800000;
  ...
  iVar6 = *(int *)(unaff_EBX + 0x486375);
  *(undefined4 *)(param_1 + 0x48e8) = 0xbf800000;
...

{
  ...
  if (iVar6 != 0) {
    ...
    if (iVar6 == 1) {
      ...
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2602f7;
      return param_1;
    }
  }
  iVar6 = **(int **)(unaff_EBX + 0x485d91);
...
LAB_00721127:
    if (0 < iVar6) {
      if ((*(char *)((int)param_2 + 0x48dc) != '\0') &&
        ...
        *(undefined4 *)param_1 = 3;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x26035d;
        return param_1;
      }
      fVar7 = (float10)RandomFloat(0,0x41000000);
      fVar1 = (float)fVar7;
      fVar7 = (float10)CountdownTimer::Now();
  ...
  if (0.0 < *(float *)((int)param_2 + 0x48e8)) {
    if ((0.0 < *(float *)((int)param_2 + 0x48e0)) &&
      ...
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x260308;
      return param_1;
    }
    fVar7 = (float10)CountdownTimer::Now();
    ...
    if (*(float *)((int)param_2 + 0x48f4) <= (float)fVar7 &&
      ...
      fVar1 = *(float *)(unaff_EBX + 0x231245);
      ...
      local_20 = local_2c * fVar1 + *(float *)((int)param_2 + 0x44) +
                 *(float *)(unaff_EBX + 0x197b81);
      piVar5 = (int *)(**(code **)(*in_stack_0000000c + 0x970))(in_stack_0000000c);
      (**(code **)(*piVar5 + 0xd4))(piVar5,&local_28,0,0x3dcccccd,0,unaff_EBX + 0x260320);
    ...
    if ((double)(float)fVar7 < *(double *)(unaff_EBX + 0x260395)) {
  ...
  if (*(float *)((int)param_2 + 0x48cc) <= (float)fVar7 &&
    ...
    pfVar4 = *(float **)(unaff_EBX + 0x485641);
...

{
  ...
  *param_1 = 3;
  param_1[1] = 0;
  param_1[2] = extraout_ECX + 0x260d4d;
  param_1[3] = 1;
  return;
}
...

{
  ...
  piVar1 = (int *)(unaff_EBX + 0x5cbc15 + in_stack_0000000c * 0x14);
  local_40 = piVar1[3];
  if (piVar1[3] == 0) {
    this_00 = (CGlobalEntityList *)(unaff_EBX + 0x2090f9);
    pCVar15 = this_00;
    pcVar9 = (char *)CGlobalEntityList::FindEntityByClassname
                               (this_00,*(CBaseEntity **)(unaff_EBX + 0x486219),(char *)0x0);
      ...
      if (cVar7 != '\0') {
        pCVar10 = (CBaseEntity *)
                  CGlobalEntityList::FindEntityByClassname
                            (*(CGlobalEntityList **)(unaff_EBX + 0x486219),
                             (CBaseEntity *)*(CGlobalEntityList **)(unaff_EBX + 0x486219),
                             (char *)0x0);
        ...
        while (pCVar10 != (CBaseEntity *)0x0) {
          ...
          if (cVar7 == '\0') {
            ...
            if (iVar11 == iVar8) {
              ...
              if (cVar7 != '\0') {
                this_05 = *(CBaseEntity **)(unaff_EBX + 0x485a81);
                if ((((byte)pCVar10[0xd1] & 8) != 0) &&
    ...
    if (iVar11 == 0) {
      ...
      Warning(unaff_EBX + 0x26076d,in_stack_0000000c,uVar14);
      iVar11 = piVar1[3];
    }
    local_40 = iVar11;
    if (iVar11 == 0) {
  ...
  iVar11 = *piVar1;
  iVar8 = *(int *)(unaff_EBX + 0x5cbbd5 + in_stack_0000000c * 4) + 1;
  *(int *)(unaff_EBX + 0x5cbbd5 + in_stack_0000000c * 4) = iVar8;
...

{
  ...
  do {
    *(undefined4 *)(iVar1 * 4 + unaff_EBX + 0x5cbc24) = 0;
    iVar2 = iVar1 + 1;
    *(undefined4 *)(unaff_EBX + 0x5cbc70 + iVar1 * 0x14) = 0;
    iVar1 = iVar2;
  } while (iVar2 != 0x10);
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x475b5a;
  in_stack_00000004[1] = unaff_EBX + 0x475cea;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x475aea;
  in_stack_00000004[1] = unaff_EBX + 0x475c7a;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
