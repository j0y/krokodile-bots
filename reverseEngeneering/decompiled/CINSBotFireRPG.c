...

{
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  ...
  fVar3 = (float10)RandomFloat(0xc2a00000,0x42a00000);
  fVar1 = (float)fVar3;
  fVar3 = (float10)RandomFloat(0xc1f00000,0x428c0000);
  fVar2 = (float)fVar3;
  param_2[0x1a] = 0;
...

{
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  if (pCVar2 != (CINSNextBot *)0x0) {
    piVar4 = (int *)(**(code **)(*(int *)pCVar2 + 0x974))(pCVar2);
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (cVar3 != '\0') {
        ...
        (**(code **)(*(int *)pCVar2 + 0x20c))(&local_34,pCVar2);
...

{
  ...
  if (fVar1 != 0.0) {
    (**(code **)(*(int *)in_stack_0000000c + 0x96c))(in_stack_0000000c,uVar4,uVar5);
    ...
    *(undefined4 *)(in_stack_0000000c + 0x2284) = 1;
    ...
    if (*(int *)(in_stack_0000000c + 0xb38c) != 0x40400000) {
      (**(code **)(*(int *)(in_stack_0000000c + 0xb388) + 4))
                (in_stack_0000000c + 0xb388,in_stack_0000000c + 0xb38c);
      *(undefined4 *)(in_stack_0000000c + 0xb38c) = 0x40400000;
    }
...

{
  ...
  if (*(float *)((int)param_2 + 100) <= 0.0) {
            ...
            *(undefined1 *)((int)param_2 + 0x6c) = 1;
            if (*(int *)(iVar4 + 0x14) < 1) {
              ...
              do {
                ...
                if ((piVar2 == (int *)0x0) ||
                   (cVar1 = (**(code **)(*piVar2 + 0x158))(piVar2,pCVar7,this_09), cVar1 == '\0')) {
                  local_2c[0] = (int *)0x0;
                }
                else {
                  local_2c[0] = piVar2;
            ...
            if (0 < (int)local_40) {
              ...
              if (piVar2 != (int *)0x0) {
                (**(code **)(*piVar2 + 0x800))(piVar2,0x4c,0,0,0,0);
    ...
    if (*(float *)((int)param_2 + 100) <= (float)fVar8 &&
      ...
      piVar2 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x970))(in_stack_0000000c);
      (**(code **)(*piVar2 + 0x160))(piVar2);
...

{
  ...
  if (*(float *)(param_1 + 0xb378) <= (float)fVar15 && (float)fVar15 != *(float *)(param_1 + 0xb378)
    ...
    piVar6 = (int *)(**(code **)(*(int *)param_1 + 0x974))(param_1);
    ...
    if ((piVar6 != (int *)0x0) && (cVar3 = (**(code **)(*piVar6 + 0x3c))(piVar6), cVar3 != '\0')) {
      ...
      if ((piVar7 != (int *)0x0) &&
         (cVar3 = (**(code **)(*piVar7 + 0x410))(piVar7,uVar14,ppiVar25), cVar3 != '\0')) {
        iVar8 = (**(code **)(*piVar7 + 0x5f0))(piVar7);
        uVar14 = 0;
        if (iVar8 != 7) goto LAB_0071e08c;
        piVar7 = (int *)(**(code **)(*piVar6 + 0x10))(piVar6);
        if ((piVar7 == (int *)0x0) ||
           (cVar3 = (**(code **)(*piVar7 + 0x158))(piVar7), cVar3 == '\0')) goto LAB_0071e6a0;
        pfVar9 = (float *)(**(code **)(*piVar7 + 0x260))(piVar7);
        fVar20 = *pfVar9;
        fVar17 = pfVar9[1];
        fVar22 = pfVar9[2];
        pCVar23 = param_1;
