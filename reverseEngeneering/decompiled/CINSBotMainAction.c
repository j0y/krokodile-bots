...

{
  ...
  *(undefined1 *)((int)piVar4 + 0x31) = 0;
  piVar4[0xb] = 0;
  piVar4[0xd] = 0;
  iVar3 = *(int *)(unaff_EBX + 0x453111);
  piVar4[0xe] = iVar1;
  piVar4[0xf] = 0;
  piVar4[1] = iVar3 + 0x1a0;
  *piVar4 = iVar3 + 8;
  pcVar2 = (code *)(unaff_EBX + -0x52309b);
...

{
  ...
  if (**(int **)(unaff_EBX + 0x452e4a) != 0) {
    ...
    if ((0.0 < (float)in_stack_0000000c[0x608]) &&
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x22d756;
      return param_1;
    }
...

{
  ...
  if (pcVar2 != (char *)0x0) {
    if (*(int *)(pcVar2 + 100) != unaff_EBX + 0x1d52e5) {
...
LAB_00753e73:
  ...
  uVar6 = (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x45280d) + 0x40))
                    ((int *)**(undefined4 **)(unaff_EBX + 0x45280d),in_stack_0000000c[8]);
  uVar7 = (**(code **)(*in_stack_0000000c + 0xa8))(in_stack_0000000c);
  uVar12 = CONCAT44(uVar6,uVar7);
  uVar13 = CONCAT44(uVar4,uVar5);
  UTIL_LogPrintf((char *)(unaff_EBX + 0x22f7cd),uVar7,uVar6,uVar5,uVar4,dVar11,local_3c,local_34,
                 dVar10);
  ...
  if (piVar3 != (int *)0x0) {
    ...
    if (iVar8 != 0) {
      ...
      iVar8 = (**(code **)(*piVar3 + 0x20))(piVar3);
      UTIL_LogPrintf((char *)(unaff_EBX + 0x22f819),(double)*(float *)(iVar8 + 8),(double)fVar2,
                     (double)fVar1);
      goto LAB_00753fb6;
    }
  }
  UTIL_LogPrintf((char *)(unaff_EBX + 0x22f77d),uVar12,uVar13,dVar11,local_3c,local_34,dVar10);
LAB_00753fb6:
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 8) = 0;
...

{
  ...
  if (((uVar2 != 0xffffffff) &&
      (iVar1 = **(int **)(unaff_EBX + 0x4526e7) + (uVar2 & 0xffff) * 0x18,
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          if ((iVar4 != 0) &&
             (iVar4 = __dynamic_cast(iVar4,*(undefined4 *)(unaff_EBX + 0x452ef3),
                                     *(undefined4 *)(unaff_EBX + 0x452a1b),0), iVar4 != 0)) {
            fVar9 = (float10)CBaseDetonator::GetDetonateDamage();
            if (*(float *)(unaff_EBX + 0x1648f7) <= (float)fVar9 &&
                (float)fVar9 != *(float *)(unaff_EBX + 0x1648f7)) {
              CBaseDetonator::GetDetonateDamageRadius();
              return (float)fVar8 < (float)extraout_ST0 * *(float *)(unaff_EBX + 0x1d0f53);
            }
            return false;
          }
...

{
  ...
  __i686_get_pc_thunk_bx();
  pcVar1 = *(code **)(*(int *)(extraout_EDX + 0x2060) + 0x130);
  uVar3 = (**(code **)(*(int *)param_3 + 0x10))(param_3);
  fVar6 = (float10)(*pcVar1)(extraout_EDX + 0x2060,uVar3);
  ...
  if (local_24 != (int *)0x0) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (cVar2 != '\0') {
        ...
        if (*(float *)(unaff_EBX + 0x1d03a3) <= (float)fVar6) {
          uVar5 = CINSPlayer::GetPlayerFlags(this_03);
          if ((uVar5 & 1) != 0) {
            local_20 = local_20 * *(float *)(unaff_EBX + 0x1cf6cf);
          }
        }
        else {
          local_20 = local_20 * *(float *)(unaff_EBX + 0x1cf6cb);
        }
      }
    }
  }
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (cVar2 != '\0') {
        ...
        if (*(float *)(unaff_EBX + 0x1d03a3) <= (float)fVar6) {
          ...
          if ((uVar5 & 1) != 0) {
            fVar7 = fVar7 * *(float *)(unaff_EBX + 0x1cf6cf);
          }
        }
        else {
          fVar7 = fVar7 * *(float *)(unaff_EBX + 0x1cf6cb);
        }
      }
    }
  }
...

{
  ...
  *in_stack_00000004 = &UNK_004484d3 + extraout_ECX;
  in_stack_00000004[1] = extraout_ECX + 0x44866f;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x4529a3));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x44848a;
  in_stack_00000004[1] = unaff_EBX + 0x448626;
