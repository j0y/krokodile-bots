...

{
  ...
  if (iVar4 != 0) {
    ...
    if (iVar4 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x249b62;
      return param_1;
    }
  }
  ...
  if (iVar4 != iVar5) {
    ...
    *(undefined4 *)param_1 = 2;
    *(void **)(param_1 + 4) = pvVar6;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24b74b;
    *(undefined4 *)((int)param_2 + 0x20) = 0;
    *(undefined4 *)((int)param_2 + 0x24) = 0;
    *(undefined4 *)((int)param_2 + 0x28) = 0;
    *(undefined4 *)((int)param_2 + 0x2c) = 0;
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 != '\0') {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b6f3;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x46faf1) + 0x40))(*(int **)(unaff_EBX + 0x46faf1));
    if (iVar4 != 0) {
      ...
      if (((piVar3 != (int *)0x0) && (cVar2 = (**(code **)(*piVar3 + 0x158))(piVar3), cVar2 != '\0')
        ...
        *(undefined4 *)param_1 = 2;
        *(CNavArea **)(param_1 + 4) = pCVar8;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24b722;
        *(undefined4 *)((int)param_2 + 0x20) = 0;
        *(undefined4 *)((int)param_2 + 0x24) = 0;
        *(undefined4 *)((int)param_2 + 0x28) = 0;
        *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    pCVar9 = *(CINSNextBot **)(unaff_EBX + 0x46fe9d);
    if (*(char *)(*(int *)pCVar9 + 0x3ac) != '\0') {
      ...
      piVar3 = *(int **)(unaff_EBX + 0x46fe45);
      fVar12 = *(float *)((int)param_2 + 0x3c);
      if (fVar12 < 0.0) {
        fVar12 = *(float *)(*piVar3 + 0xc);
        *(float *)((int)param_2 + 0x3c) = fVar12;
      }
      fVar13 = *(float *)(unaff_EBX + 0x1820b9);
      fVar12 = ((*(float *)(unaff_EBX + 0x201281) + *(float *)(*piVar3 + 0xc)) - fVar12) *
               *(float *)(unaff_EBX + 0x241491);
      if (fVar13 <= fVar12) {
        fVar12 = fVar13;
      }
      ...
      if ((float)fVar11 < fVar13) {
        iVar4 = (int)fVar10 * 0xc + **(int **)(unaff_EBX + 0x4702c1);
        ...
        if ((piVar3 != (int *)0x0) && (iVar4 = (**(code **)(*piVar3 + 0x548))(piVar3), iVar4 != 0))
        {
          ...
          *(undefined4 *)param_1 = 2;
          *(CNavArea **)(param_1 + 4) = pCVar8;
          *(int *)(param_1 + 8) = unaff_EBX + 0x24b765;
          *(undefined4 *)((int)param_2 + 0x20) = 0;
          *(undefined4 *)((int)param_2 + 0x24) = 0;
          *(undefined4 *)((int)param_2 + 0x28) = 0;
          *(undefined4 *)((int)param_2 + 0x2c) = 0;
      ...
      *(undefined4 *)param_1 = 2;
      *(void **)(param_1 + 4) = pvVar6;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b789;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    *(undefined4 *)((int)param_2 + 0x3c) = 0xbf800000;
    if (((0 < local_34) && ((uint)fVar10 < 0x10)) &&
      ...
      if (iVar4 != 0) {
        ...
        *(undefined4 *)((int)param_2 + 0x28) = 0;
        *(undefined4 *)((int)param_2 + 0x2c) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24b7bd;
        return param_1;
      }
    }
    if ((*(byte *)(in_stack_0000000c + 0x8a5) & 4) != 0) {
      ...
      *(undefined4 *)param_1 = 2;
      *(void **)(param_1 + 4) = pvVar6;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b733;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
  ...
  if (in_stack_00000008 != (int *)0x0) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        cVar4 = ((float)fVar5 < *(float *)(unaff_EBX + 0x24b880) ||
                (float)fVar5 == *(float *)(unaff_EBX + 0x24b880)) + '\x01';
      }
    }
  }
  return cVar4;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x461d93;
  in_stack_00000004[1] = extraout_ECX + 0x461f2b;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46fe43));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x461d4a;
  in_stack_00000004[1] = unaff_EBX + 0x461ee2;
