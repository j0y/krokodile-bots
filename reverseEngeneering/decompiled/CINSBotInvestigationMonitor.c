  ...
  if (((iVar5 == 0) && (**(int **)(&DAT_00467987 + unaff_EBX) != 0)) &&
    ...
    if (cVar3 != '\0') {
      ...
      if (*(float *)((int)param_2 + 0x58) <= (float)fVar7 &&
        ...
        if ((uVar2 != 0xffffffff) &&
           (iVar1 = **(int **)(unaff_EBX + 0x467867) + (uVar2 & 0xffff) * 0x18,
           *(uint *)(iVar1 + 8) == uVar2 >> 0x10)) {
          iVar5 = *(int *)(iVar1 + 4);
        }
        iVar1 = *(int *)(**(int **)(unaff_EBX + 0x467dab) + 0x770);
        if (*(int *)(iVar5 + 900) != iVar1) {
          uVar2 = *(uint *)(**(int **)(unaff_EBX + 0x467dab) + 0x7cc + iVar1 * 4);
          if (((uVar2 == 0xffffffff) ||
              (iVar5 = **(int **)(unaff_EBX + 0x467867) + (uVar2 & 0xffff) * 0x18,
...

{
  ...
  if (in_stack_00000010 != (CBaseEntity *)0x0) {
    ...
    piVar10 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
    cVar9 = (**(code **)(*piVar10 + 0x104))(piVar10,in_stack_00000010,0,0);
    if (cVar9 == '\0') {
      piVar10 = (int *)(*(int **)(unaff_EBX + 0x467f29))[7];
      if (piVar10 == *(int **)(unaff_EBX + 0x467f29)) {
    ...
    fVar14 = (float10)RandomFloat(0,0x3f800000);
    if (*(float *)(&DAT_001e562d + unaff_EBX) <= (float)fVar14 &&
      ...
      fVar14 = (float10)RandomFloat(0,0x3f800000);
      if ((float)fVar14 < *(float *)(unaff_EBX + 0x1f8bb5) ||
          (float)fVar14 == *(float *)(unaff_EBX + 0x1f8bb5)) {
        ...
        if ((uVar8 != 0xffffffff) &&
           (pCVar13 = (CBaseEntity *)(**(int **)(unaff_EBX + 0x4676ad) + (uVar8 & 0xffff) * 0x18),
...

{
  ...
  if ((in_stack_00000010 != (CINSNextBot *)param_3) && (in_stack_00000010 != (CINSNextBot *)0x0)) {
    cVar6 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3);
    if (cVar6 == '\0') {
      iVar8 = CBaseEntity::GetTeamNumber(this_00);
      iVar9 = CBaseEntity::GetTeamNumber(this_01);
      if (iVar8 != iVar9) {
        piVar10 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        cVar6 = (**(code **)(*piVar10 + 0x104))(piVar10,in_stack_00000010,0,0);
        piVar10 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        cVar7 = (**(code **)(*piVar10 + 0x104))(piVar10,in_stack_00000010,1,0);
        piVar10 = (int *)(**(code **)(*(int *)param_3 + 0x97c))(param_3);
        iVar8 = (**(code **)(*piVar10 + 0xcc))(piVar10,param_3 + 0x2060);
        pfVar11 = (float *)(**(code **)(*(int *)in_stack_00000010 + 0x260))(in_stack_00000010);
        pfVar12 = (float *)(**(code **)(*(int *)param_3 + 0x260))(param_3);
        fVar15 = *pfVar12;
        fVar1 = pfVar12[1];
        fVar2 = pfVar12[2];
        fVar3 = *pfVar11;
        ...
        if (*(float *)(param_2 + 0x40) <= (float)fVar14 &&
          ...
          if (cVar7 != '\0') {
            ...
            if ((cVar6 == '\0') && (iVar8 != 1)) {
              fVar14 = (float10)RandomFloat(0,0x3f800000);
              if (*(float *)(unaff_EBX + 0x1e4378) <= (float)fVar14 &&
                  (float)fVar14 != *(float *)(unaff_EBX + 0x1e4378)) {
                uVar16 = 2;
                CINSNextBot::AddInvestigation();
                fVar14 = (float10)CountdownTimer::Now();
                fVar15 = (float)fVar14 + *(float *)(unaff_EBX + 0x1e5058);
          ...
          if (SQRT((fVar1 - fVar4) * (fVar1 - fVar4) + (fVar15 - fVar3) * (fVar15 - fVar3) +
                   (fVar2 - fVar5) * (fVar2 - fVar5)) < *(float *)(unaff_EBX + 0x1e58fc)) {
            fVar14 = (float10)RandomFloat(0,0x3f800000);
            if (*(float *)(unaff_EBX + 0x1edf80) <= (float)fVar14 &&
                (float)fVar14 != *(float *)(unaff_EBX + 0x1edf80)) {
              CINSNextBot::AddInvestigation(in_stack_00000010,param_3,in_stack_00000010,2);
              fVar14 = (float10)CountdownTimer::Now();
              fVar15 = (float)fVar14 + *(float *)(unaff_EBX + 0x1e4a9c);
              if (*(float *)(param_2 + 0x40) != fVar15) {
                (**(code **)(*(int *)(param_2 + 0x38) + 4))(pCVar13,param_2 + 0x40);
                *(float *)(param_2 + 0x40) = fVar15;
              }
              if (*(int *)(param_2 + 0x3c) != 0x41200000) {
                (**(code **)(*(int *)(param_2 + 0x38) + 4))(pCVar13,param_2 + 0x3c);
                *(undefined4 *)(param_2 + 0x3c) = 0x41200000;
              }
            }
          }
        }
...

{
  ...
  if ((cVar2 == '\0') || (cVar2 = (**(code **)(*(int *)param_3 + 0x8a8))(param_3), cVar2 != '\0'))
  goto LAB_0073f403;
  ...
  if (*(float *)(unaff_EBX + 0x20d37d) <= fVar8 && fVar8 != *(float *)(unaff_EBX + 0x20d37d)) {
    piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
    iVar6 = (**(code **)(*piVar5 + 0xd0))(piVar5,0);
    if (iVar6 != 0) goto LAB_0073f403;
    piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x97c))(param_3);
    iVar6 = (**(code **)(*piVar5 + 0xcc))(piVar5,param_3 + 0x2060);
  ...
  piVar5 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
  cVar2 = (**(code **)(*piVar5 + 0x104))(piVar5,in_stack_00000010,1,0,uVar9,uVar10);
  if ((cVar2 == '\0') || (cVar2 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3), cVar2 != '\0')) {
    fVar7 = (float10)CountdownTimer::Now();
    if (*(float *)(param_2 + 0x40) <= (float)fVar7 && (float)fVar7 != *(float *)(param_2 + 0x40)) {
      ...
      if (cVar2 != '\0') {
        DevMsg((char *)(unaff_EBX + 0x24346d));
      }
    }
  }
  else {
    ...
    (*pcVar1)(piVar5,local_28,2,0x3f400000,0,unaff_EBX + 0x24351d);
  }
LAB_0073f403:
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
...

{
  ...
  __i686_get_pc_thunk_bx();
  cVar1 = (**(code **)(*(int *)param_3 + 0x8a8))(param_3);
  if ((cVar1 == '\0') &&
    ...
    if ((piVar3 == (int *)0x0) || (iVar2 = (**(code **)(*piVar3 + 0x10))(piVar3), iVar2 == 0)) {
      piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x97c))(param_3);
      iVar2 = (**(code **)(*piVar3 + 0xcc))(piVar3,param_3 + 0x2060);
      if (iVar2 != 1) {
        piVar3 = (int *)(**(code **)(*(int *)param_3 + 0x974))(param_3);
        cVar1 = (**(code **)(*piVar3 + 0x108))(piVar3,in_stack_00000014,1);
        if ((cVar1 == '\0') ||
           (cVar1 = (**(code **)(*(int *)param_3 + 0x8ac))(param_3), cVar1 != '\0')) {
          ...
          if (*(float *)(param_2 + 0x40) <= (float)fVar4 &&
            ...
            if (cVar1 != '\0') {
              DevMsg((char *)(unaff_EBX + 0x243d60));
            }
          }
        }
        else {
          ...
          (**(code **)(*piVar3 + 0xd4))
                    (piVar3,in_stack_00000014,2,0x3f400000,0,unaff_EBX + 0x243d94);
        }
      }
    }
  }
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45af73;
  in_stack_00000004[1] = extraout_ECX + 0x45b103;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45af2a;
  in_stack_00000004[1] = unaff_EBX + 0x45b0ba;
