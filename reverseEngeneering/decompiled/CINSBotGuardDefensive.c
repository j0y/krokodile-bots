        ...
        **(int **)(&DAT_004845d1 + unaff_EBX) = **(int **)(&DAT_004845d1 + unaff_EBX) + 1;
        ...
        if (0 < (int)local_6c) {
          ...
          if ((iVar8 != iVar6) && (iVar6 != 0)) {
            ...
            (*pcVar3)(piVar5,local_38,0,0x3dcccccd,0,unaff_EBX + 0x25ee00 /* "Guard Aiming" */);
          }
        }
        local_6c = (CNavArea **)0x0;
        iVar6 = local_78[0];
  ...
  if (in_stack_00000010 != 0) {
    ...
    if ((iVar3 != iVar4) && ((piVar2 == (int *)0x0 || ((char)this_00 == '\0')))) {
      ...
      if (cVar1 != '\0') {
        ...
        (**(code **)(*piVar2 + 0xd8))(piVar2,in_stack_00000010,2,0x41200000,0,unaff_EBX + 0x25f9ed /* "Heard some gunshots." */);
      }
    }
  }
  *(undefined4 *)param_1 = 0;
