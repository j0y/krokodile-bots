...

{
  ...
  puVar4 = *(undefined4 **)(unaff_EBX + 0x469481);
  ...
  *(undefined4 *)(param_2 + 0x48c0) = uVar1;
  ...
  iVar2 = _V_stricmp(pcVar3,(char *)(unaff_EBX + 0x1f6a00));
  if (iVar2 == 0) {
...

{
  ...
  if (iVar7 != 0) {
    ...
    if (iVar7 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x2432d2;
      return param_1;
    }
  }
  ...
  if (iVar7 == 2) {
    ...
    local_78 = *(int **)(unaff_EBX + 0x46960d);
...
LAB_0073d391:
    ...
    if (fVar17 < *(float *)(unaff_EBX + 0x1ebedd) || fVar17 == *(float *)(unaff_EBX + 0x1ebedd)) {
      iVar7 = *(int *)((int)param_2 + 0x38);
      goto LAB_0073d460;
    }
    if ((*(byte *)(iVar8 + 0xd1) & 8) != 0) {
  ...
  pfVar2 = (float *)(unaff_EBX + 0x1ebee1);
  if (((((fVar19 < *(float *)(unaff_EBX + 0x1ebee1) || fVar19 == *(float *)(unaff_EBX + 0x1ebee1))
        || (fVar17 = *(float *)(unaff_EBX + 0x1e7d45), fVar17 <= fVar19)) ||
    ...
    if (iVar7 != 1) {
      ...
      if (*(float *)((int)param_2 + 0x48b4) <= (float)fVar16 &&
        ...
        iVar7 = CNavMesh::GetNearestNavArea
                          (local_54,**(undefined4 **)(unaff_EBX + 0x4693cd),&local_58,0,0x461c4000,0
                           ,1,0);
        ...
        local_1d = *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x100c) != 0;
        if (((bool)local_1d) &&
           (iVar7 = *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x19b8), iVar8 = ThreadGetCurrentId(),
           iVar7 == iVar8)) {
          piVar20 = *(int **)(*(int *)(unaff_EBX + 0x469689) + 0x1014);
          if (*piVar20 != unaff_EBX + 0x1ec8f8) {
            piVar20 = (int *)CVProfNode::GetSubNode
                                       ((char *)piVar20,unaff_EBX + 0x1ec8f8,(char *)0x0,
                                        unaff_EBX + 0x1ec8c3);
            *(int **)(*(int *)(unaff_EBX + 0x469689) + 0x1014) = piVar20;
          }
          puVar1 = (uint *)(piVar20[0x1c] * 8 + *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x10a0) +
                           4);
          *puVar1 = *puVar1 | 4;
          CVProfNode::EnterScope();
          *(undefined1 *)(*(int *)(unaff_EBX + 0x469689) + 0x1010) = 0;
        }
...
LAB_0073db65:
          ...
          pVVar10 = (Vector *)
                    CNavMesh::GetNearestNavArea
                              (this_08,**(undefined4 **)(unaff_EBX + 0x4693cd),this_08,1,0x43480000,
                               1,1,1);
...
LAB_0073ddaa:
            ...
            if (pVVar10 == (Vector *)0x0) {
              ...
              CNavMesh::GetGroundHeight
                        ((CNavMesh *)0x0,(Vector *)**(undefined4 **)(unaff_EBX + 0x4693cd),
...
LAB_0073da84:
        ...
        if ((local_1d != '\0') &&
           (((*(char *)(*(int *)(unaff_EBX + 0x469689) + 0x1010) == '\0' ||
             (*(int *)(*(int *)(unaff_EBX + 0x469689) + 0x100c) != 0)) &&
            (iVar7 = *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x19b8),
            iVar8 = ThreadGetCurrentId(pCVar11,pVVar10,pCVar23), iVar7 == iVar8)))) {
          cVar4 = CVProfNode::ExitScope();
          if (cVar4 == '\0') {
            iVar7 = *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x1014);
          }
          else {
            iVar7 = *(int *)(*(int *)(*(int *)(unaff_EBX + 0x469689) + 0x1014) + 100);
            *(int *)(*(int *)(unaff_EBX + 0x469689) + 0x1014) = iVar7;
          }
          *(bool *)(*(int *)(unaff_EBX + 0x469689) + 0x1010) =
               iVar7 == *(int *)(unaff_EBX + 0x469689) + 0x1018;
        }
      }
...
LAB_0073d4ea:
    piVar6 = piVar20;
    if (iVar7 == 0) {
      uVar14 = *(uint *)(unaff_EBX + 0x5b0115);
      if (uVar14 != 0xffffffff) {
        ...
        if ((*(CBaseCombatCharacter **)(iVar8 + 8) == (CBaseCombatCharacter *)(uVar14 >> 0x10)) &&
          ...
          if (cVar4 != '\0') {
            ...
            (**(code **)(*piVar20 + 0xd8))(piVar20,uVar13,2,0x3f800000,0,unaff_EBX + 0x2454e3);
            goto LAB_0073d622;
          }
          iVar7 = *(int *)((int)param_2 + 0x38);
          goto LAB_0073d547;
...
LAB_0073d547:
    ...
    if (((uVar14 != 0xffffffff) &&
      ...
      piVar20 = (int *)(**(code **)(*in_stack_0000000c + 0x970))(in_stack_0000000c);
      (**(code **)(*piVar20 + 0xd8))(piVar20,iVar7,2,0x3f800000,0,unaff_EBX + 0x2454f8);
      goto LAB_0073d622;
    }
  }
LAB_0073dd60:
  ...
  (*pcVar3)(piVar20,uVar13,2,0x3f800000,0,unaff_EBX + 0x2454f8);
LAB_0073d622:
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 8) = 0;
...

{
  ...
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
  puVar1 = *(undefined4 **)(unaff_EBX + 0x4696eb);
  *(undefined4 *)(param_1 + 8) = 0;
  *(undefined4 *)(param_1 + 0xc) = 1;
  *(undefined4 *)(extraout_EDX + 0x48b8) = *puVar1;
  uVar2 = puVar1[2];
  *(undefined4 *)(extraout_EDX + 0x48bc) = puVar1[1];
  *(undefined4 *)(extraout_EDX + 0x48c0) = uVar2;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  Warning(unaff_EBX + 0x245747);
  fVar1 = *(float *)(unaff_EBX + 0x1ec15e);
  if (((((*(float *)(in_stack_00000008 + 0x48b8) <= fVar1) ||
        (fVar2 = *(float *)(unaff_EBX + 0x1e7fc2), fVar2 <= *(float *)(in_stack_00000008 + 0x48b8)))
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45c8fa;
  in_stack_00000004[1] = unaff_EBX + 0x45ca8e;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45c88a;
  in_stack_00000004[1] = unaff_EBX + 0x45ca1e;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
