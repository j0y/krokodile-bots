...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x47359d;
  *(int *)(param_1 + 4) = unaff_EBX + 0x473735;
  ...
  *(undefined4 *)(param_1 + 0x34) = 0;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f383b);
  ...
  *(undefined4 *)(param_1 + 0x48d8) = 0xbf800000;
  (**(code **)(*(int *)(param_1 + 0x48d0) + 4))(pCVar3,param_1 + 0x48d8);
  ...
  *(undefined4 *)(param_1 + 0x48f0) = 0xbf800000;
  (**(code **)(*(int *)(param_1 + 0x48e8) + 4))(pCVar4,param_1 + 0x48f0);
...

{
  ...
  param_2[8] = 0;
  param_2[9] = 0;
  *param_2 = unaff_EBX + 0x4732ad;
  param_2[1] = unaff_EBX + 0x473445;
  param_2[10] = 0;
  param_2[3] = 0;
  param_2[4] = 0;
  param_2[5] = 0;
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f3b2b);
  param_2[0x122f] = 0;
  iVar5 = unaff_EBX + 0x403f1d;
  param_2[0x122e] = iVar5;
  (*pcVar1)(param_2 + 0x122e,param_2 + 0x122f);
  param_2[0x1230] = -0x40800000;
  (**(code **)(param_2[0x122e] + 4))(param_2 + 0x122e,param_2 + 0x1230);
  param_2[0x1231] = iVar5;
  param_2[0x1232] = 0;
  (*pcVar1)(param_2 + 0x1231,param_2 + 0x1232);
  param_2[0x1233] = -0x40800000;
  (**(code **)(param_2[0x1231] + 4))(param_2 + 0x1231,param_2 + 0x1233);
  piVar4 = param_2 + 0x1234;
  param_2[0x1234] = iVar5;
  param_2[0x1235] = 0;
  (*pcVar1)(piVar4,param_2 + 0x1235);
  param_2[0x1236] = -0x40800000;
  (**(code **)(param_2[0x1234] + 4))(piVar4,param_2 + 0x1236);
  piVar2 = param_2 + 0x123a;
  param_2[0x123a] = iVar5;
  param_2[0x123b] = 0;
  (*pcVar1)(piVar2,param_2 + 0x123b);
  param_2[0x123c] = -0x40800000;
  (**(code **)(param_2[0x123a] + 4))(piVar2,param_2 + 0x123c);
  ...
  if ((float)param_2[0x1236] != (float)fVar6 + fVar3) {
    (**(code **)(param_2[0x1234] + 4))(piVar4,param_2 + 0x1236);
    param_2[0x1236] = (int)((float)fVar6 + fVar3);
  }
  fVar6 = (float10)CountdownTimer::Now();
  fVar3 = (float)param_2[0x123b];
  if ((float)param_2[0x123c] != (float)fVar6 + fVar3) {
    (**(code **)(param_2[0x123a] + 4))(piVar2,param_2 + 0x123c);
    param_2[0x123c] = (int)((float)fVar6 + fVar3);
  }
  iVar5 = CNavMesh::GetNearestNavArea();
  param_2[0xe] = iVar5;
  piVar4 = *(int **)(unaff_EBX + 0x482331);
  *(undefined1 *)(param_2 + 0x123e) = 0;
  param_2[0x123d] = -0x40800000;
...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x472f8d;
  in_stack_00000004[1] = unaff_EBX + 0x473125;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  CINSPathFollower::CINSPathFollower(this_00);
  pcVar1 = (code *)(unaff_EBX + -0x4f3e4b);
  ...
  (**(code **)(in_stack_00000004[0x1234] + 4))(piVar5,in_stack_00000004 + 0x1236);
  ...
  in_stack_00000004[0x123c] = -0x40800000;
  ...
  if ((float)in_stack_00000004[0x1236] != (float)fVar7 + fVar4) {
    (**(code **)(in_stack_00000004[0x1234] + 4))(piVar5,in_stack_00000004 + 0x1236);
    in_stack_00000004[0x1236] = (int)((float)fVar7 + fVar4);
  }
  fVar7 = (float10)CountdownTimer::Now();
  ...
  piVar5 = *(int **)(unaff_EBX + 0x482011);
  *(undefined1 *)(in_stack_00000004 + 0x123e) = 0;
  in_stack_00000004[0x123d] = -0x40800000;
...

{
  ...
  if (iVar3 == 0) {
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x25de7c;
  ...
  if (*(int *)(param_2 + 0x38) == 0) {
    ...
    *(int *)(param_2 + 0x38) = iVar5;
    if (iVar5 == 0) {
      *(undefined4 *)param_1 = 3;
      *(int *)(param_1 + 8) = unaff_EBX + 0x25de93;
      *(undefined4 *)(param_1 + 4) = 0;
      return param_1;
    }
  }
  ...
  *(undefined4 *)(param_2 + 0x44) = *(undefined4 *)(iVar3 + 0x14);
  ...
  if (*(float *)(unaff_EBX + 0x201205) <= (float)fVar6 &&
      (float)fVar6 != *(float *)(unaff_EBX + 0x201205)) {
...

{
  ...
  if (*(CINSNextBot **)((int)param_2 + 0x38) == (CINSNextBot *)0x0) {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x25da83;
  }
  else {
    ...
    if (cVar2 == '\0') {
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x25db18;
    }
    else {
      ...
      if (this_00 != pCVar4) {
        ...
        *(undefined4 *)((int)param_2 + 0x44) = local_20;
        this_01 = extraout_ECX_00;
        if (*(int *)((int)param_2 + 0x48cc) != -0x40800000) {
          (**(code **)(*(int *)((int)param_2 + 0x48c4) + 4))
                    ((int)param_2 + 0x48c4,(int)param_2 + 0x48cc);
          *(undefined4 *)((int)param_2 + 0x48cc) = 0xbf800000;
          this_01 = extraout_ECX_01;
        }
      }
      ...
      if ((cVar2 == '\0') ||
         ...
         (float)fVar9 < *(float *)(unaff_EBX + 0x200df8) ||
         (float)fVar9 == *(float *)(unaff_EBX + 0x200df8))) {
        ...
        if (((((*(float *)((int)param_2 + 0x3c) <= fVar11) ||
              (fVar1 = *(float *)(unaff_EBX + 0x2016bc), fVar1 <= *(float *)((int)param_2 + 0x3c)))
          ...
          if (*(float *)((int)param_2 + 0x48c0) <= (float)fVar9 &&
            ...
            if (SQRT(fVar10 * fVar10 + fVar13 * fVar13 + fVar12 * fVar12) <
                *(float *)(unaff_EBX + 0x200114)) {
              *(undefined4 *)param_1 = 3;
              *(undefined4 *)(param_1 + 4) = 0;
              *(int *)(param_1 + 8) = unaff_EBX + 0x25db60;
              return param_1;
            }
            ...
            *(float *)((int)param_2 + 0x48e4) = fVar1;
            fVar9 = (float10)CountdownTimer::Now();
            fVar11 = (float)fVar9 + *(float *)(unaff_EBX + 0x200df8);
            if (*(float *)((int)param_2 + 0x48c0) != fVar11) {
              (**(code **)(*(int *)((int)param_2 + 0x48b8) + 4))
                        ((int)param_2 + 0x48b8,(int)param_2 + 0x48c0);
              *(float *)((int)param_2 + 0x48c0) = fVar11;
            }
            if (*(int *)((int)param_2 + 0x48bc) != 0x40a00000) {
              (**(code **)(*(int *)((int)param_2 + 0x48b8) + 4))
                        ((int)param_2 + 0x48b8,(int)param_2 + 0x48bc);
              *(undefined4 *)((int)param_2 + 0x48bc) = 0x40a00000;
            }
          }
          fVar9 = (float10)CountdownTimer::Now();
          if (*(float *)((int)param_2 + 0x48cc) <= (float)fVar9 &&
            ...
            *(undefined1 *)((int)param_2 + 0x48f8) = uVar3;
            ...
            fVar9 = (float10)CountdownTimer::Now();
            fVar11 = (float)fVar9 + *(float *)(unaff_EBX + 0x200de4);
            if (*(float *)((int)param_2 + 0x48cc) != fVar11) {
              (**(code **)(*(int *)((int)param_2 + 0x48c4) + 4))
                        ((int)param_2 + 0x48c4,(int)param_2 + 0x48cc);
              *(float *)((int)param_2 + 0x48cc) = fVar11;
            }
            if (*(int *)((int)param_2 + 0x48c8) != 0x3f000000) {
              (**(code **)(*(int *)((int)param_2 + 0x48c4) + 4))
                        ((int)param_2 + 0x48c4,(int)param_2 + 0x48c8);
              *(undefined4 *)((int)param_2 + 0x48c8) = 0x3f000000;
            }
          }
          if ((*(char *)((int)param_2 + 0x48fa) == '\0') ||
            ...
            *(undefined4 *)param_1 = 3;
            *(undefined4 *)(param_1 + 4) = 0;
            *(int *)(param_1 + 8) = unaff_EBX + 0x25dab3;
          }
        }
        else {
          *(undefined4 *)param_1 = 3;
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x25db40;
        }
      }
      else {
        *(undefined4 *)param_1 = 3;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x25da9f;
      }
    }
  }
  return param_1;
...

{
  ...
  if ((cVar2 != '\0') && (piVar1 = *(int **)(param_2 + 0xb45c), piVar1[2] != -0x40800000)) {
...

{
  ...
  if ((*(int *)(param_2 + 0x38) != 0) &&
    ...
    *(undefined4 *)(param_2 + 0x48fc) = uVar3;
    ...
    if (*(float *)(param_2 + 0x48c0) != (float)fVar4 + fVar1) {
      (**(code **)(*(int *)(param_2 + 0x48b8) + 4))(param_2 + 0x48b8,param_2 + 0x48c0);
      *(float *)(param_2 + 0x48c0) = (float)fVar4 + fVar1;
  ...
  *(undefined4 *)param_1 = 3;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x25dbe3;
  return param_1;
}
...

{
  ...
  if (*(int *)(param_1 + 0x48fc) != 8) {
    iVar3 = (**(code **)(**(int **)(unaff_EBX + 0x483123) + 0x40))(*(int **)(unaff_EBX + 0x483123));
    fVar1 = *(float *)(param_1 + 0x48f4);
    if (iVar3 == 0) {
      uVar2 = 0;
      if (*(float *)(unaff_EBX + 0x201c0f) <= fVar1) {
        return (fVar1 < *(float *)(unaff_EBX + 0x25e0e7) ||
               fVar1 == *(float *)(unaff_EBX + 0x25e0e7)) + 1;
      }
    }
    else {
      uVar2 = (uint)(*(float *)(unaff_EBX + 0x2023af) <= fVar1 &&
                    fVar1 != *(float *)(unaff_EBX + 0x2023af));
    }
  }
  return uVar2;
}
...

{
  ...
  *(undefined4 *)param_1 = 3;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x25e3ab;
...

{
  ...
  *piVar2 = iVar1 + 8;
  ...
  piVar2[0x16] = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x25c856;
  piVar2[0x17] = 0;
  piVar2[0x18] = 0;
  piVar2[0x19] = 0;
  piVar2[0x1a] = 0;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x472c7a;
  in_stack_00000004[1] = unaff_EBX + 0x472e12;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x472c0a;
  in_stack_00000004[1] = unaff_EBX + 0x472da2;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
