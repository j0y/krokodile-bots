...

{
  ...
  *(int *)(param_1 + 4) = unaff_EBX + 0x4831a1 /* vtable for CINSBotCaptureCP+0x19c */;
  pcVar1 = (code *)(unaff_EBX + -0x4e28ab /* CountdownTimer::NetworkStateChanged */);
  iVar2 = unaff_EBX + 0x41519d /* vtable for CountdownTimer+0x8 */;
...

{
  ...
  fVar1 = *(float *)(unaff_EBX + 0x21633e /* typeinfo name for CTraceFilterIgnoreWeapons+0x41 */);
  *(float *)(param_2 + 0x58) = local_28;
  *(float *)(param_2 + 0x5c) = local_24;
  *(float *)(param_2 + 0x60) = local_20;
  if ((((local_28 <= fVar1) || (fVar2 = *(float *)(unaff_EBX + 0x2121a2 /* typeinfo name for ITraceFilter+0x40 */), fVar2 <= local_28)) ||
...

{
  ...
  if (*(float *)((int)param_2 + 0x50) <= (float)fVar20 &&
    ...
    fVar20 = (float10)CountdownTimer::Now();
    fVar21 = (float)fVar20 + *(float *)(unaff_EBX + 0x2108e1 /* typeinfo name for ISaveRestoreOps+0x67 */);
    ...
    if ((iVar8 == 0) ||
       (((fVar21 = *(float *)(**(int **)(&DAT_004936f5 + unaff_EBX) + 0xc) -
         ...
         *(float *)(unaff_EBX + 0x213c05 /* typeinfo name for CTraceFilterSkipTwoEntitiesAndCheckTeamMask+0x30 */) <= fVar21 && fVar21 != *(float *)(unaff_EBX + 0x213c05 /* typeinfo name for CTraceFilterSkipTwoEntitiesAndCheckTeamMask+0x30 */) &&
         (cVar6 = CINSNextBot::IsIdle((CINSNextBot *)param_2), cVar6 != '\0')) &&
        (fVar20 = (float10)CINSNextBot::GetIdleDuration(this_00),
        *(float *)(unaff_EBX + 0x1a5dd1 /* typeinfo name for IServerBenchmark+0x13 */) <= (float)fVar20 &&
        (float)fVar20 != *(float *)(unaff_EBX + 0x1a5dd1 /* typeinfo name for IServerBenchmark+0x13 */))))) {
      uVar23 = *(undefined4 *)((int)param_2 + 0x54);
      uVar22 = **(undefined4 **)(unaff_EBX + 0x49350d /* &TheNavMesh */);
    ...
    iVar19 = **(int **)(unaff_EBX + 0x493b71 /* &g_pObjectiveResource */);
    ...
    if ((bVar5) || (0 < local_1a8)) {
      uVar23 = CINSNavMesh::GetRandomControlPointArea(**(int **)(unaff_EBX + 0x49350d /* &TheNavMesh */));
    ...
    if ((((float)fVar20 < *(float *)(unaff_EBX + 0x213c09 /* typeinfo name for CTraceFilterSkipTwoEntitiesAndCheckTeamMask+0x34 */)) &&
        (*(char *)((int)param_2 + 0x6c) != '\0')) &&
       ((iVar8 = *(int *)(**(int **)(unaff_EBX + 0x493b71 /* &g_pObjectiveResource */) + 0x6f0 +
  ...
  if (*(float *)((int)param_2 + 0x74) <= 0.0) {
    ...
    fVar20 = (float10)CountdownTimer::Now();
    fVar21 = (float)fVar20 + *(float *)(unaff_EBX + 0x213c05 /* typeinfo name for CTraceFilterSkipTwoEntitiesAndCheckTeamMask+0x30 */);
    ...
    if (iVar8 != 0) {
      ...
      if (iVar8 != 0) {
        ...
        pcVar16 = (char *)(unaff_EBX + 0x26d3ff /* " newgoal" */);
        *(undefined4 *)((int)param_2 + 0x38) = uVar23;
        ...
        *pcVar12 = '\0';
        ...
        local_3c = *(float *)(unaff_EBX + 0x1a5975 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x40 */);
        ...
        pcVar16 = (char *)(unaff_EBX + 0x26d408 /* " no cover" */);
        pcVar12 = local_197 + local_94;
        if (pcVar12 < local_98) {
          do {
            cVar6 = *pcVar16;
...
LAB_00713cb6:
  ...
  iVar18 = **(int **)(unaff_EBX + 0x493b71 /* &g_pObjectiveResource */);
...
LAB_00713477:
    if (iVar8 != 0) {
      ...
      iVar8 = unaff_EBX + 0x26d476 /* "Crouching at CP" */;
      ...
      if (*(float *)((int)param_2 + 0x80) <= (float)fVar20 &&
        ...
        if (iVar8 != 0) {
          ...
          **(int **)(unaff_EBX + 0x4938d1 /* &CNavArea::s_nCurrVisTestCounter */) = **(int **)(unaff_EBX + 0x4938d1 /* &CNavArea::s_nCurrVisTestCounter */) + 1;
          local_78 = (int *)0x0;
            ...
            do {
              while( true ) {
                ...
                if ((pCVar2 != (CUtlVector<CNavArea*,CUtlMemory<CNavArea*,int>> *)0x0) &&
                   (*(undefined4 *)(pCVar2 + 0x148) = **(undefined4 **)(unaff_EBX + 0x4938d1 /* &CNavArea::s_nCurrVisTestCounter */),
...
LAB_00713618:
          ...
          if ((iVar18 != 0) && (0 < *(int *)(iVar18 + 0x13c))) {
            ...
            do {
              ...
              if ((iVar3 != 0) && (*(int *)(iVar3 + 0x148) != **(int **)(unaff_EBX + 0x4938d1 /* &CNavArea::s_nCurrVisTestCounter */))) {
                *(int *)(iVar3 + 0x148) = **(int **)(unaff_EBX + 0x4938d1 /* &CNavArea::s_nCurrVisTestCounter */);
...

{
  ...
  return extraout_ECX + 0x26c388 /* "Capturing CP" */;
}
...

{
  ...
  fVar1 = (float10)(**(code **)(*(int *)(in_stack_0000000c + 0x2060) + 0x134))
                             (in_stack_0000000c + 0x2060,extraout_EDX + 0x58 /* CINSBotCaptureCP::OnMoveToSuccess */);
  if ((float)fVar1 < *(float *)(unaff_EBX + 0x1a5f89 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x40 */)) {
...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x493f6d /* &vtable for CINSBotStuck */);
  piVar2[0xf] = 0;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x481de3 /* vtable for CINSBotCaptureCP+0x8 */;
  in_stack_00000004[1] = (int)(&UNK_00481f77 + extraout_ECX);
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x492f33 /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x481d9a /* vtable for CINSBotCaptureCP+0x8 */;
