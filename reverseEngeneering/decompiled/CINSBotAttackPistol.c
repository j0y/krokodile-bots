...

{
  ...
  if (in_stack_00000008 != (CINSWeapon *)0x0) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      pfVar1 = *(float **)(unaff_EBX + 0x496be8 /* &vec3_origin */ /* &vec3_origin */);
...

{
  ...
  if (in_stack_0000000c != (CINSWeapon *)0x0) {
    ...
    iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x496e58 /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */) + 0x40))
        ...
        if (fVar2 < (float)fVar6) {
          ...
          if (cVar1 == '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x27026a /* "Walking At Target" */ /* "Walking At Target" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */);
            }
            else {
              (**(code **)(*(int *)in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))();
              uVar8 = 0x3f0ccccd /* 0.55f */;
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x270236 /* "Crouching From Suppression" */ /* "Crouching From Suppression" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */);
            }
          }
            ...
            if (cVar1 == '\0') {
              ...
              if ((float)fVar6 <= local_24) {
                ...
                uVar8 = 0x3f0ccccd /* 0.55f */;
                uVar7 = 7;
                iVar4 = unaff_EBX + 0x27021c /* "Crawling From Suppression" */ /* "Crawling From Suppression" */;
                CINSBotBody::SetPosture();
              }
            }
            else {
              ...
              uVar8 = 0x3f0ccccd /* 0.55f */;
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x270251 /* "Walking From Suppression" */ /* "Walking From Suppression" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */);
            }
          }
          ...
          uVar8 = 0x3f0ccccd /* 0.55f */;
          uVar7 = 7;
          iVar4 = unaff_EBX + 0x27027c /* "Sprinting At Target" */ /* "Sprinting At Target" */;
          CINSBotBody::SetPosture();
          local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */);
        }
...

{
  ...
  if (piVar2 != (int *)0x0) {
    ...
    cVar3 = (*(float *)(unaff_EBX + 0x215ca8 /* 360.0f */ /* 360.0f */) <= (float)fVar4) * '\x02';
  }
  return cVar3;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4854c3 /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x48566b /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x496c13 /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48547a /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x485622 /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */;
