...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x470a2d /* vtable for CINSBotPatrol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x470bc5 /* vtable for CINSBotPatrol+0x1a0 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f67ab /* CountdownTimer::NetworkStateChanged */);
  ...
  in_stack_00000004[0x1230] = -0x40800000;
  ...
  in_stack_00000004[0x1233] = -0x40800000;
  ...
  in_stack_00000004[0x1236] = -0x40800000;
  ...
  in_stack_00000004[0x123f] = -0x40800000;
  (**(code **)(in_stack_00000004[0x123d] + 4))(piVar5,in_stack_00000004 + 0x123f);
  iVar4 = *(int *)(unaff_EBX + 0x47fd35 /* &vtable for IntervalTimer */);
  in_stack_00000004[0x1241] = -0x40800000;
  ...
  in_stack_00000004[0x1244] = -0x40800000;
  ...
  in_stack_00000004[0x1247] = -0x40800000;
  ...
  piVar5 = *(int **)(unaff_EBX + 0x47f6b1 /* &vec3_origin */);
  *(undefined1 *)(in_stack_00000004 + 0x123c) = 0;
  *(undefined1 *)(in_stack_00000004 + 0x1237) = 0;
  in_stack_00000004[0x123b] = -0x40800000;
...

{
  ...
  if (cVar1 != '\0') {
    *(undefined4 *)(param_2 + 0x4930) = *(undefined4 *)(**(int **)(unaff_EBX + 0x47e8d1 /* &g_pObjectiveResource */) + 0x770);
  }
  ...
  if (cVar1 != '\0') {
    ...
    fVar5 = (float)fVar4 + *(float *)(unaff_EBX + 0x1fd905 /* typeinfo name for ICollideable+0x13 */);
    ...
    if (*(int *)(param_2 + 0x490c) != 0x40c00000) {
      (**(code **)(*(int *)(param_2 + 0x4908) + 4))(param_2 + 0x4908,param_2 + 0x490c);
      *(undefined4 *)(param_2 + 0x490c) = 0x40c00000;
    ...
    *(undefined4 *)(param_2 + 0x38) = uVar2;
    ...
    if (*(float *)(in_stack_0000000c + 0xb4a8) <= (float)fVar4 &&
      ...
      fVar4 = (float10)RandomFloat(0x41200000,0x42200000);
      fVar5 = (float)fVar4;
      fVar4 = (float10)CountdownTimer::Now();
    ...
    fVar4 = (float10)RandomFloat(0x3dcccccd,0x3f800000);
    fVar5 = (float)fVar4;
    fVar4 = (float10)CountdownTimer::Now();
...

{
  ...
  __i686_get_pc_thunk_bx();
  piVar12 = (int *)(**(code **)(*in_stack_0000000c + 0x974))();
  iVar13 = (**(code **)(*piVar12 + 0xd0))(piVar12,0);
  if (iVar13 != 0) {
    piVar12 = (int *)(**(code **)(*in_stack_0000000c + 0x97c))();
    iVar13 = (**(code **)(*piVar12 + 0xd4))(piVar12,in_stack_0000000c + 0x818,iVar13);
    if (iVar13 == 1) {
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
    ...
    if ((((((uint)fVar19 & 0x7f800000) == 0x7f800000) ||
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x259afd /* "Goal position no longer valid?" */;
      ...
      if ((0.0 < *(float *)((int)param_2 + 0x4904)) &&
         ...
         fVar19 < *(float *)(unaff_EBX + 0x1ff1e9 /* typeinfo name for CEntityFactory<CFuncLadder>+0x20 */) || fVar19 == *(float *)(unaff_EBX + 0x1ff1e9 /* typeinfo name for CEntityFactory<CFuncLadder>+0x20 */))) {
            ...
            if (cVar10 != '\0') {
              ...
              if (iVar13 == *(int *)((int)param_2 + 0x4930)) {
                *(undefined4 *)((int)param_2 + 0x4930) = 0xffffffff;
                iVar13 = **(int **)(unaff_EBX + 0x47f365 /* &g_pObjectiveResource */);
...
LAB_00728208:
        ...
        if (*(float *)((int)param_2 + 0x48c0) <= (float)fVar18 &&
          ...
          fVar18 = (float10)CountdownTimer::Now();
          fVar19 = (float)fVar18 + *(float *)(unaff_EBX + 0x19115d /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x34 */);
          ...
          if (*(int *)((int)param_2 + 0x48bc) != 0x3f800000) {
            (**(code **)(*(int *)((int)param_2 + 0x48b8) + 4))
                      ((int)param_2 + 0x48b8,(int)param_2 + 0x48bc);
            *(undefined4 *)((int)param_2 + 0x48bc) = 0x3f800000;
          }
        }
        fVar18 = (float10)CountdownTimer::Now();
        if (*(float *)((int)param_2 + 0x48fc) <= (float)fVar18 &&
          ...
          if (((*(float *)((int)param_2 + 0x48d8) <= 0.0) &&
             ...
             *(float *)(unaff_EBX + 0x1fcda9 /* typeinfo name for CBaseGameSystem+0x26 */) <= (float)fVar18 &&
             (float)fVar18 != *(float *)(unaff_EBX + 0x1fcda9 /* typeinfo name for CBaseGameSystem+0x26 */))) {
            GetNextPatrolArea(this_10);
            this_01 = (CINSNextBot *)extraout_ECX_01;
          }
          cVar10 = CINSRules::IsSurvival((CINSRules *)this_01);
          if ((cVar10 != '\0') &&
             (iVar13 = *(int *)(**(int **)(unaff_EBX + 0x47f365 /* &g_pObjectiveResource */) + 0x770),
          ...
          *(float *)((int)param_2 + 0x48ec) = (float)fVar18;
          ...
          local_20 = *(float *)(unaff_EBX + 0x2366c1 /* typeinfo name for CMemberFunctor0<CParallelProcessor<CNavArea*, CFuncJobItemProcessor<CNavArea*>, 1>*, void (CParallelProcessor<CNavArea*, CFuncJobItemProcessor<CNavArea*>, 1>::*)(), CRefCounted1<CFunctor, CRefCountServiceBase<true, CRefMT> >, CFuncMemPolicyNone>+0xd8 */) + *(float *)((int)param_2 + 0x44);
          uVar11 = (**(code **)(*piVar12 + 0x108))(piVar12,&local_28,0);
        ...
        if (((*(char *)((int)param_2 + 0x4920) != '\0') &&
          ...
          *(undefined4 *)((int)param_2 + 0x44) = *(undefined4 *)((int)param_2 + 0x492c);
          uVar15 = (**(code **)(*in_stack_0000000c + 0x96c))();
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (*(int *)(param_2 + 0x48c0) != -0x40800000) {
    (**(code **)(*(int *)(param_2 + 0x48b8) + 4))(param_2 + 0x48b8,param_2 + 0x48c0);
    *(undefined4 *)(param_2 + 0x48c0) = 0xbf800000;
  }
  fVar4 = (float10)IntervalTimer::Now();
  if (*(float *)(param_2 + 0x4904) != (float)fVar4) {
    (**(code **)(*(int *)(param_2 + 0x4900) + 8))(param_2 + 0x4900,param_2 + 0x4904);
  ...
  uVar2 = CNavMesh::GetNearestNavArea
                    (pCVar3,**(undefined4 **)(unaff_EBX + 0x47e3ed /* &TheNavMesh */),in_stack_0000000c + 0x208,0,
                     0x461c4000,0,1,0);
  *(undefined4 *)(param_2 + 0x38) = uVar2;
  cVar1 = CINSRules::IsSurvival(this_00);
  if (cVar1 != '\0') {
    *(undefined4 *)(param_2 + 0x4930) = *(undefined4 *)(**(int **)(unaff_EBX + 0x47ea51 /* &g_pObjectiveResource */) + 0x770);
  }
  cVar1 = GetNextPatrolArea(this_01);
  if (cVar1 != '\0') {
    *(undefined4 *)param_1 = 0;
...

{
  ...
  return extraout_ECX + 0x259a75 /* "Patrol" */;
}
...

{
  ...
  if (((iVar4 != 0) && (iVar4 != 0x2060)) &&
     (piVar1 = *(int **)(unaff_EBX + 0x480ad2 /* &g_pGameRules */), *piVar1 != 0)) {
    cVar2 = CINSRules::IsSurvival(this);
    if (cVar2 != '\0') {
      fVar5 = ((float)*(int *)(*piVar1 + 1000) + *(float *)(unaff_EBX + 0x192cea /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x30 */)) *
              *(float *)(unaff_EBX + 0x20dd1a /* typeinfo name for CINSRules_Survival+0x20 */);
      if (*(float *)(unaff_EBX + 0x192cee /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x34 */) <= fVar5) {
        fVar5 = *(float *)(unaff_EBX + 0x192cee /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x34 */);
      }
      if (fVar5 <= *(float *)(unaff_EBX + 0x192ce2 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x28 */)) {
        fVar5 = *(float *)(unaff_EBX + 0x192ce2 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x28 */);
      }
      if (fVar5 * *(float *)(&DAT_0025b87a + unaff_EBX) + *(float *)(unaff_EBX + 0x1ff1ea /* typeinfo name for ITraceFilter+0x20 */) <
    ...
    if (cVar2 != '\0') {
      ...
      if (((iVar3 != 0) &&
          (iVar3 = __dynamic_cast(iVar3,*(undefined4 *)(unaff_EBX + 0x4807c2 /* &typeinfo for CNavArea */),
                                  *(undefined4 *)(unaff_EBX + 0x480e62 /* &typeinfo for CINSNavArea */),0,uVar7,uVar8,uVar9),
          this_01 = extraout_ECX_01, iVar3 != 0)) && ((*(uint *)(iVar3 + 0x160) & 0x2004) != 0)) {
        if (*(float *)(unaff_EBX + 0x233a92 /* typeinfo name for CEntityFactory<CGib>+0x1f */) < *(float *)(param_1 + 0x48ec)) {
          return 1;
        }
    ...
    iVar3 = 2;
    if ((cVar2 == '\0') && (*(float *)(unaff_EBX + 0x233a92 /* typeinfo name for CEntityFactory<CGib>+0x1f */) < *(float *)(param_1 + 0x48ec))) {
...

{
  ...
  piVar1 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
  iVar2 = (**(code **)(*piVar1 + 0x134))(piVar1);
  if (iVar2 < 3) {
    piVar1 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
    (**(code **)(*piVar1 + 0x130))(piVar1,3);
  }
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 8) = 0;
...

{
  ...
  if (cVar3 == '\0') {
    ...
    *(undefined4 *)(param_1 + 0xc) = 1;
    ...
    pfVar2 = *(float **)(unaff_EBX + 0x4801eb /* &vec3_origin */);
    if (((*pfVar2 == local_3c) && (pfVar2[1] == local_38)) && (pfVar2[2] == local_34)) {
      fVar6 = (float10)RandomFloat(0x3f800000,0x40400000,uVar8);
      fVar1 = (float)fVar6;
      ...
      CINSNextBot::GetHidingCover(true);
      uVar8 = (**(code **)(*(int *)in_stack_0000000c + 0x96c))(in_stack_0000000c,pCVar7,uVar8);
      CINSBotLocomotion::AddMovementRequest(uVar8,local_28,local_24,local_20,4,3,0x40000000);
      in_stack_0000000c[0x2290] = (CBaseEntity)0x1;
      fVar6 = (float10)RandomFloat(0x41200000,0x41700000);
      fVar1 = (float)fVar6;
      iVar4 = (**(code **)(*(int *)in_stack_0000000c + 0x548))(in_stack_0000000c);
      if (iVar4 != 0) {
...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x480e2d /* &vtable for CINSBotStuck */);
  piVar2[0xf] = 0;
  piVar2[1] = iVar1 + 0x198;
  *piVar2 = iVar1 + 8;
  piVar2[0xe] = unaff_EBX + 0x40262d /* vtable for CountdownTimer+0x8 */;
  CountdownTimer::NetworkStateChanged(piVar2 + 0xe);
  piVar2[0x10] = -0x40800000;
  (**(code **)(piVar2[0xe] + 4))(piVar2 + 0xe,piVar2 + 0x10);
  piVar2[0x16] = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x259ec6 /* "I'm Stuck" */;
  piVar2[0x17] = 0;
  piVar2[0x18] = 0;
  piVar2[0x19] = 0;
  piVar2[0x1a] = 0;
...

{
  ...
  piVar1 = (int *)(**(code **)(*in_stack_0000000c + 0x970))();
  iVar2 = (**(code **)(*piVar1 + 0x134))(piVar1);
  if (iVar2 < 5) {
    piVar1 = (int *)(**(code **)(*in_stack_0000000c + 0x970))();
    (**(code **)(*piVar1 + 0x130))(piVar1,5);
  }
  *(undefined4 *)param_1 = 0;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 8) = 0;
...

{
  ...
  if (param_3 != (CTakeDamageInfo *)0x0) {
    ...
    if ((iVar2 < 8) && (in_stack_00000010 != (int *)0x0)) {
      ...
      if (iVar2 == iVar3) {
        pfVar4 = (float *)(**(code **)(*in_stack_00000010 + 0x260))(in_stack_00000010);
        pfVar5 = (float *)(**(code **)(*(int *)param_3 + 0x260))(param_3);
        if (SQRT((pfVar5[1] - pfVar4[1]) * (pfVar5[1] - pfVar4[1]) +
                 (*pfVar5 - *pfVar4) * (*pfVar5 - *pfVar4) +
                 (pfVar5[2] - pfVar4[2]) * (pfVar5[2] - pfVar4[2])) <
            *(float *)(unaff_EBX + 0x1ff044 /* typeinfo name for ITraceFilter+0x28 */)) {
          piVar1 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
          (**(code **)(*piVar1 + 0x130))(piVar1,8);
        }
      }
    }
  }
  ...
  if (in_stack_00000010 != (int *)0x0) {
    ...
    if (cVar1 != '\0') {
      ...
      if (cVar1 == '\0') {
        ...
        if (iVar2 != 0) {
          if (**(int **)(unaff_EBX + 0x47fbf4 /* &TheNavMesh */) != 0) {
            iVar2 = TheINSNextBots();
            if (*(char *)(iVar2 + 0x129) != '\0') {
              pCVar3 = (CBaseEntity *)
                       (**(code **)(*(int *)in_stack_0000000c + 0x974))(in_stack_0000000c);
...

{
  ...
  __i686_get_pc_thunk_bx();
  pfVar6 = (float *)(**(code **)(*(int *)param_3 + 0x260))(param_3);
  ...
  if (SQRT((pfVar6[1] - in_stack_00000010[1]) * (pfVar6[1] - in_stack_00000010[1]) +
    ...
    *(float *)(param_2 + 0x492c) = fVar5;
    if ((((((uint)fVar1 & 0x7f800000) != 0x7f800000) && (((uint)fVar4 & 0x7f800000) != 0x7f800000))
       ...
       ((((fVar2 = *(float *)(unaff_EBX + 0x202ab1 /* typeinfo name for CTraceFilterIgnoreWeapons+0x41 */), fVar1 <= fVar2 ||
          (fVar3 = *(float *)(unaff_EBX + 0x1fe915 /* typeinfo name for ITraceFilter+0x40 */), fVar3 <= fVar1)) ||
         ((fVar4 <= fVar2 || ((fVar3 <= fVar4 || (fVar5 <= fVar2)))))) || (fVar3 <= fVar5)))) {
      param_2[0x4920] = (Vector)0x1;
      fVar7 = (float10)RandomFloat(0x3dcccccd,0x40400000);
      fVar1 = (float)fVar7;
...

{
  ...
  iVar14 = *(int *)(unaff_EBX + 0x47fd55 /* &TheNavAreas */);
...
LAB_00727520:
    ...
    local_54 = 0;
    local_50 = (Vector *)0x0;
    iVar14 = **(int **)(unaff_EBX + 0x47fa91 /* &g_pObjectiveResource */);
    local_4c = 0;
...
LAB_007277ad:
      ...
      do {
        ...
        if (piVar10 != (int *)0x0) {
          ...
          if (((iVar13 == iVar9) &&
              (cVar7 = (**(code **)(*piVar10 + 0x118))(piVar10), cVar7 != '\0')) &&
             (iVar13 = (**(code **)(*piVar10 + 0x548))(piVar10), iVar13 != 0)) {
            ...
            fVar17 = ((float)piVar5[0x83] - (float)piVar10[0x83]) *
                     ...
                     ((float)piVar5[0x84] - (float)piVar10[0x84]);
            if (*(float *)(unaff_EBX + 0x25a41d /* typeinfo name for CollectIdealPatrolAreas+0x24 */) <= fVar17 &&
                fVar17 != *(float *)(unaff_EBX + 0x25a41d /* typeinfo name for CollectIdealPatrolAreas+0x24 */)) {
              iVar14 = (**(code **)(*piVar10 + 0x548))(piVar10);
              goto LAB_0072775e;
            }
          }
        }
      ...
      do {
        ...
        if (iVar9 == iVar14) {
          ...
          if (iVar14 == 2) {
            cVar7 = *(char *)(**(int **)(unaff_EBX + 0x47fa91 /* &g_pObjectiveResource */) + 0x6a0 + iVar13);
          }
          else {
            cVar7 = *(char *)(**(int **)(unaff_EBX + 0x47fa91 /* &g_pObjectiveResource */) + 0x690 + iVar13);
          }
          if (cVar7 == '\0') {
            CINSNavMesh::GetControlPointHidingSpot((int)&local_3c);
            pfVar6 = *(float **)(unaff_EBX + 0x47f341 /* &vec3_origin */);
        ...
        pCVar12 = *(CBaseEntity **)(unaff_EBX + 0x47fa91 /* &g_pObjectiveResource */);
        iVar13 = iVar13 + 1;
        iVar14 = *(int *)pCVar12;
...
LAB_0072775e:
    ...
    if (local_54 < 0) {
      ...
      if (local_5c != 0) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x47f5ed /* &GCSDK::GetPchTempTextBuffer */) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x47f5ed /* &GCSDK::GetPchTempTextBuffer */),local_5c);
        local_5c = 0;
      }
      local_58 = 0;
      local_4c = 0;
    ...
    do {
      ...
      if (*(int *)(iVar13 + 4) != 0) {
        ...
        uVar1 = *(uint *)(unaff_EBX + 0x191891 /* typeinfo name for CEntityFactory<CInfoElevatorFloor>+0x3c */);
        uVar2 = *(uint *)(unaff_EBX + 0x1fd4c1 /* typeinfo name for CBaseGameSystem+0x12 */);
        fVar16 = (float10)RandomFloat(0,0x3f800000);
...
LAB_0072741d:
    ...
    *(float *)(in_stack_00000004 + 0x44) = local_24;
    if (((((uint)local_2c & 0x7f800000) != 0x7f800000) &&
       ...
       ((((uint)local_24 & 0x7f800000) != 0x7f800000 &&
        (((((fVar17 = *(float *)(unaff_EBX + 0x201f41 /* typeinfo name for CTraceFilterIgnoreWeapons+0x41 */), local_2c <= fVar17 ||
            (fVar3 = *(float *)(unaff_EBX + 0x1fdda5 /* typeinfo name for ITraceFilter+0x40 */), fVar3 <= local_2c)) || (local_28 <= fVar17))
          || ((fVar3 <= local_28 || (local_24 <= fVar17)))) || (fVar3 <= local_24)))))) {
      uVar8 = (**(code **)(*piVar5 + 0x96c))(piVar5,iVar14);
      CINSBotLocomotion::AddMovementRequest
  ...
  uVar8 = 0;
LAB_00727662:
  local_8c[0] = unaff_EBX + 0x470895 /* vtable for CollectIdealPatrolAreas+0x8 */;
  if (0 < local_78) {
    iVar14 = 0;
    do {
      iVar13 = iVar14 * 4;
  ...
  if ((-1 < local_7c) && (local_84[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x47f5ed /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x47f5ed /* &GCSDK::GetPchTempTextBuffer */),local_84[0]);
  }
  return uVar8;
}
...

{
  ...
  piVar1 = (int *)(**(code **)(*piVar1 + 0x974))(piVar1);
  ...
  if ((in_stack_00000010 != (int *)0x0) &&
    ...
    if ((iVar2 != iVar3) &&
       (((iVar2 = CINSPlayer::GetActiveINSWeapon(), iVar2 != 0 &&
         (iVar2 = **(int **)(unaff_EBX + 0x47fa34 /* &TheNavMesh */), iVar2 != 0)) &&
      ...
      if (((iVar2 != 0) &&
           ...
           *(float *)(iVar2 + 0xec)) * *(float *)(unaff_EBX + 0x1fce08 /* typeinfo name for ISaveRestoreOps+0x67 */) <
           *(float *)(unaff_EBX + 0x1fdad4 /* typeinfo name for CBaseGameSystem+0x1e */))) &&
         ((cVar1 = CINSWeapon::HasFlashlight(this_01), cVar1 != '\0' &&
          (cVar1 = CINSWeapon::IsFlashlightOn(this_02), cVar1 == '\0')))) {
        fVar5 = (float10)CountdownTimer::Now();
        fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x1fdae8 /* typeinfo name for CBaseGameSystem+0x32 */);
        if (*(float *)(param_2 + 0x48cc) != fVar6) {
          (**(code **)(*(int *)(param_2 + 0x48c4) + 4))(param_2 + 0x48c4,param_2 + 0x48cc);
          *(float *)(param_2 + 0x48cc) = fVar6;
        }
...

{
  ...
  if ((in_stack_00000010 != 0) && (param_3 != (CNavArea *)0x0)) {
    ...
    if ((*(char *)(iVar2 + 0x129) != '\0') &&
        ...
        *(float *)(unaff_EBX + 0x1fd158 /* typeinfo name for ISaveRestoreOps+0x67 */) < *(float *)(&LAB_00202880 + unaff_EBX))) {
        ...
        if (iVar2 != 0) {
          ...
          if (cVar1 != '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              fVar4 = (float)fVar3 + *(float *)(unaff_EBX + 0x192648 /* typeinfo name for IServerBenchmark+0x13 */);
              if (*(float *)(param_2 + 0x48cc) != fVar4) {
                (**(code **)(*(int *)(param_2 + 0x48c4) + 4))(param_2 + 0x48c4,param_2 + 0x48cc);
                *(float *)(param_2 + 0x48cc) = fVar4;
              }
              if (*(int *)(param_2 + 0x48c8) != 0x40400000) {
                (**(code **)(*(int *)(param_2 + 0x48c4) + 4))(param_2 + 0x48c4,param_2 + 0x48c8);
                *(undefined4 *)(param_2 + 0x48c8) = 0x40400000;
...

{
  ...
  __i686_get_pc_thunk_bx();
  if ((in_stack_00000010 != (int *)0x0) &&
     (cVar4 = (**(code **)(*in_stack_00000010 + 0x158))(in_stack_00000010), cVar4 != '\0')) {
    iVar9 = CBaseEntity::GetTeamNumber(this_00);
    iVar10 = CBaseEntity::GetTeamNumber(this_02);
    if (iVar9 != iVar10) {
      piVar11 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
      iVar9 = (**(code **)(*piVar11 + 0x134))(piVar11);
      if (iVar9 < 3) {
        piVar11 = (int *)(**(code **)(*(int *)param_3 + 0x970))(param_3);
        (**(code **)(*piVar11 + 0x130))(piVar11,3);
      }
    }
  }
  pfVar5 = (float *)(**(code **)(*in_stack_00000010 + 0x260))(in_stack_00000010);
  pfVar6 = (float *)(**(code **)(*(int *)param_3 + 0x260))(param_3);
  fVar14 = SQRT((pfVar6[1] - pfVar5[1]) * (pfVar6[1] - pfVar5[1]) +
                (*pfVar6 - *pfVar5) * (*pfVar6 - *pfVar5) +
                (pfVar6[2] - pfVar5[2]) * (pfVar6[2] - pfVar5[2]));
  if ((fVar14 < *(float *)(unaff_EBX + 0x1fef15 /* typeinfo name for ITraceFilter+0x20 */) || fVar14 == *(float *)(unaff_EBX + 0x1fef15 /* typeinfo name for ITraceFilter+0x20 */)) ||
     (*(float *)(unaff_EBX + 0x2337bd /* typeinfo name for CEntityFactory<CGib>+0x1f */) <= fVar14)) {
    fVar13 = (float10)RandomFloat(0,0x3f800000);
  ...
  puVar7[1] = unaff_EBX + 0x4020bd /* vtable for CountdownTimer+0x8 */;
  puVar7[2] = 0;
  ...
  fVar14 = (float)fVar13 + *(float *)(unaff_EBX + 0x1fe0b5 /* typeinfo name for CTraceFilterNoCombatCharacters+0x30 */);
...

{
  ...
  return (*(float *)(unaff_EBX + 0x1ff295 /* typeinfo name for ITraceFilter+0x2c */) < *(float *)(param_1 + 0x48ec) ||
         *(float *)(unaff_EBX + 0x1ff295 /* typeinfo name for ITraceFilter+0x2c */) == *(float *)(param_1 + 0x48ec)) + '\x01';
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46f0ea /* vtable for CINSBotPatrol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x46f282 /* vtable for CINSBotPatrol+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46f07a /* vtable for CINSBotPatrol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x46f212 /* vtable for CINSBotPatrol+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
