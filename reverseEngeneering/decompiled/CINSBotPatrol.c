...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x470a2d;
  in_stack_00000004[1] = unaff_EBX + 0x470bc5;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f67ab);
...

{
  ...
  if (cVar1 != '\0') {
    *(undefined4 *)(param_2 + 0x4930) = *(undefined4 *)(**(int **)(unaff_EBX + 0x47e8d1) + 0x770);
  }
  ...
  if (cVar1 != '\0') {
    ...
    fVar5 = (float)fVar4 + *(float *)(unaff_EBX + 0x1fd905);
...
LAB_00728208:
        ...
        if (*(float *)((int)param_2 + 0x48c0) <= (float)fVar18 &&
          ...
          if ((cVar10 != '\0') && (*(char *)(*piVar12 + 0x3ac) != '\0')) {
            *(undefined4 *)param_1 = 3;
            *(undefined4 *)(param_1 + 4) = 0;
            *(int *)(param_1 + 8) = unaff_EBX + 0x259c69;
            return param_1;
          }
          fVar18 = (float10)CountdownTimer::Now();
          fVar19 = (float)fVar18 + *(float *)(unaff_EBX + 0x19115d);
        ...
        if (*(float *)((int)param_2 + 0x48fc) <= (float)fVar18 &&
          ...
          if (((*(float *)((int)param_2 + 0x48d8) <= 0.0) &&
             ...
             *(float *)(unaff_EBX + 0x1fcda9) <= (float)fVar18 &&
             (float)fVar18 != *(float *)(unaff_EBX + 0x1fcda9))) {
            GetNextPatrolArea(this_10);
            this_01 = (CINSNextBot *)extraout_ECX_01;
          }
          cVar10 = CINSRules::IsSurvival((CINSRules *)this_01);
          if ((cVar10 != '\0') &&
             (iVar13 = *(int *)(**(int **)(unaff_EBX + 0x47f365) + 0x770),
          ...
          *(float *)((int)param_2 + 0x48ec) = (float)fVar18;
          ...
          local_20 = *(float *)(unaff_EBX + 0x2366c1) + *(float *)((int)param_2 + 0x44);
      ...
      *(undefined4 *)param_1 = 3;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x259c39;
    }
  }
  else {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x259c1b;
  }
  return param_1;
}
...

{
  ...
  uVar2 = CNavMesh::GetNearestNavArea
                    (pCVar3,**(undefined4 **)(unaff_EBX + 0x47e3ed),in_stack_0000000c + 0x208,0,
                     0x461c4000,0,1,0);
  *(undefined4 *)(param_2 + 0x38) = uVar2;
  cVar1 = CINSRules::IsSurvival(this_00);
  if (cVar1 != '\0') {
    *(undefined4 *)(param_2 + 0x4930) = *(undefined4 *)(**(int **)(unaff_EBX + 0x47ea51) + 0x770);
  }
  cVar1 = GetNextPatrolArea(this_01);
  if (cVar1 != '\0') {
    *(undefined4 *)param_1 = 0;
  ...
  *(undefined4 *)param_1 = 3;
  *(int *)(param_1 + 8) = unaff_EBX + 0x259341;
  *(undefined4 *)(param_1 + 4) = 0;
  return param_1;
}
...

{
  ...
  if (((iVar4 != 0) && (iVar4 != 0x2060)) &&
     (piVar1 = *(int **)(unaff_EBX + 0x480ad2), *piVar1 != 0)) {
    cVar2 = CINSRules::IsSurvival(this);
    if (cVar2 != '\0') {
      fVar5 = ((float)*(int *)(*piVar1 + 1000) + *(float *)(unaff_EBX + 0x192cea)) *
              *(float *)(unaff_EBX + 0x20dd1a);
      if (*(float *)(unaff_EBX + 0x192cee) <= fVar5) {
        fVar5 = *(float *)(unaff_EBX + 0x192cee);
      }
      if (fVar5 <= *(float *)(unaff_EBX + 0x192ce2)) {
        fVar5 = *(float *)(unaff_EBX + 0x192ce2);
      }
      if (fVar5 * *(float *)(&DAT_0025b87a + unaff_EBX) + *(float *)(unaff_EBX + 0x1ff1ea) <
    ...
    if (cVar2 != '\0') {
      ...
      if (((iVar3 != 0) &&
          (iVar3 = __dynamic_cast(iVar3,*(undefined4 *)(unaff_EBX + 0x4807c2),
                                  *(undefined4 *)(unaff_EBX + 0x480e62),0,uVar7,uVar8,uVar9),
          this_01 = extraout_ECX_01, iVar3 != 0)) && ((*(uint *)(iVar3 + 0x160) & 0x2004) != 0)) {
        if (*(float *)(unaff_EBX + 0x233a92) < *(float *)(param_1 + 0x48ec)) {
          return 1;
        }
    ...
    iVar3 = 2;
    if ((cVar2 == '\0') && (*(float *)(unaff_EBX + 0x233a92) < *(float *)(param_1 + 0x48ec))) {
...

{
  ...
  if (cVar3 == '\0') {
    *(undefined4 *)param_1 = 3;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x25b1dd;
    *(undefined4 *)(param_1 + 0xc) = 1;
  }
  else {
    uVar8 = 1;
    CINSNextBot::GetHidingCover(true);
    pfVar2 = *(float **)(unaff_EBX + 0x4801eb);
            ...
            if (*(char *)(iVar2 + 0x129) != '\0') {
              ...
              if (cVar1 != '\0') {
                ...
                if (cVar1 == '\0') {
                  ...
                  fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x1fdca8);
  ...
  if (SQRT((pfVar6[1] - in_stack_00000010[1]) * (pfVar6[1] - in_stack_00000010[1]) +
    ...
    *(float *)(param_2 + 0x492c) = fVar5;
    if ((((((uint)fVar1 & 0x7f800000) != 0x7f800000) && (((uint)fVar4 & 0x7f800000) != 0x7f800000))
       ...
       ((((fVar2 = *(float *)(unaff_EBX + 0x202ab1), fVar1 <= fVar2 ||
          (fVar3 = *(float *)(unaff_EBX + 0x1fe915), fVar3 <= fVar1)) ||
...
LAB_007277ad:
        ...
        if (piVar10 != (int *)0x0) {
          ...
          if (((iVar13 == iVar9) &&
            ...
            fVar17 = ((float)piVar5[0x83] - (float)piVar10[0x83]) *
                     ...
                     ((float)piVar5[0x84] - (float)piVar10[0x84]);
            if (*(float *)(unaff_EBX + 0x25a41d) <= fVar17 &&
                fVar17 != *(float *)(unaff_EBX + 0x25a41d)) {
      ...
      do {
        ...
        if (iVar9 == iVar14) {
          ...
          if (iVar14 == 2) {
            cVar7 = *(char *)(**(int **)(unaff_EBX + 0x47fa91) + 0x6a0 + iVar13);
          }
          else {
            cVar7 = *(char *)(**(int **)(unaff_EBX + 0x47fa91) + 0x690 + iVar13);
          }
          if (cVar7 == '\0') {
            CINSNavMesh::GetControlPointHidingSpot((int)&local_3c);
            pfVar6 = *(float **)(unaff_EBX + 0x47f341);
        ...
        pCVar12 = *(CBaseEntity **)(unaff_EBX + 0x47fa91);
        iVar13 = iVar13 + 1;
        iVar14 = *(int *)pCVar12;
...
LAB_0072775e:
    ...
    if (local_54 < 0) {
      ...
      if (local_5c != 0) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x47f5ed) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x47f5ed),local_5c);
        local_5c = 0;
      }
      local_58 = 0;
      local_4c = 0;
    ...
    do {
      ...
      if (*(int *)(iVar13 + 4) != 0) {
        ...
        uVar1 = *(uint *)(unaff_EBX + 0x191891);
        uVar2 = *(uint *)(unaff_EBX + 0x1fd4c1);
    ...
    *(float *)(in_stack_00000004 + 0x44) = local_24;
    if (((((uint)local_2c & 0x7f800000) != 0x7f800000) &&
       ...
       ((((uint)local_24 & 0x7f800000) != 0x7f800000 &&
        (((((fVar17 = *(float *)(unaff_EBX + 0x201f41), local_2c <= fVar17 ||
            (fVar3 = *(float *)(unaff_EBX + 0x1fdda5), fVar3 <= local_2c)) || (local_28 <= fVar17))
...
LAB_00727662:
  ...
  if ((-1 < local_7c) && (local_84[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x47f5ed) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x47f5ed),local_84[0]);
  }
  return uVar8;
}
...

{
  ...
  *(undefined4 *)param_1 = 3;
  *(int *)(param_1 + 8) = unaff_EBX + 0x259f33;
  *(undefined4 *)(param_1 + 4) = 0;
  ...
  if ((in_stack_00000010 != (int *)0x0) &&
    ...
    if ((iVar2 != iVar3) &&
       (((iVar2 = CINSPlayer::GetActiveINSWeapon(), iVar2 != 0 &&
         (iVar2 = **(int **)(unaff_EBX + 0x47fa34), iVar2 != 0)) &&
      ...
      if (((iVar2 != 0) &&
           ...
           *(float *)(iVar2 + 0xec)) * *(float *)(unaff_EBX + 0x1fce08) <
           *(float *)(unaff_EBX + 0x1fdad4))) &&
         ((cVar1 = CINSWeapon::HasFlashlight(this_01), cVar1 != '\0' &&
          (cVar1 = CINSWeapon::IsFlashlightOn(this_02), cVar1 == '\0')))) {
        fVar5 = (float10)CountdownTimer::Now();
        fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x1fdae8);
        if (*(float *)(param_2 + 0x48cc) != fVar6) {
          (**(code **)(*(int *)(param_2 + 0x48c4) + 4))(param_2 + 0x48c4,param_2 + 0x48cc);
          *(float *)(param_2 + 0x48cc) = fVar6;
        }
...

{
  ...
  if ((in_stack_00000010 != 0) && (param_3 != (CNavArea *)0x0)) {
    ...
    if ((*(char *)(iVar2 + 0x129) != '\0') &&
        ...
        *(float *)(unaff_EBX + 0x1fd158) < *(float *)(&LAB_00202880 + unaff_EBX))) {
        ...
        if (iVar2 != 0) {
          ...
          if (cVar1 != '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              fVar4 = (float)fVar3 + *(float *)(unaff_EBX + 0x192648);
...

{
  ...
  if ((fVar14 < *(float *)(unaff_EBX + 0x1fef15) || fVar14 == *(float *)(unaff_EBX + 0x1fef15)) ||
     (*(float *)(unaff_EBX + 0x2337bd) <= fVar14)) {
  ...
  fVar14 = (float)fVar13 + *(float *)(unaff_EBX + 0x1fe0b5);
...

{
  ...
  return (*(float *)(unaff_EBX + 0x1ff295) < *(float *)(param_1 + 0x48ec) ||
         *(float *)(unaff_EBX + 0x1ff295) == *(float *)(param_1 + 0x48ec)) + '\x01';
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46f0ea;
  in_stack_00000004[1] = unaff_EBX + 0x46f282;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46f07a;
  in_stack_00000004[1] = unaff_EBX + 0x46f212;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
