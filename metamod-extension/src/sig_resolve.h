...
struct ServerOffsets
{
    ...
    static constexpr uintptr_t CINSBotInvestigate_ctor_vec    = 0x00714290;
    // Game rules (BSS)
...
static constexpr uintptr_t kVtableOff_IVision_GetPrimaryKnownThreat = 0xd0;  // (int onlyVisible) → CKnownEntity*
