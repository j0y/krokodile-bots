...

{
  ...
  *puVar1 = 3;
  puVar1[1] = 0;
  puVar1[2] = unaff_EBX + 0x261372 /* "No longer blind." */ /* "No longer blind." */ /* "No longer blind." */;
  return;
}
...

{
  ...
  return extraout_ECX + 0x2611cf /* "Flashed" */ /* "Flashed" */ /* "Flashed" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x476d63 /* vtable for CINSBotFlashed+0x8 */ /* vtable for CINSBotFlashed+0x8 */ /* vtable for CINSBotFlashed+0x8 */;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x476d1a /* vtable for CINSBotFlashed+0x8 */ /* vtable for CINSBotFlashed+0x8 */ /* vtable for CINSBotFlashed+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x476eaa /* vtable for CINSBotFlashed+0x198 */ /* vtable for CINSBotFlashed+0x198 */ /* vtable for CINSBotFlashed+0x198 */;
