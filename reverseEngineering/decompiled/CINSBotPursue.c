...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x46d3ba /* vtable for CINSBotPursue+0x8 */ /* vtable for CINSBotPursue+0x8 */ /* vtable for CINSBotPursue+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x46d552 /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */;
  in_stack_00000004[0xe] = unaff_EBX + 0x3fda2a /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
...

{
  ...
  if (piVar2 == (int *)0x0) {
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x2575af /* "No Known Threats" */ /* "No Known Threats" */ /* "No Known Threats" */;
  ...
  *(undefined4 *)param_1 = 3 /* Done */;
  *(int *)(param_1 + 8) = unaff_EBX + 0x257605 /* "I should not be pursuing while escorting" */ /* "I should not be pursuing while escorting" */ /* "I should not be pursuing while escorting" */;
  *(undefined4 *)(param_1 + 4) = 0;
  return param_1;
}
...

{
  ...
  if ((float)fVar10 < *(float *)((int)param_2 + 0x40) || /* !timer_0.IsElapsed() */
  ...
  iVar4 = 0;
  if (*(int *)(iVar3 + 0x20) != 0) {
    iVar4 = *(int *)(iVar3 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x47c542 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
  }
...
LAB_0072a5b0:
  ...
  if ((cVar2 != '\0') &&
     ...
     *(float *)(unaff_EBX + 0x1fa40e /* 5.0f */ /* 5.0f */ /* 5.0f */) <= (float)fVar10 &&
     (float)fVar10 != *(float *)(unaff_EBX + 0x1fa40e /* 5.0f */ /* 5.0f */ /* 5.0f */))) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
  ...
  bVar1 = true;
  if (cVar2 != '\0') {
    bVar1 = *(float *)(unaff_EBX + 0x20daba /* 32.0f */ /* 32.0f */ /* 32.0f */) <= fVar11 && fVar11 != *(float *)(unaff_EBX + 0x20daba /* 32.0f */ /* 32.0f */ /* 32.0f */)
    ;
  }
...
LAB_0072a67c:
  ...
  fVar10 = (float10)CountdownTimer::Now();
  fVar11 = (float)fVar10 + *(float *)(unaff_EBX + 0x18e7b6 /* 1.0f */ /* 1.0f */ /* 1.0f */);
  if (*(float *)((int)param_2 + 0x40) != fVar11) {
    ...
    *(float *)((int)param_2 + 0x40) = fVar11; /* timer_0.Start(1.0f) */
  }
...

{
  ...
  return extraout_ECX + 0x256e37 /* "Pursue Threat" */ /* "Pursue Threat" */ /* "Pursue Threat" */;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar2 = (**(code **)(**(int **)(unaff_EBX + 0x47c30e /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */) + 0x40))(*(int **)(unaff_EBX + 0x47c30e /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */));
  if (iVar2 == 0) {
    bVar1 = 2;
    if (param_1[0x58] == (INextBot)0x0) {
      return ~-(*(float *)(unaff_EBX + 0x25750e /* 2600.0f */ /* 2600.0f */ /* 2600.0f */) < *(float *)(param_1 + 0x54)) & 2;
    }
  }
  else {
    bVar1 = *(float *)(unaff_EBX + 0x1fb59a /* 80.0f */ /* 80.0f */ /* 80.0f */) <= *(float *)(param_1 + 0x54) &&
            *(float *)(param_1 + 0x54) != *(float *)(unaff_EBX + 0x1fb59a /* 80.0f */ /* 80.0f */ /* 80.0f */);
  }
  return bVar1;
}
...

{
  ...
  *(undefined4 *)param_1 = 3 /* Done */;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x25746b /* "Arrived at investigation target." */ /* "Arrived at investigation target." */ /* "Arrived at investigation target." */;
  *(undefined4 *)(param_1 + 0xc) = 1;
  return;
}
...

{
  ...
  return ~-(*(float *)(extraout_ECX + 0x221bd3 /* 2000.0f */ /* 2000.0f */ /* 2000.0f */) < *(float *)(param_1 + 0x54)) & 2;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x46d2a3 /* vtable for CINSBotPursue+0x8 */ /* vtable for CINSBotPursue+0x8 */ /* vtable for CINSBotPursue+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x46d43b /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */;
...

{
  ...
  *in_stack_00000004 = &UNK_0046d25a + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x46d3f2 /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */ /* vtable for CINSBotPursue+0x1a0 */;
