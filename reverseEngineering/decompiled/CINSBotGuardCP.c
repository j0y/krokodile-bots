...

{
  ...
  *(int *)param_1 = unaff_EBX + 0x4768ad /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */;
  *(int *)(param_1 + 4) = unaff_EBX + 0x476a3d /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */;
  puVar3 = *(undefined4 **)(unaff_EBX + 0x485cf1 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */);
  ...
  *(undefined4 *)(param_1 + 0x44) = uVar5;
  puVar3 = *(undefined4 **)(unaff_EBX + 0x486465 /* &vec3_angle */ /* &vec3_angle */ /* &vec3_angle */);
  ...
  *(undefined4 *)(param_1 + 0x50) = uVar4;
  ...
  pcVar1 = (code *)(unaff_EBX + -0x4f016b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
  *(undefined4 *)(param_1 + 0x48c8) = 0;
  iVar2 = unaff_EBX + 0x4078dd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
  ...
  *(undefined4 *)(param_1 + 0x48d8) = 0xbf800000 /* -1.0f */;
  ...
  iVar6 = *(int *)(unaff_EBX + 0x486375 /* &vtable for IntervalTimer */ /* &vtable for IntervalTimer */ /* &vtable for IntervalTimer */);
...

{
  ...
  if (iVar6 != 0) {
    ...
    if (iVar6 == 1) {
      ...
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2602f7 /* "LoS to an enemy." */ /* "LoS to an enemy." */ /* "LoS to an enemy." */;
      return param_1;
    }
  }
  iVar6 = **(int **)(unaff_EBX + 0x485d91 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
...
LAB_00721127:
    if (0 < iVar6) {
      if ((*(char *)((int)param_2 + 0x48dc) != '\0') &&
        ...
        *(undefined4 *)param_1 = 3 /* Done */;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x26035d /* "Exiting guard state, enemy entering CP" */ /* "Exiting guard state, enemy entering CP" */ /* "Exiting guard state, enemy entering CP" */;
        return param_1;
      }
  ...
  if (0.0 < *(float *)((int)param_2 + 0x48e8)) {
    if ((0.0 < *(float *)((int)param_2 + 0x48e0)) &&
      ...
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x260308 /* "Finished guarding spot." */ /* "Finished guarding spot." */ /* "Finished guarding spot." */;
      return param_1;
    }
    fVar7 = (float10)CountdownTimer::Now();
    ...
    if (*(float *)((int)param_2 + 0x48f4) <= (float)fVar7 &&
      ...
      fVar1 = *(float *)(unaff_EBX + 0x231245 /* 512.0f */ /* 512.0f */ /* 512.0f */);
      ...
      local_20 = local_2c * fVar1 + *(float *)((int)param_2 + 0x44) +
                 *(float *)(unaff_EBX + 0x197b81 /* 76.0f */ /* 76.0f */ /* 76.0f */);
      piVar5 = (int *)(**(code **)(*in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_0000000c);
      (**(code **)(*piVar5 + 0xd4 /* PlayerBody::AimHeadTowards */))(piVar5,&local_28,0,0x3dcccccd /* 0.1f */,0,unaff_EBX + 0x260320 /* "Guard Aiming" */ /* "Guard Aiming" */ /* "Guard Aiming" */);
    ...
    if ((double)(float)fVar7 < *(double *)(unaff_EBX + 0x260395 /* rodata:0x66666666 */ /* rodata:0x66666666 */ /* rodata:0x66666666 */)) {
  ...
  if (*(float *)((int)param_2 + 0x48cc) <= (float)fVar7 &&
    ...
    pfVar4 = *(float **)(unaff_EBX + 0x485641 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */);
...

{
  ...
  return extraout_ECX + 0x25fc71 /* "Guarding CP" */ /* "Guarding CP" */ /* "Guarding CP" */;
}
...

{
  ...
  fVar2 = (float)fVar1 + *(float *)(unaff_EBX + 0x20402a /* 0.5f */ /* 0.5f */ /* 0.5f */);
...

{
  ...
  *param_1 = 3;
  param_1[1] = 0;
  param_1[2] = extraout_ECX + 0x260d4d /* "Failed move-to." */ /* "Failed move-to." */ /* "Failed move-to." */;
  param_1[3] = 1;
  return;
}
...

{
  ...
  if (0xf < in_stack_0000000c) {
    puVar12 = *(undefined4 **)(unaff_EBX + 0x485a81 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */);
    *(undefined4 *)param_1 = *puVar12;
    uVar14 = puVar12[2];
    *(undefined4 *)(param_1 + 4) = puVar12[1];
    *(undefined4 *)(param_1 + 8) = uVar14;
    puVar12 = *(undefined4 **)(unaff_EBX + 0x4861f5 /* &vec3_angle */ /* &vec3_angle */ /* &vec3_angle */);
  ...
  piVar1 = (int *)(unaff_EBX + 0x5cbc15 /* CINSBotGuardCP::m_HidingSpotsAtPoint */ /* CINSBotGuardCP::m_HidingSpotsAtPoint */ /* CINSBotGuardCP::m_HidingSpotsAtPoint */ + in_stack_0000000c * 0x14);
  local_40 = piVar1[3];
  if (piVar1[3] == 0) {
    this_00 = (CGlobalEntityList *)(unaff_EBX + 0x2090f9 /* "ins_spawnzone" */ /* "ins_spawnzone" */ /* "ins_spawnzone" */);
    pCVar15 = this_00;
    pcVar9 = (char *)CGlobalEntityList::FindEntityByClassname
                               (this_00,*(CBaseEntity **)(unaff_EBX + 0x486219 /* &gEntList */ /* &gEntList */ /* &gEntList */),(char *)0x0);
      ...
      if (cVar7 != '\0') {
        pCVar10 = (CBaseEntity *)
                  CGlobalEntityList::FindEntityByClassname
                            (*(CGlobalEntityList **)(unaff_EBX + 0x486219 /* &gEntList */ /* &gEntList */ /* &gEntList */),
                             (CBaseEntity *)*(CGlobalEntityList **)(unaff_EBX + 0x486219 /* &gEntList */ /* &gEntList */ /* &gEntList */),
                             (char *)0x0);
        ...
        while (pCVar10 != (CBaseEntity *)0x0) {
          ...
          if (cVar7 == '\0') {
            ...
            if (iVar11 == iVar8) {
              ...
              if (cVar7 != '\0') {
                this_05 = *(CBaseEntity **)(unaff_EBX + 0x485a81 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */);
                if ((((byte)pCVar10[0xd1] & 8) != 0) &&
...
" */,in_stack_0000000c,uVar14);
  ...
  iVar11 = *piVar1;
  iVar8 = *(int *)(unaff_EBX + 0x5cbbd5 /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */ + in_stack_0000000c * 4) + 1;
  *(int *)(unaff_EBX + 0x5cbbd5 /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */ + in_stack_0000000c * 4) = iVar8;
...

{
  ...
  do {
    *(undefined4 *)(iVar1 * 4 + unaff_EBX + 0x5cbc24 /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */ /* CINSBotGuardCP::m_iSelectedHidingSpot */) = 0;
    iVar2 = iVar1 + 1;
    *(undefined4 *)(unaff_EBX + 0x5cbc70 /* CINSBotGuardCP::m_HidingSpotsAtPoint+0xc */ /* CINSBotGuardCP::m_HidingSpotsAtPoint+0xc */ /* CINSBotGuardCP::m_HidingSpotsAtPoint+0xc */ + iVar1 * 0x14) = 0;
    iVar1 = iVar2;
  } while (iVar2 != 0x10);
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x475b5a /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x475cea /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x475aea /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */ /* vtable for CINSBotGuardCP+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x475c7a /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */ /* vtable for CINSBotGuardCP+0x198 */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
