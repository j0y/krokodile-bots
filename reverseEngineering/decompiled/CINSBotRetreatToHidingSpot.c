...

{
  ...
  _param_1[8] = 0;
  *_param_1 = unaff_EBX + 0x4677dd /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  _param_1[9] = 0;
  _param_1[10] = 0;
  _param_1[3] = 0;
  _param_1[4] = 0;
  ...
  *(undefined1 *)((int)_param_1 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x5003db /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(_param_1 + 0x122d,_param_1 + 0x122e);
  ...
  (*(code *)(unaff_EBX + -0x5003db /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar1,_param_1 + 0x1231);
  _param_1[0x1232] = -0x40800000 /* -1.0f */;
  (**(code **)(_param_1[0x1230] + 4))(piVar1,_param_1 + 0x1232);
  _param_1[0x1236] = -0x40800000 /* -1.0f */;
  iVar3 = *(int *)(unaff_EBX + 0x476105 /* &vtable for IntervalTimer */ /* &vtable for IntervalTimer */ /* &vtable for IntervalTimer */);
...

{
  ...
  piVar1 = *(int **)(unaff_EBX + 0x476df1 /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */);
...

{
  ...
  if (iVar6 == 0) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x251890 /* "No longer need to retreat" */ /* "No longer need to retreat" */ /* "No longer need to retreat" */;
    return param_1;
  }
  if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
    ...
    if (fVar2 < (float)fVar9 - *(float *)((int)param_2 + 0x48d8)) {
      if (*(char *)((int)param_2 + 0x48cc) == '\0') {
        *(undefined4 *)param_1 = 3 /* Done */;
        *(int *)(param_1 + 8) = unaff_EBX + 0x2514f3 /* "Retreat timer elapsed." */ /* "Retreat timer elapsed." */ /* "Retreat timer elapsed." */;
        *(undefined4 *)(param_1 + 4) = 0;
        return param_1;
      }
      ...
      *(undefined1 *)((int)piVar4 + 0x31) = 0;
      piVar4[0xb] = 0;
      piVar4[0xd] = 0;
      iVar6 = *(int *)(unaff_EBX + 0x47662d /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
      piVar4[0xf] = 0;
      piVar4[1] = iVar6 + 0x198;
      iVar5 = unaff_EBX + 0x3f7ded /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
      *piVar4 = iVar6 + 8;
      pcVar1 = (code *)(unaff_EBX + -0x4ffc5b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
      piVar4[0xe] = iVar5;
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x251909 /* "Timer elapsed, changing to reload action" */ /* "Timer elapsed, changing to reload action" */ /* "Timer elapsed, changing to reload action" */;
      *(int **)(param_1 + 4) = piVar4;
      return param_1;
    }
    if (0.0 < *(float *)((int)param_2 + 0x48d8)) {
      if (iVar5 != 0) {
        piVar4 = (int *)(*(int **)(unaff_EBX + 0x476641 /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */))[7];
        if (piVar4 != *(int **)(unaff_EBX + 0x476641 /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */ /* &ins_bot_retreat_to_hidingspot_range */)) {
...
" */;
          ...
          *(undefined1 *)((int)piVar4 + 0x31) = 0;
          piVar4[0xb] = 0;
          piVar4[0xd] = 0;
          iVar5 = *(int *)(unaff_EBX + 0x47662d /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
          piVar4[0xf] = 0;
          ...
          *(undefined4 *)param_1 = 1 /* ChangeTo */;
          *(int **)(param_1 + 4) = piVar4;
          *(int *)(param_1 + 8) = unaff_EBX + 0x251935 /* "Failed finding another cover, doing reload." */ /* "Failed finding another cover, doing reload." */ /* "Failed finding another cover, doing reload." */;
          return param_1;
        }
...

{
  ...
  return extraout_ECX + 0x250ebe /* "Retreating to hiding spot" */ /* "Retreating to hiding spot" */ /* "Retreating to hiding spot" */;
}
...

{
  ...
  if (param_2[0x48cc] == (Path)0x0) {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x476c9a /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
    piVar4[0xf] = 0;
    piVar4[1] = iVar3 + 0x198;
    iVar1 = unaff_EBX + 0x3f845a /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
    *piVar4 = iVar3 + 8;
    pcVar2 = (code *)(unaff_EBX + -0x4ff5ee /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
    piVar4[0xe] = iVar1;
    ...
    *(undefined4 *)param_1 = 1 /* ChangeTo */;
    *(int **)(param_1 + 4) = piVar4;
    *(int *)(param_1 + 8) = unaff_EBX + 0x251b8a /* "Doing reload after OnMoveToFailure" */ /* "Doing reload after OnMoveToFailure" */ /* "Doing reload after OnMoveToFailure" */;
...

{
  ...
  if (*(char *)(iVar2 + 0x48cc) == '\0') {
    *param_1 = 3;
    param_1[1] = 0;
    param_1[2] = unaff_EBX + 0x25198b /* "We couldn't get to target's position!" */ /* "We couldn't get to target's position!" */ /* "We couldn't get to target's position!" */;
    param_1[3] = 3;
  }
  else {
    ...
    *(undefined1 *)((int)piVar3 + 0x31) = 0;
    piVar3[0xb] = 0;
    piVar3[0xd] = 0;
    iVar2 = *(int *)(unaff_EBX + 0x476a77 /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
    piVar3[0xf] = 0;
    piVar3[1] = iVar2 + 0x198;
    *piVar3 = iVar2 + 8;
    iVar2 = unaff_EBX + 0x3f8237 /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
    pcVar1 = (code *)(unaff_EBX + -0x4ff811 /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
    piVar3[0xe] = iVar2;
    ...
    *param_1 = 1;
    param_1[1] = piVar3;
    param_1[2] = unaff_EBX + 0x251967 /* "Doing reload after OnMoveToFailure" */ /* "Doing reload after OnMoveToFailure" */ /* "Doing reload after OnMoveToFailure" */;
    param_1[3] = 3;
  }
  return param_1;
}
...

{
  ...
  if (cVar2 != '\0') {
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar3 = *(int *)(unaff_EBX + 0x47689d /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
    piVar4[0xf] = 0;
    *piVar4 = iVar3 + 8;
    piVar4[1] = iVar3 + 0x198;
    iVar3 = unaff_EBX + 0x3f805d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
    piVar4[0xe] = iVar3;
    pcVar1 = (code *)(unaff_EBX + -0x4ff9eb /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
    (*pcVar1)(piVar4 + 0xe,piVar4 + 0xf);
    piVar4[0x10] = -0x40800000 /* -1.0f */;
    (**(code **)(piVar4[0xe] + 4))(piVar4 + 0xe,piVar4 + 0x10);
    piVar4[0x12] = 0;
  ...
  *(undefined4 *)param_1 = 3 /* Done */;
  *(int *)(param_1 + 8) = unaff_EBX + 0x251b3d /* "We couldn't get a path to our target after getting stuck" */ /* "We couldn't get a path to our target after getting stuck" */ /* "We couldn't get a path to our target after getting stuck" */;
  *(undefined4 *)(param_1 + 4) = 0;
  *(undefined4 *)(param_1 + 0xc) = 3;
  return param_1;
}
...

{
  ...
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x252138 /* "Sustaining retreat from fire." */ /* "Sustaining retreat from fire." */ /* "Sustaining retreat from fire." */;
  *(undefined4 *)(param_1 + 0xc) = 3;
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46758a /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x467722 /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */ /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */ /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46751a /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */ /* vtable for CINSBotRetreatToHidingSpot+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4676b2 /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */ /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */ /* vtable for CINSBotRetreatToHidingSpot+0x1a0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
