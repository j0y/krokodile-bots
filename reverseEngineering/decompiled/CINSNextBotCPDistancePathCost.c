...

{
  ...
  iVar2 = *(int *)(unaff_EBX + 0x4b9dd9 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */);
  ...
  if ((bVar7) &&
    ...
    if (*piVar6 != unaff_EBX + 0x2921a1 /* "CINSNextBotCPDistancePathCost::operator()" */ /* "CINSNextBotCPDistancePathCost::operator()" */ /* "CINSNextBotCPDistancePathCost::operator()" */) {
      piVar6 = (int *)CVProfNode::GetSubNode
                                ((char *)piVar6,unaff_EBX + 0x2921a1 /* "CINSNextBotCPDistancePathCost::operator()" */ /* "CINSNextBotCPDistancePathCost::operator()" */ /* "CINSNextBotCPDistancePathCost::operator()" */,(char *)0x0,
                                 unaff_EBX + 0x2940ce /* "NextBot" */ /* "NextBot" */ /* "NextBot" */);
  ...
  local_30 = *(float *)(unaff_EBX + 0x23c611 /* FLT_MAX */ /* FLT_MAX */ /* FLT_MAX */);
  iVar5 = 0;
  do {
    if (iVar5 == 2) {
  ...
  if (fVar10 < *(float *)(param_1 + 0x10)) {
    if (fVar10 <= (float)((uint)*(float *)(param_1 + 0x10) ^ *(uint *)(unaff_EBX + 0x238065 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */))) {
      fVar9 = *(float *)(CBaseAchievement::~CBaseAchievement + unaff_EBX + 5);
      if (fVar10 <= (float)(*(uint *)(param_1 + 0x18) ^ *(uint *)(unaff_EBX + 0x238065 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */)))
      goto LAB_006ecd5a;
      goto LAB_006ecd3b;
    }
  }
...
LAB_006ecd3b:
    local_30 = local_30 * *(float *)(unaff_EBX + 0x1cc3e1 /* 3.0f */ /* 3.0f */ /* 3.0f */);
  }
