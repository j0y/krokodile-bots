...

{
  ...
  *param_2 = &UNK_00478dcd + unaff_EBX;
  param_2[1] = unaff_EBX + 0x478f65 /* vtable for CINSBotFireRPG+0x1a0 */ /* vtable for CINSBotFireRPG+0x1a0 */ /* vtable for CINSBotFireRPG+0x1a0 */;
  param_2[9] = 0;
  param_2[10] = 0;
  param_2[3] = 0;
  param_2[4] = 0;
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  param_2[0xb] = 0;
  param_2[0xd] = 0;
  param_2[0x17] = unaff_EBX + 0x40a3dd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
  param_2[0x18] = 0;
...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x4776ad /* vtable for CINSBotFireRPG+0x8 */ /* vtable for CINSBotFireRPG+0x8 */ /* vtable for CINSBotFireRPG+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x477845 /* vtable for CINSBotFireRPG+0x1a0 */ /* vtable for CINSBotFireRPG+0x1a0 */ /* vtable for CINSBotFireRPG+0x1a0 */;
  in_stack_00000004[0x17] = unaff_EBX + 0x408cbd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
...

{
  ...
  if (*(int *)(in_stack_0000000c + 0x2284) == 3) {
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x2635a8 /* "No Target to fire at" */ /* "No Target to fire at" */ /* "No Target to fire at" */;
  ...
  if (fVar1 != 0.0) {
    ...
    (**(code **)(*piVar2 + 0xd4 /* PlayerBody::AimHeadTowards */))
              (piVar2,param_2 + 0x38,5,0x40c00000 /* 6.0f */,unaff_EBX + 0x4ef7e1 /* rpgFireReply */ /* rpgFireReply */ /* rpgFireReply */,unaff_EBX + 0x2635cc /* "Aiming at RPG target" */ /* "Aiming at RPG target" */ /* "Aiming at RPG target" */);
    *(undefined4 *)(in_stack_0000000c + 0x2284) = 1;
    fVar3 = (float10)CountdownTimer::Now();
    fVar1 = (float)fVar3 + *(float *)(unaff_EBX + 0x19b541 /* 3.0f */ /* 3.0f */ /* 3.0f */);
    ...
    *(undefined4 *)(param_2 + 0x68) = *(undefined4 *)(**(int **)(unaff_EBX + 0x488e65 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
...
" */;
  ...
  if ((cVar1 != '\0') &&
     ...
     *(float *)(unaff_EBX + 0x204fdb /* 5.0f */ /* 5.0f */ /* 5.0f */) <= (float)fVar8 &&
     (float)fVar8 != *(float *)(unaff_EBX + 0x204fdb /* 5.0f */ /* 5.0f */ /* 5.0f */))) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x2618a8 /* "Idle in fire rpg" */ /* "Idle in fire rpg" */ /* "Idle in fire rpg" */;
    return param_1;
  }
  if (*(int *)(in_stack_0000000c + 0x2284) == 3) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x2618b9 /* "Error acquiring RPG target" */ /* "Error acquiring RPG target" */ /* "Error acquiring RPG target" */;
    return param_1;
  }
  fVar9 = *(float *)(**(int **)(&DAT_0048710f + unaff_EBX) + 0xc) - *(float *)((int)param_2 + 0x68);
  if (*(float *)(unaff_EBX + 0x204fcf /* 4.0f */ /* 4.0f */ /* 4.0f */) <= fVar9 && fVar9 != *(float *)(unaff_EBX + 0x204fcf /* 4.0f */ /* 4.0f */ /* 4.0f */)) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x2618d4 /* "Expired." */ /* "Expired." */ /* "Expired." */;
    return param_1;
  }
  if (piVar2 != piVar3) {
  ...
  if (*(float *)((int)param_2 + 100) <= 0.0) {
    if ((*(int *)(in_stack_0000000c + 0x2284) == 2) &&
       ...
       *(float *)(unaff_EBX + 0x204fc7 /* 0.5f */ /* 0.5f */ /* 0.5f */) <= fVar9 && fVar9 != *(float *)(unaff_EBX + 0x204fc7 /* 0.5f */ /* 0.5f */ /* 0.5f */))) {
      ...
      if (cVar1 == '\0') {
        ...
        if (cVar1 != '\0') {
          if ((*(char *)((int)param_2 + 0x6c) == '\0') &&
             (cVar1 = (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x487167 /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) + 0x29c))
                                ((int *)**(undefined4 **)(unaff_EBX + 0x487167 /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */)), cVar1 != '\0')) {
            local_4c[0] = 0;
            local_4c[1] = 0;
            local_4c[2] = 0;
...

{
  ...
  return extraout_ECX + 0x2612a3 /* "Firing RPG" */ /* "Firing RPG" */ /* "Firing RPG" */;
}
...

{
  ...
  uStack_14 = 0x71e02b;
  __i686_get_pc_thunk_bx();
  local_1d = *(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) != 0;
  if (((bool)local_1d) &&
     (iVar8 = *(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8), iVar4 = ThreadGetCurrentId(),
     iVar8 == iVar4)) {
    piVar11 = *(int **)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
    if (*piVar11 != unaff_EBX + 0x262ff1 /* "CINSBotFireRPG::HasRPGTarget" */ /* "CINSBotFireRPG::HasRPGTarget" */ /* "CINSBotFireRPG::HasRPGTarget" */) {
      piVar11 = (int *)CVProfNode::GetSubNode
                                 ((char *)piVar11,unaff_EBX + 0x262ff1 /* "CINSBotFireRPG::HasRPGTarget" */ /* "CINSBotFireRPG::HasRPGTarget" */ /* "CINSBotFireRPG::HasRPGTarget" */,(char *)0x0,
                                  unaff_EBX + 0x262c3b /* "INSNextBot" */ /* "INSNextBot" */ /* "INSNextBot" */);
      *(int **)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = piVar11;
    }
    iVar8 = *(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */);
  ...
  piVar11 = *(int **)(unaff_EBX + 0x488f15 /* &ins_bot_rpg_minimum_player_cluster */ /* &ins_bot_rpg_minimum_player_cluster */ /* &ins_bot_rpg_minimum_player_cluster */);
  ...
  if (*(float *)(param_1 + 0xb378) <= (float)fVar15 && (float)fVar15 != *(float *)(param_1 + 0xb378)
    ...
    if (**(int **)(unaff_EBX + 0x4888cd /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) != 0) {
    ...
    if ((piVar6 != (int *)0x0) && (cVar3 = (**(code **)(*piVar6 + 0x3c))(piVar6), cVar3 != '\0')) {
      ...
      fVar20 = *(float *)(unaff_EBX + 0x19af51 /* 3.0f */ /* 3.0f */ /* 3.0f */);
      fVar17 = *(float *)(unaff_EBX + 0x206735 /* 4.0f */ /* 4.0f */ /* 4.0f */);
      ppiVar25 = (int **)0x0;
      uVar14 = 3;
      ...
      if ((piVar7 != (int *)0x0) &&
        ...
        piVar7 = *(int **)(unaff_EBX + 0x48896d /* &ins_bot_rpg_minimum_firing_distance */ /* &ins_bot_rpg_minimum_firing_distance */ /* &ins_bot_rpg_minimum_firing_distance */);
...
LAB_0071e7a9:
        ...
        if (cVar3 != '\0') {
          ...
          if (0 < *(int *)(**(int **)(unaff_EBX + 0x488875 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x14)) {
            iVar8 = 1;
            do {
              ...
              if ((piVar6 == (int *)0x0) ||
                ...
                if ((cVar3 != '\0') &&
                   ...
                   cVar3 == '\0')) {
                  fVar16 = *(float *)(**(int **)(unaff_EBX + 0x488875 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
                  fVar19 = (float)local_2c[0][0x76e];
                  piVar6 = *(int **)(unaff_EBX + 0x5ce5f1 /* ins_bot_rpg_grace_time+0x1c */ /* ins_bot_rpg_grace_time+0x1c */ /* ins_bot_rpg_grace_time+0x1c */);
                  if (piVar6 == (int *)(unaff_EBX + 0x5ce5d5 /* ins_bot_rpg_grace_time */ /* ins_bot_rpg_grace_time */ /* ins_bot_rpg_grace_time */U)) {
                    fVar21 = (float)((uint)piVar6 ^ *(uint *)(unaff_EBX + 0x5ce601 /* ins_bot_rpg_grace_time+0x2c */ /* ins_bot_rpg_grace_time+0x2c */ /* ins_bot_rpg_grace_time+0x2c */));
                  }
                  else {
              ...
              iVar8 = iVar8 + 1;
            } while (iVar8 <= *(int *)(**(int **)(unaff_EBX + 0x488875 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x14));
          }
          ...
          if (local_160 == (CINSNextBot *)0x0) {
            ...
            if ((cVar3 == '\0') &&
              ...
              fVar20 = ((float)*(int *)(**(int **)(unaff_EBX + 0x4888cd /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) + 1000) +
                       *(float *)(unaff_EBX + 0x19aae5 /* -1.0f */ /* -1.0f */ /* -1.0f */)) * *(float *)(unaff_EBX + 0x2631d5 /* rodata:0x3DE38E39 */ /* rodata:0x3DE38E39 */ /* rodata:0x3DE38E39 */);
              if (*(float *)(unaff_EBX + 0x19aae9 /* 1.0f */ /* 1.0f */ /* 1.0f */) <= fVar20) {
                fVar20 = *(float *)(unaff_EBX + 0x19aae9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
              }
              if (fVar20 <= *(float *)(unaff_EBX + 0x19aadd /* 0.0f */ /* 0.0f */ /* 0.0f */)) {
                fVar20 = *(float *)(unaff_EBX + 0x19aadd /* 0.0f */ /* 0.0f */ /* 0.0f */);
              }
              local_2c[0] = (int *)CONCAT22(local_2c[0]._2_2_,in_FPUControlWord);
              local_20 = in_FPUControlWord & 0xf3ff | 0x400;
              fVar20 = ROUND(*(float *)(unaff_EBX + 0x208d85 /* 2.0f */ /* 2.0f */ /* 2.0f */) - fVar20);
            }
            if (((int)fVar20 < 2) || (uVar14 = 0, (int)fVar20 <= (int)local_160)) {
              ...
              iVar8 = (**(code **)(**(int **)(unaff_EBX + 0x489065 /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */) + 0x40))
                                (*(int **)(unaff_EBX + 0x489065 /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */));
              if (iVar8 != 0) {
                local_8c = local_fc - local_10c;
                local_88 = local_f8 - local_108;
                local_84 = local_f4 - local_104;
                NDebugOverlay::Box((Vector *)&local_10c,*(Vector **)(unaff_EBX + 0x4885a1 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */),
              ...
              local_14c[1] = 0x32;
              local_14c[2] = 0;
              local_14c[0] = (*(code *)**(undefined4 **)**(undefined4 **)(unaff_EBX + 0x48884d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */))
                                       ((undefined4 *)**(undefined4 **)(unaff_EBX + 0x48884d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),600);
              fVar22 = local_fc - local_10c;
              local_140 = (Vector *)0x0;
              fVar16 = local_f8 - local_108;
              local_254 = 5;
              fVar20 = *(float *)(unaff_EBX + 0x20672d /* 0.5f */ /* 0.5f */ /* 0.5f */);
              fVar19 = local_f4 - local_104;
              local_250 = *(float *)(unaff_EBX + 0x20617d /* 0.9f */ /* 0.9f */ /* 0.9f */);
              fVar17 = *(float *)(unaff_EBX + 0x20672d /* 0.5f */ /* 0.5f */ /* 0.5f */);
              ...
              do {
                ...
                do {
                  ...
                  iVar8 = iVar8 + -1;
                  local_224 = *(float *)(unaff_EBX + 0x206bb9 /* 0.2f */ /* 0.2f */ /* 0.2f */) + local_224;
                } while (iVar8 != 0);
                fVar18 = 0.1;
                iVar8 = 5;
                do {
                  ...
                  CUtlVector<Vector,CUtlMemory<Vector,int>>::InsertBefore((int)local_14c,local_140);
                  iVar8 = iVar8 + -1;
                  fVar18 = *(float *)(unaff_EBX + 0x206bb9 /* 0.2f */ /* 0.2f */ /* 0.2f */) + fVar18;
                } while (iVar8 != 0);
                local_254 = local_254 + -1;
                local_250 = local_250 - *(float *)(unaff_EBX + 0x206bb9 /* 0.2f */ /* 0.2f */ /* 0.2f */);
              } while (local_254 != 0);
              ...
              if (0 < (int)local_140) {
                ...
                do {
                  ...
                  (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x48874d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */) + 0x14))
                            ((int *)**(undefined4 **)(unaff_EBX + 0x48874d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */),&local_1bc,1,local_12c,
                             &local_210);
                  piVar11 = *(int **)(unaff_EBX + 0x488a15 /* &r_visualizetraces */ /* &r_visualizetraces */ /* &r_visualizetraces */);
                  ...
                  cVar3 = IsBoxIntersectingRay
                                    ((Vector *)&local_10c,(Vector *)&local_fc,(Vector *)&local_210,
                                     (Vector *)&local_38,0.0);
                  if (cVar3 != '\0') {
                    iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x489065 /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */) + 0x40))
                                      (*(int **)(unaff_EBX + 0x489065 /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */ /* &ins_debug_rpg_targets */));
                    if (iVar4 != 0) {
...
LAB_0071e08c:
  if ((local_1d != '\0') &&
     (((*(char *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) == '\0' ||
       (*(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) != 0)) &&
      (iVar8 = *(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8), iVar4 = ThreadGetCurrentId(),
      iVar8 == iVar4)))) {
    cVar3 = CVProfNode::ExitScope();
    if (cVar3 == '\0') {
      iVar8 = *(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
    }
    else {
      iVar8 = *(int *)(*(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) + 100);
      *(int *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = iVar8;
    }
    *(bool *)(*(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) =
         iVar8 == *(int *)(unaff_EBX + 0x488949 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1018;
    return uVar14;
  }
  return uVar14;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4791f3 /* vtable for CINSBotFireRPG+0x8 */ /* vtable for CINSBotFireRPG+0x8 */ /* vtable for CINSBotFireRPG+0x8 */;
  in_stack_00000004[1] = (int)(&UNK_0047938b + extraout_ECX);
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x4897c3 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
