...

{
  ...
  param_2[8] = 0;
  param_2[9] = 0;
  *param_2 = unaff_EBX + 0x46576d /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */;
  param_2[1] = unaff_EBX + 0x465905 /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */;
  iVar1 = unaff_EBX + 0x3f503d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
  param_2[10] = 0;
  param_2[3] = 0;
  pcVar2 = (code *)(unaff_EBX + -0x502a0b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
  param_2[4] = 0;
  param_2[5] = 0;
  param_2[6] = 0;
  param_2[7] = 0;
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  ...
  fVar3 = *(float *)(unaff_EBX + 0x24ed9d /* 56.0f */ /* 56.0f */ /* 56.0f */);
  param_2[0xf] = param_3;
...

{
  ...
  if (((piVar6 != (int *)0x0) && (cVar5 = (**(code **)(*piVar6 + 0x38 /* CBaseAnimating::TestCollision */))(), cVar5 != '\0')) &&
     ...
     *(float *)(unaff_EBX + 0x18603d /* 1.0f */ /* 1.0f */ /* 1.0f */) <= (float)fVar9 &&
     (float)fVar9 != *(float *)(unaff_EBX + 0x18603d /* 1.0f */ /* 1.0f */ /* 1.0f */))) {
    ...
    if (iVar8 != 0) {
      ...
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24f3fd /* "Spotted a threat while suppressing." */ /* "Spotted a threat while suppressing." */ /* "Spotted a threat while suppressing." */;
      return param_1;
    }
  }
  ...
  if ((float)fVar9 < *(float *)((int)param_2 + 0x5c) || /* !timer_0.IsElapsed() */
    ...
    if ((cVar5 == '\0') ||
       ...
       (float)fVar9 < *(float *)(unaff_EBX + 0x1f1c95 /* 5.0f */ /* 5.0f */ /* 5.0f */) ||
       (float)fVar9 == *(float *)(unaff_EBX + 0x1f1c95 /* 5.0f */ /* 5.0f */ /* 5.0f */))) {
      piVar6 = (int *)CINSPlayer::GetActiveINSWeapon();
      if (piVar6 == (int *)0x0) {
        *(undefined4 *)param_1 = 3 /* Done */;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24f3aa /* "Failed to init weapon entity" */ /* "Failed to init weapon entity" */ /* "Failed to init weapon entity" */;
      }
      else {
        ...
        if (cVar5 == '\0') {
          ...
          if (((uVar1 != 0xffffffff) &&
              (iVar8 = (uVar1 & 0xffff) * 0x18 + **(int **)(unaff_EBX + 0x473d01 /* &g_pEntityList */ /* &g_pEntityList */ /* &g_pEntityList */),
          ...
          fVar13 = *(float *)(**(int **)(unaff_EBX + 0x473dc9 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
          local_40 = *(float *)((int)param_2 + 0x3c);
          local_3c = *(float *)((int)param_2 + 0x40);
          local_38 = *(float *)((int)param_2 + 0x44);
          dVar14 = sin((double)(*(float *)(unaff_EBX + 0x24f43d /* 3.5f */ /* 3.5f */ /* 3.5f */) * fVar13));
          fVar4 = local_38;
          fVar3 = local_3c;
          fVar12 = (float)(dVar14 * *(double *)(unaff_EBX + 0x24f449 /* 0.0f */ /* 0.0f */ /* 0.0f */));
          fVar10 = local_54 * fVar12;
          fVar11 = local_50 * fVar12;
          dVar14 = cos((double)(fVar13 * *(float *)(&DAT_001f0fb9 + unaff_EBX)));
          fVar13 = (float)(dVar14 * *(double *)(unaff_EBX + 0x24f451 /* 0.0f */ /* 0.0f */ /* 0.0f */));
          ...
          (**(code **)(*piVar6 + 0xd4 /* PlayerBody::AimHeadTowards */))(piVar6,&local_40,3,0x3dcccccd /* 0.1f */,0,unaff_EBX + 0x24f3e2 /* "Aiming at suppression area" */ /* "Aiming at suppression area" */ /* "Aiming at suppression area" */);
          ...
          *(undefined4 *)param_1 = 3 /* Done */;
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x24f3c7 /* "Our weapon is out of ammo." */ /* "Our weapon is out of ammo." */ /* "Our weapon is out of ammo." */;
        }
      }
    }
    else {
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24f399 /* "Idle in suppress" */ /* "Idle in suppress" */ /* "Idle in suppress" */;
    }
  }
  else {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24f381 /* "We're done suppressing." */ /* "We're done suppressing." */ /* "We're done suppressing." */;
  }
  return param_1;
}
...

{
  ...
  return extraout_ECX + 0x24eb37 /* "Suppressing" */ /* "Suppressing" */ /* "Suppressing" */;
}
...

{
  ...
  if (pCVar1 != (CBaseEntity *)0x0) {
    ...
    iVar3 = 0;
    if (*(float *)(unaff_EBX + 0x24f6b4 /* 114.0f */ /* 114.0f */ /* 114.0f */) <= SQRT(fVar6 * fVar6 + fVar8 * fVar8 + fVar7 * fVar7)) {
      ...
      if (iVar4 != 0) {
        ...
        if ((fVar6 < *(float *)(unaff_EBX + 0x21943c /* 2000.0f */ /* 2000.0f */ /* 2000.0f */) || fVar6 == *(float *)(unaff_EBX + 0x21943c /* 2000.0f */ /* 2000.0f */ /* 2000.0f */))
           && (iVar3 = 1, *(float *)(unaff_EBX + 0x1fae28 /* 500.0f */ /* 500.0f */ /* 500.0f */) <= fVar6)) {
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4655a3 /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x46573b /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x473e33 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x46555a /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */ /* vtable for CINSBotSuppressTarget+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4656f2 /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */ /* vtable for CINSBotSuppressTarget+0x1a0 */;
