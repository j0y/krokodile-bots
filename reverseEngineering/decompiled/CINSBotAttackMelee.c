...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x4865dd /* vtable for CINSBotAttackMelee+0x8 */ /* vtable for CINSBotAttackMelee+0x8 */;
  in_stack_00000004[1] = (int)(&UNK_00486785 + unaff_EBX);
  in_stack_00000004[0xe] = unaff_EBX + 0x418f6d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (**(int **)(unaff_EBX + 0x497eda /* &g_pGameRules */ /* &g_pGameRules */) == 0) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x27145e /* "INSRules failed to initialize." */ /* "INSRules failed to initialize." */;
  }
  else {
    fVar3 = (float10)CountdownTimer::Now();
    fVar4 = (float)fVar3 + *(float *)(unaff_EBX + 0x215d4e /* 5.0f */ /* 5.0f */);
    ...
    puVar1 = *(undefined4 **)(unaff_EBX + 0x497bae /* &vec3_origin */ /* &vec3_origin */);
...

{
  ...
  if (((piVar3 != (int *)0x0) && (iVar4 = (**(code **)(*piVar3 + 0x10))(piVar3), iVar4 != 0)) &&
      ...
      if (in_stack_0000000c[0x1864] == (CINSWeapon)0x0) {
        ...
        if (pCVar6 == this_00) {
          ...
          if (*(float *)((int)param_2 + 0x40) <= (float)fVar9 && /* timer_0.IsElapsed() */
            ...
            local_2c = *pfVar7;
            local_28 = pfVar7[1];
            piVar5 = *(int **)(unaff_EBX + 0x497edb /* &ins_bot_knives_only_sprint_range */ /* &ins_bot_knives_only_sprint_range */);
            local_24 = pfVar7[2];
            piVar1 = (int *)piVar5[7];
            if (piVar1 == piVar5) {
            ...
            if ((*(float *)(in_stack_0000000c + 0x20c) - local_28) *
              ...
              uVar12 = 7;
              iVar4 = unaff_EBX + 0x2719ae /* "Jog at Target" */ /* "Jog at Target" */;
              uVar11 = 0xc;
              ...
              uVar13 = 0x3f19999a /* 0.6f */;
              uVar12 = 7;
              iVar4 = unaff_EBX + 0x27199d /* "Sprint at Target" */ /* "Sprint at Target" */;
              uVar11 = 0xd;
              CINSBotBody::SetPosture();
            }
            iVar8 = (**(code **)(**(int **)(unaff_EBX + 0x497dd7 /* &ins_bot_knives_only_enable_slide */ /* &ins_bot_knives_only_enable_slide */) + 0x40))
                              (*(int **)(unaff_EBX + 0x497dd7 /* &ins_bot_knives_only_enable_slide */ /* &ins_bot_knives_only_enable_slide */),uVar11,uVar12,uVar13,iVar4);
            ...
            if ((iVar8 != 0) &&
              ...
              if (cVar2 != '\0') {
                ...
                fVar10 = (float)fVar9 + *(float *)(unaff_EBX + 0x21a687 /* 64.0f */ /* 64.0f */);
                if (((byte)in_stack_0000000c[0xd1] & 8) != 0) {
                  CBaseEntity::CalcAbsolutePosition((CBaseEntity *)this_00);
                }
                if ((*(float *)(in_stack_0000000c + 0x20c) - local_28) *
                  ...
                  if ((float)fVar9 < local_38) {
                    ...
                    uVar12 = 8;
                    iVar4 = unaff_EBX + 0x2719bc /* "Slide like a G" */ /* "Slide like a G" */;
                    CINSBotBody::SetPosture();
                  }
                }
                else {
            ...
            if ((*(float *)(in_stack_0000000c + 0x20c) - local_28) *
              ...
              if ((float)fVar9 <= local_38) {
                ...
                uVar12 = 7;
                iVar4 = unaff_EBX + 0x24af3a /* rodata:0x73250900 */ /* rodata:0x73250900 */;
                CINSBotBody::SetPosture();
              }
              else {
    ...
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x271810 /* "Non INS Player Enemy?" */ /* "Non INS Player Enemy?" */;
    return param_1;
  }
  *(undefined4 *)param_1 = 3 /* Done */;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x27198c /* "Lost our threat." */ /* "Lost our threat." */;
  return param_1;
}
...

{
  ...
  *(undefined4 *)(param_2 + 0xb33c) = *(undefined4 *)(**(int **)(unaff_EBX + 0x49844c /* &gpGlobals */ /* &gpGlobals */) + 0xc);
  return;
}
...

{
  ...
  return extraout_ECX + 0x27115c /* "AttackMelee" */ /* "AttackMelee" */;
}
...

{
  ...
  *in_stack_00000004 = &UNK_0048648a + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x486632 /* vtable for CINSBotAttackMelee+0x1b0 */ /* vtable for CINSBotAttackMelee+0x1b0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48641a /* vtable for CINSBotAttackMelee+0x8 */ /* vtable for CINSBotAttackMelee+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4865c2 /* vtable for CINSBotAttackMelee+0x1b0 */ /* vtable for CINSBotAttackMelee+0x1b0 */;
  CINSPathFollower::~CINSPathFollower(this_00);
  Action<CINSNextBot>::~Action(this_01);
