...

{
  ...
  if ((bVar10) &&
    ...
    if (*piVar8 != unaff_EBX + 0x22a277 /* "CINSBotChatter::Update" */ /* "CINSBotChatter::Update" */ /* "CINSBotChatter::Update" */) {
      piVar8 = (int *)CVProfNode::GetSubNode
                                ((char *)piVar8,unaff_EBX + 0x22a277 /* "CINSBotChatter::Update" */ /* "CINSBotChatter::Update" */ /* "CINSBotChatter::Update" */,(char *)0x0,
                                 unaff_EBX + 0x2275eb /* "INSNextBot" */ /* "INSNextBot" */ /* "INSNextBot" */);
  ...
  {
    iVar7 = (**(code **)(**(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */) + 0x40))(*(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */));
    if (iVar7 != 0) {
  ...
  while (pBVar12 = pBVar3, pBVar12 != (BotStatement *)0x0) {
    ...
    if (cVar4 == '\0') {
      ...
      if (pBVar12[0x28] == (BotStatement)0x0) {
        fVar2 = *(float *)(**(int **)(unaff_EBX + 0x44d225 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
        if (*(float *)(pBVar12 + 0x20) <= fVar2 && fVar2 != *(float *)(pBVar12 + 0x20)) {
          iVar7 = (**(code **)(**(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */) + 0x40))
                            (*(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */));
          if (iVar7 != 0) {
          ...
          iVar7 = (**(code **)(**(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */) + 0x40))
                            (*(int **)(unaff_EBX + 0x44da6d /* &ins_debug_chatter */ /* &ins_debug_chatter */ /* &ins_debug_chatter */),puVar6);
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (*(int *)(**(int **)(unaff_EBX + 0x44d7c5 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x14) < 1) {
    local_24 = 0;
  }
  else {
    local_20 = *(float *)(unaff_EBX + 0x22a925 /* "(knNWhen to change bot difficulty, 1 = instantly, 0 = when new bots are added" */ /* "(knNWhen to change bot difficulty, 1 = instantly, 0 = when new bots are added" */ /* "(knNWhen to change bot difficulty, 1 = instantly, 0 = when new bots are added" */);
    iVar4 = 1;
    local_24 = 0;
LAB_00759110:
    do {
      ...
      if (piVar2 != (int *)0x0) {
        ...
        if ((cVar1 == '\0') && (cVar1 = (**(code **)(*piVar2 + 0x118 /* CBaseEntity::IsAlive */))(piVar2), cVar1 == '\0')) {
          iVar4 = iVar4 + 1;
          iVar3 = **(int **)(unaff_EBX + 0x44d7c5 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
          if (*(int *)(iVar3 + 0x14) < iVar4) break;
          goto LAB_00759110;
        }
        cVar1 = CBaseEntity::InSameTeam((CBaseEntity *)*in_stack_00000004);
        if ((cVar1 != '\0') &&
           (piVar2 = (int *)__dynamic_cast(piVar2,*(undefined4 *)(unaff_EBX + 0x44d6a9 /* &typeinfo for CBasePlayer */ /* &typeinfo for CBasePlayer */ /* &typeinfo for CBasePlayer */),
                                           *(undefined4 *)(unaff_EBX + 0x44d94d /* &typeinfo for CINSNextBot */ /* &typeinfo for CINSNextBot */ /* &typeinfo for CINSNextBot */),0),
           piVar2 != (int *)0x0)) {
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar4 = *(int *)(unaff_EBX + 0x44d019 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */);
  bVar11 = *(int *)(iVar4 + 0x100c) != 0;
  if ((bVar11) && (iVar9 = *(int *)(iVar4 + 0x19b8), iVar7 = ThreadGetCurrentId(), iVar9 == iVar7))
  {
    piVar10 = *(int **)(iVar4 + 0x1014);
    if (*piVar10 != unaff_EBX + 0x229fd6 /* "CINSBotChatter::IdleChatter" */ /* "CINSBotChatter::IdleChatter" */ /* "CINSBotChatter::IdleChatter" */) {
      piVar10 = (int *)CVProfNode::GetSubNode
                                 ((char *)piVar10,unaff_EBX + 0x229fd6 /* "CINSBotChatter::IdleChatter" */ /* "CINSBotChatter::IdleChatter" */ /* "CINSBotChatter::IdleChatter" */,(char *)0x0,
                                  unaff_EBX + 0x22730b /* "INSNextBot" */ /* "INSNextBot" */ /* "INSNextBot" */);
  ...
  if (cVar6 != '\0') {
    ...
    if (*(int *)(iVar9 + 0xb448) == 0) {
      pBVar13 = *(BotStatement **)(unaff_EBX + 0x44ced5 /* &nb_blind */ /* &nb_blind */ /* &nb_blind */);
    ...
    puVar8[1] = 0;
    fVar2 = *(float *)(unaff_EBX + 0x1cae11 /* 5.0f */ /* 5.0f */ /* 5.0f */);
    puVar8[2] = 0;
    *puVar8 = in_stack_00000004;
    iVar9 = **(int **)(unaff_EBX + 0x44cf45 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
...

{
  ...
  __i686_get_pc_thunk_bx();
  bVar13 = *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) != 0;
  if ((bVar13) &&
     (iVar12 = *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8), iVar5 = ThreadGetCurrentId(),
     iVar12 == iVar5)) {
    piVar6 = *(int **)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
    if (*piVar6 != unaff_EBX + 0x22a689 /* "CINSBotChatter::ReportEnemies" */ /* "CINSBotChatter::ReportEnemies" */ /* "CINSBotChatter::ReportEnemies" */) {
      piVar6 = (int *)CVProfNode::GetSubNode
                                ((char *)piVar6,unaff_EBX + 0x22a689 /* "CINSBotChatter::ReportEnemies" */ /* "CINSBotChatter::ReportEnemies" */ /* "CINSBotChatter::ReportEnemies" */,(char *)0x0,
                                 (int)(&UNK_00227a1b + unaff_EBX));
      *(int **)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = piVar6;
    }
    puVar1 = (uint *)(piVar6[0x1c] * 8 + *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x10a0) + 4);
    *puVar1 = *puVar1 | 4;
    CVProfNode::EnterScope();
    *(undefined1 *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) = 0;
  }
        ...
        do {
          ...
          if ((piVar6 != (int *)0x0) && (piVar7 = *(int **)in_stack_00000004, piVar6 != piVar7)) {
            ...
            if ((piVar7 != (int *)0x0) &&
              ...
              if ((iVar5 != iVar8) && ((float)fVar14 <= *(float *)(unaff_EBX + 0x1cb521 /* 5.0f */ /* 5.0f */ /* 5.0f */))) {
                puVar9 = (undefined4 *)::operator_new(0x6c);
                puVar9[1] = 0;
                puVar9[2] = 0;
                fVar2 = *(float *)(unaff_EBX + 0x15f8cd /* 8.0f */ /* 8.0f */ /* 8.0f */);
                *puVar9 = in_stack_00000004;
                iVar12 = **(int **)(unaff_EBX + 0x44d655 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
                ...
                *puVar10 = &UNK_00443ded + unaff_EBX;
                ...
                puVar10[1] = *puVar11;
                puVar9[5] = puVar10;
                cVar4 = (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44d6ad /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) + 0xe0))
                                  ((int *)**(undefined4 **)(unaff_EBX + 0x44d6ad /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */));
                this_03 = this_02;
                if (cVar4 != '\0') {
                ...
                if ((*(char *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) != '\0') &&
                   (*(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) == 0)) {
                  return;
                }
                iVar12 = *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8);
                iVar5 = ThreadGetCurrentId(in_stack_00000004,puVar9,uVar16);
                if (iVar12 != iVar5) {
                  return;
                }
                cVar4 = CVProfNode::ExitScope();
                iVar12 = *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
                if (cVar4 != '\0') {
                  iVar12 = *(int *)(iVar12 + 100);
                  *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = iVar12;
                }
                goto LAB_00759484;
              }
            }
...
LAB_007592ac:
  if ((!bVar13) ||
     (((*(char *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) != '\0' &&
       (*(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) == 0)) ||
      (iVar12 = *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8),
  ...
  if (cVar4 == '\0') {
    ...
    iVar12 = *(int *)(*(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) + 100);
    *(int *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = iVar12;
  }
LAB_00759484:
  *(bool *)(*(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) =
       iVar12 == *(int *)(unaff_EBX + 0x44d729 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1018;
  return;
}
