...

{
  ...
  param_2[8] = 0;
  *param_2 = unaff_EBX + 0x4671ad /* vtable for CINSBotSpecialAction+0x8 */ /* vtable for CINSBotSpecialAction+0x8 */ /* vtable for CINSBotSpecialAction+0x8 */;
  param_2[1] = unaff_EBX + 0x46733d /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */;
  param_2[0xf] = unaff_EBX + 0x3f6e3d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
  param_2[9] = 0;
  param_2[10] = 0;
  param_2[3] = 0;
  param_2[4] = 0;
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  ...
  param_2[0xd] = 0;
  param_2[0x10] = 0;
  (*(code *)(unaff_EBX + -0x500c0b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(param_2 + 0xf,param_2 + 0x10);
  ...
  param_2[0x13] = 0;
  param_2[0x12] = unaff_EBX + 0x3f6e3d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_1 */
  (*(code *)(unaff_EBX + -0x500c0b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(param_2 + 0x12,param_2 + 0x13);
...

{
  ...
  if (*(int *)(param_2 + 0x38) == 1) {
    ...
    fVar2 = (float)fVar1 + *(float *)(unaff_EBX + 0x1f3691 /* 5.0f */ /* 5.0f */ /* 5.0f */);
    ...
    fVar1 = (float10)CountdownTimer::Now();
    fVar2 = (float)fVar1 + *(float *)(unaff_EBX + 0x187ea1 /* 3.0f */ /* 3.0f */ /* 3.0f */);
    ...
    fVar1 = (float10)CountdownTimer::Now();
    fVar2 = (float)fVar1 + *(float *)(unaff_EBX + 0x187a39 /* 1.0f */ /* 1.0f */ /* 1.0f */);
    if (*(float *)(param_2 + 0x50) != fVar2) {
      (**(code **)(*(int *)(param_2 + 0x48) + 4))(param_2 + 0x48,param_2 + 0x50); /* timer_1.NetworkStateChanged() */
...

{
  ...
  return extraout_ECX + 0x2508ca /* "Special Action" */ /* "Special Action" */ /* "Special Action" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x467053 /* vtable for CINSBotSpecialAction+0x8 */ /* vtable for CINSBotSpecialAction+0x8 */ /* vtable for CINSBotSpecialAction+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x4671e3 /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */;
...

{
  ...
  *in_stack_00000004 = &UNK_0046700a + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x46719a /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */ /* vtable for CINSBotSpecialAction+0x198 */;
