...

{
  ...
  if (iVar4 != 0) {
    ...
    if (iVar4 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x249b62 /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
      return param_1;
    }
  }
  ...
  if (iVar4 != iVar5) {
    ...
    *(undefined4 *)param_1 = 2 /* SuspendFor */;
    *(void **)(param_1 + 4) = pvVar6;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24b74b /* "Escorting nearest Human" */ /* "Escorting nearest Human" */ /* "Escorting nearest Human" */;
    *(undefined4 *)((int)param_2 + 0x20) = 0;
    *(undefined4 *)((int)param_2 + 0x24) = 0;
    *(undefined4 *)((int)param_2 + 0x28) = 0;
    *(undefined4 *)((int)param_2 + 0x2c) = 0;
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 != '\0') {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b6f3 /* "I have an investigation!" */ /* "I have an investigation!" */ /* "I have an investigation!" */;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x46faf1 /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */) + 0x40))(*(int **)(unaff_EBX + 0x46faf1 /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */));
    if (iVar4 != 0) {
      ...
      if (((piVar3 != (int *)0x0) && (cVar2 = (**(code **)(*piVar3 + 0x158 /* CBasePlayer::IsPlayer */))(piVar3), cVar2 != '\0')
        ...
        *(undefined4 *)param_1 = 2 /* SuspendFor */;
        *(CNavArea **)(param_1 + 4) = pCVar8;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24b722 /* "Knifing a player" */ /* "Knifing a player" */ /* "Knifing a player" */;
        *(undefined4 *)((int)param_2 + 0x20) = 0;
        *(undefined4 *)((int)param_2 + 0x24) = 0;
        *(undefined4 *)((int)param_2 + 0x28) = 0;
        *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    iVar4 = **(int **)(unaff_EBX + 0x4702c1 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
    ...
    pCVar9 = *(CINSNextBot **)(unaff_EBX + 0x46fe9d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */);
    if (*(char *)(*(int *)pCVar9 + 0x3ac) != '\0') {
      ...
      piVar3 = *(int **)(unaff_EBX + 0x46fe45 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
      fVar12 = *(float *)((int)param_2 + 0x3c);
      if (fVar12 < 0.0) {
        fVar12 = *(float *)(*piVar3 + 0xc);
        *(float *)((int)param_2 + 0x3c) = fVar12;
      }
      fVar13 = *(float *)(unaff_EBX + 0x1820b9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
      fVar12 = ((*(float *)(unaff_EBX + 0x201281 /* -20.0f */ /* -20.0f */ /* -20.0f */) + *(float *)(*piVar3 + 0xc)) - fVar12) *
               *(float *)(unaff_EBX + 0x241491 /* 0.025f */ /* 0.025f */ /* 0.025f */);
      if (fVar13 <= fVar12) {
        fVar12 = fVar13;
      }
      ...
      if ((float)fVar11 < fVar13) {
        iVar4 = (int)fVar10 * 0xc + **(int **)(unaff_EBX + 0x4702c1 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
        ...
        if ((piVar3 != (int *)0x0) && (iVar4 = (**(code **)(*piVar3 + 0x548 /* CINSNextBot::GetLastKnownArea */))(piVar3), iVar4 != 0))
        {
          ...
          *(undefined4 *)param_1 = 2 /* SuspendFor */;
          *(CNavArea **)(param_1 + 4) = pCVar8;
          *(int *)(param_1 + 8) = unaff_EBX + 0x24b765 /* "Counter-attacking enemy directly" */ /* "Counter-attacking enemy directly" */ /* "Counter-attacking enemy directly" */;
          *(undefined4 *)((int)param_2 + 0x20) = 0;
          *(undefined4 *)((int)param_2 + 0x24) = 0;
          *(undefined4 *)((int)param_2 + 0x28) = 0;
          *(undefined4 *)((int)param_2 + 0x2c) = 0;
      ...
      *(undefined4 *)param_1 = 2 /* SuspendFor */;
      *(void **)(param_1 + 4) = pvVar6;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b789 /* "It's a counter-attack and we're not hunting, re-cap" */ /* "It's a counter-attack and we're not hunting, re-cap" */ /* "It's a counter-attack and we're not hunting, re-cap" */;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    *(undefined4 *)((int)param_2 + 0x3c) = 0xbf800000 /* -1.0f */;
    if (((0 < local_34) && ((uint)fVar10 < 0x10)) &&
      ...
      if (iVar4 != 0) {
        ...
        *(undefined4 *)((int)param_2 + 0x28) = 0;
        *(undefined4 *)((int)param_2 + 0x2c) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24b7bd /* "Counter-attacking contested point" */ /* "Counter-attacking contested point" */ /* "Counter-attacking contested point" */;
        return param_1;
      }
    }
    if ((*(byte *)(in_stack_0000000c + 0x8a5) & 4) != 0) {
      ...
      *(undefined4 *)param_1 = 2 /* SuspendFor */;
      *(void **)(param_1 + 4) = pvVar6;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b733 /* "Defending." */ /* "Defending." */ /* "Defending." */;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    if ((float)fVar11 < *(float *)(unaff_EBX + 0x1edcfd /* 0.5f */ /* 0.5f */ /* 0.5f */)) {
      ...
      *(undefined4 *)param_1 = 2 /* SuspendFor */;
      *(void **)(param_1 + 4) = pvVar6;
      *(int *)(param_1 + 8) = unaff_EBX + 0x24b73e /* "Guarding CP." */ /* "Guarding CP." */ /* "Guarding CP." */;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
...

{
  ...
  return extraout_ECX + 0x1f6e06 /* "Checkpoint" */ /* "Checkpoint" */ /* "Checkpoint" */;
}
  ...
  if (in_stack_00000008 != (int *)0x0) {
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        cVar4 = ((float)fVar5 < *(float *)(unaff_EBX + 0x24b880 /* 1400.0f */ /* 1400.0f */ /* 1400.0f */) ||
                (float)fVar5 == *(float *)(unaff_EBX + 0x24b880 /* 1400.0f */ /* 1400.0f */ /* 1400.0f */)) + '\x01';
      }
    }
  }
  return cVar4;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x461d93 /* vtable for CINSBotActionCheckpoint+0x8 */ /* vtable for CINSBotActionCheckpoint+0x8 */ /* vtable for CINSBotActionCheckpoint+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x461f2b /* vtable for CINSBotActionCheckpoint+0x1a0 */ /* vtable for CINSBotActionCheckpoint+0x1a0 */ /* vtable for CINSBotActionCheckpoint+0x1a0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46fe43 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x461d4a /* vtable for CINSBotActionCheckpoint+0x8 */ /* vtable for CINSBotActionCheckpoint+0x8 */ /* vtable for CINSBotActionCheckpoint+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x461ee2 /* vtable for CINSBotActionCheckpoint+0x1a0 */ /* vtable for CINSBotActionCheckpoint+0x1a0 */ /* vtable for CINSBotActionCheckpoint+0x1a0 */;
