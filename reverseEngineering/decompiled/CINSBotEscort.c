...

{
  ...
  *in_stack_00000004 = &UNK_0047c5bd + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x47c75d /* vtable for CINSBotEscort+0x1a8 */ /* vtable for CINSBotEscort+0x1a8 */;
  puVar1 = &UNK_0040ddcd + unaff_EBX;
  in_stack_00000004[10] = 0;
  in_stack_00000004[3] = 0;
  pcVar2 = (code *)(unaff_EBX + -0x4e9c7b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
...

{
    ...
    if (cVar2 != '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        if (iVar5 == 1) {
          ...
          *(int *)(param_1 + 8) = unaff_EBX + 0x264a98 /* "Combat time!" */ /* "Combat time!" */;
          return param_1;
        }
      }
    }
  ...
  if (*(float *)((int)param_2 + 100) <= (float)fVar8 &&
    ...
    if (((*(int *)((int)param_2 + 0x38) < 1) ||
        (this_02 = this_01,
        *(int *)(**(int **)(unaff_EBX + 0x48a545 /* &gpGlobals */ /* &gpGlobals */) + 0x14) < *(int *)((int)param_2 + 0x38))) &&
       (SetEscortTarget(this_01), this_02 = extraout_ECX, *(int *)((int)param_2 + 0x38) == -1)) {
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x264aa5 /* "Unable to get escort Target" */ /* "Unable to get escort Target" */;
      return param_1;
    }
    ...
    *(float *)((int)param_2 + 0x4c) = (float)fVar8;
    ...
    if (*(float *)((int)param_2 + 0x7c) <= (float)fVar8 &&
      ...
      fVar8 = (float10)CountdownTimer::Now();
      fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x19c7b9 /* 1.0f */ /* 1.0f */);
    ...
    fVar8 = (float10)CountdownTimer::Now();
    fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x20aa9d /* 0.15f */ /* 0.15f */);
  ...
  if (9 < *(int *)(in_stack_0000000c + 0xb324)) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x264c15 /* "Path compute failed. Let's go back to Game Mode" */ /* "Path compute failed. Let's go back to Game Mode" */;
    return param_1;
  }
  *(undefined4 *)param_1 = 0 /* Continue */;
  *(undefined4 *)(param_1 + 4) = 0;
...

{
  ...
  return extraout_ECX + 0x26456b /* "Escort" */ /* "Escort" */;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar1 = *(int *)(extraout_EDX + 0x1c /* CINSBotEscort::ShouldRetreat */ /* CINSBotEscort::ShouldRetreat */);
  if (iVar1 != 0) {
    ...
    if (cVar2 != '\0') {
      ...
      fVar5 = *(float *)(extraout_EDX + 0x3c /* CINSBotEscort::ShouldRetreat */ /* CINSBotEscort::ShouldRetreat */) - *(float *)(iVar1 + 0x208);
      fVar3 = *(float *)(extraout_EDX + 0x40 /* CINSBotEscort::ShouldRetreat */ /* CINSBotEscort::ShouldRetreat */) - *(float *)(iVar1 + 0x20c);
      fVar4 = *(float *)(extraout_EDX + 0x44 /* CINSBotEscort::ShouldRetreat */ /* CINSBotEscort::ShouldRetreat */) - *(float *)(iVar1 + 0x210);
      return (*(float *)(unaff_EBX + 0x222aaf /* 256.0f */ /* 256.0f */) <=
...

{
  ...
  if (((cVar1 != '\0') && (cVar1 = CBaseEntity::InSameTeam(in_stack_0000000c), cVar1 == '\0')) &&
    ...
    if ((**(int **)(unaff_EBX + 0x48cac2 /* &TheNavMesh */ /* &TheNavMesh */) != 0) &&
      ...
      if ((cVar1 != '\0') && (cVar1 = CINSWeapon::IsFlashlightOn(this_01), cVar1 == '\0')) {
        ...
        fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x20ab76 /* 5.0f */ /* 5.0f */);
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar1 = 0;
  if (*(int *)(extraout_EDX + 0x20 /* CINSBotEscort::OnLostSight */ /* CINSBotEscort::OnLostSight */) != 0) {
    iVar1 = *(int *)(extraout_EDX + 0x20 /* CINSBotEscort::OnLostSight */ /* CINSBotEscort::OnLostSight */) - *(int *)(**(int **)(unaff_EBX + 0x48d7ff /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
  }
...

{
  ...
  if (cVar2 != '\0') {
    ...
    if ((iVar6 == iVar7) || (*(float *)(unaff_EBX + 0x267201 /* 6000.0f */ /* 6000.0f */) <= fVar10)) {
      ...
      if (iVar6 == iVar7) {
        ...
        fVar11 = *(float *)(**(int **)(unaff_EBX + 0x48cad1 /* &gpGlobals */ /* &gpGlobals */) + 0xc) - *(float *)(iVar6 + 600);
        if ((*(float *)(&DAT_0020a99d + unaff_EBX) <= fVar11 &&
             fVar11 != *(float *)(&DAT_0020a99d + unaff_EBX)) &&
           (fVar10 < *(float *)(unaff_EBX + 0x20b241 /* 1000.0f */ /* 1000.0f */))) {
          cVar2 = (**(code **)(*(int *)param_3 + 0x158 /* CBasePlayer::IsPlayer */))(param_3);
          if (cVar2 != '\0') {
            local_b4 = 0;
            pfVar3 = *(float **)(unaff_EBX + 0x48c7fd /* &vec3_origin */ /* &vec3_origin */);
            local_40 = *pfVar3;
            local_3c = pfVar3[1];
            local_38 = pfVar3[2];
            uVar13 = 0;
            ...
            fVar10 = *(float *)(unaff_EBX + 0x20b249 /* 400.0f */ /* 400.0f */);
            ...
            (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x48c9a9 /* &enginetrace */ /* &enginetrace */) + 0x14))
                      ((int *)**(undefined4 **)(unaff_EBX + 0x48c9a9 /* &enginetrace */ /* &enginetrace */),&local_ac,0x2006241,&local_50,
                       local_100);
            ...
            if (fVar10 != 0.0) {
              ...
              local_50 = local_f4;
              local_48 = (float)fVar9 + *(float *)(unaff_EBX + 0x2442a9 /* 69.0f */ /* 69.0f */);
              local_4c = local_f0;
              piVar5 = (int *)(**(code **)(*(int *)param_2 + 0x970 /* CINSNextBot::GetBodyInterface */))(param_2,fVar11,uVar8);
              (**(code **)(*piVar5 + 0xd4 /* PlayerBody::AimHeadTowards */))(piVar5,&local_50,3,0x3f19999a /* 0.6f */,0,unaff_EBX + 0x267075 /* "Looking at where friendly shooter is aiming" */ /* "Looking at where friendly shooter is aiming" */);
            }
          }
        }
      }
      ...
      (*pcVar1)(piVar5,uVar8,3,0x3ecccccd /* 0.4f */,0,unaff_EBX + 0x26704d /* "Looking in direction of enemy gun fire" */ /* "Looking in direction of enemy gun fire" */);
    }
  }
  *in_EAX = 0;
  in_EAX[1] = 0;
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (0 < *(int *)(unaff_EBX + 0x5d0f7c /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */)) {
    iVar8 = 0;
    do {
      this = (CBaseEntity *)(iVar8 * 4);
      iVar7 = *(int *)(*(int *)(unaff_EBX + 0x5d0f70 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */) + iVar8 * 4);
      ...
      if (((piVar3 != (int *)0x0) &&
         ...
         (iVar7 = *(int *)(*(int *)(this + *(int *)(unaff_EBX + 0x5d0f70 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */)) + 4),
        ...
        iVar4 = *(int *)(this + *(int *)(unaff_EBX + 0x5d0f70 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */));
        ...
        iVar7 = CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>>::InsertBefore
                          (*(CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>>
                             **)(*(int *)(unaff_EBX + 0x48affc /* &vec3_origin */ /* &vec3_origin */) + 4),iVar4 + 0x20,
      ...
      iVar8 = iVar8 + 1;
    } while (iVar8 < *(int *)(unaff_EBX + 0x5d0f7c /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */));
  }
  return -1;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar2 = *(int *)(unaff_EBX + 0x5d1f21 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */);
  if ((iVar2 != 0) && (0 < iVar2)) {
    local_1c = 0;
    do {
      iVar6 = 0;
      if (*(int *)(param_1 + 0x20) != 0) {
        iVar6 = *(int *)(param_1 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48c275 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
      }
      iVar3 = *(int *)(*(int *)(unaff_EBX + 0x5d1f15 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */) + local_1c * 4);
...

{
  ...
  if ((pcVar1 != (char *)0x0) && (*pcVar1 != '\0')) {
    iVar3 = 0;
    if (*(int *)(param_1 + 0x20) != 0) {
      iVar3 = *(int *)(param_1 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48c18f /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
    }
...

{
  ...
  if ((in_stack_00000010 != (int *)0x0) &&
    ...
    if ((iVar2 != iVar3) &&
       (((iVar2 = CINSPlayer::GetActiveINSWeapon(), iVar2 != 0 &&
         (iVar2 = **(int **)(unaff_EBX + 0x48d1e4 /* &TheNavMesh */ /* &TheNavMesh */), iVar2 != 0)) &&
      ...
      if (((iVar2 != 0) &&
           ...
           *(float *)(iVar2 + 0xec)) * *(float *)(unaff_EBX + 0x20a5b8 /* 0.25f */ /* 0.25f */) <
           *(float *)(unaff_EBX + 0x20b284 /* 0.5f */ /* 0.5f */))) &&
         ((cVar1 = CINSWeapon::HasFlashlight(this_01), cVar1 != '\0' &&
          (cVar1 = CINSWeapon::IsFlashlightOn(this_02), cVar1 == '\0')))) {
        fVar5 = (float10)CountdownTimer::Now();
        fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x20b298 /* 5.0f */ /* 5.0f */);
        if (*(float *)(param_2 + 0x70) != fVar6) {
          (**(code **)(*(int *)(param_2 + 0x68) + 4))(param_2 + 0x68,param_2 + 0x70);
          *(float *)(param_2 + 0x70) = fVar6;
        }
...

{
  ...
  if ((in_stack_00000010 != 0) && (param_3 != (CNavArea *)0x0)) {
    ...
    if ((*(char *)(iVar2 + 0x129) != '\0') &&
        ...
        *(float *)(unaff_EBX + 0x20a2c8 /* 0.25f */ /* 0.25f */) < *(float *)(unaff_EBX + 0x20f9f0 /* 0.35f */ /* 0.35f */))) {
        ...
        if (iVar2 != 0) {
          ...
          if (cVar1 != '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              fVar4 = (float)fVar3 + *(float *)(unaff_EBX + 0x19f7b8 /* 3.0f */ /* 3.0f */);
...

{
  ...
  iVar5 = *(int *)(unaff_EBX + 0x5d0db1 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */);
  if (iVar5 == 0) {
    iVar4 = (**(code **)(*(int *)(unaff_EBX + 0x5d0dc5 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */) + 0x40))(unaff_EBX + 0x5d0dc5 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */);
    if (iVar4 != 0) {
      CBaseEntity::GetDebugName(this_03);
      CBaseEntity::GetDebugName(this_07);
      DevMsg((char *)(unaff_EBX + 0x265711 /* "Bot%s Creating first formation for nearest player: %s" */ /* "Bot%s Creating first formation for nearest player: %s" */));
    }
    iVar4 = 0;
    if (*(int *)(local_94 + 0x20) != 0) {
      iVar4 = *(int *)(local_94 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
    }
    puVar10 = (undefined1 *)::operator_new(0x40);
    *(int *)(puVar10 + 8) = iVar4;
    pCVar2 = *(CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>> **)
              (unaff_EBX + 0x48ae31 /* &vec3_origin */ /* &vec3_origin */);
    ...
    *(int *)(puVar10 + 0x34) = unaff_EBX + 0x40ca1d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
    ...
    *(undefined4 *)(puVar10 + 0x3c) = 0xbf800000 /* -1.0f */;
    ...
    ppuVar18 = &local_24;
    ppIVar17 = *(INSBotEscortFormation ***)(unaff_EBX + 0x5d0db1 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */);
    local_24 = puVar10;
    CUtlVector<INSBotEscortFormation*,CUtlMemory<INSBotEscortFormation*,int>>::InsertBefore
              (pCVar13,unaff_EBX + 0x5d0da5 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */,ppIVar17);
    ...
    if (*(int *)(pCVar1 + 0x20) != 0) {
      iVar5 = *(int *)(pCVar1 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
    }
  ...
  if (iVar4 == 0) {
    ...
    while( true ) {
      ...
      iVar16 = *(int *)(*(int *)(unaff_EBX + 0x5d0da5 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */) + local_98 * 4);
...
LAB_0071c050:
    ...
    if (iVar4 != 0) {
      ...
      DevMsg((char *)(unaff_EBX + 0x2657a9 /* "Bot%s Joining nearest players formation: %s" */ /* "Bot%s Joining nearest players formation: %s" */));
    }
    iVar4 = 0;
    if (*(int *)(pCVar1 + 0x20) != 0) {
      iVar4 = *(int *)(pCVar1 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
    }
    local_94 = *(CINSNextBot **)(unaff_EBX + 0x5d0da5 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */);
...
LAB_0071c121:
        ...
        if (piVar7 != (int *)0x0) {
          ...
          if ((int)*(t_INSBotEscortMember **)(iVar5 + 0x2c) <
            ...
            CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>>::InsertBefore
                      (*(CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>> **)
                        (*(int *)(unaff_EBX + 0x48ae31 /* &vec3_origin */ /* &vec3_origin */) + 4),iVar5 + 0x20,
  ...
  iVar5 = 0;
  if (*(int *)(local_94 + 0x20) != 0) {
    iVar5 = *(int *)(local_94 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
  }
  ...
  if (pCVar6 == (CINSNextBot *)0x0) {
    ...
    *(undefined4 *)(puVar10 + 0x3c) = 0xbf800000 /* -1.0f */;
    ...
    local_20[0] = puVar10;
    CUtlVector<INSBotEscortFormation*,CUtlMemory<INSBotEscortFormation*,int>>::InsertBefore
              (pCVar13,unaff_EBX + 0x5d0da5 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */,*(INSBotEscortFormation ***)(unaff_EBX + 0x5d0db1 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */));
    iVar4 = GetEscortFormation((CBaseEntity *)local_94);
    if (iVar4 == 0) {
      return;
    }
    ...
    *(undefined4 *)(in_stack_00000004 + 0x38) = *(undefined4 *)(iVar4 + 8);
    ...
    CINSNextBot::SetEscortFormation(in_stack_00000004,(INSBotEscortFormation *)pCVar1);
    if (*(int *)(pCVar1 + 0x20) != 0) {
      iVar16 = *(int *)(pCVar1 + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
    }
  ...
  iVar5 = (**(code **)(*(int *)(unaff_EBX + 0x5d0dc5 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */) + 0x40))(unaff_EBX + 0x5d0dc5 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */);
  if (iVar5 != 0) {
    CBaseEntity::GetDebugName(this_01);
    DevMsg((char *)(unaff_EBX + 0x265749 /* "Bot:%s leaving old and joining new Formation" */ /* "Bot:%s leaving old and joining new Formation" */));
  }
  local_94 = (CINSNextBot *)0x0;
  local_98 = *(int *)(pCVar1 + 0x20);
  if (local_98 != 0) {
    local_94 = (CINSNextBot *)(local_98 - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4);
  }
...
LAB_0071b909:
  ...
  if (local_98 != 0) {
    pCVar15 = (CINSNextBot *)(local_98 - *(int *)(**(int **)(unaff_EBX + 0x48b105 /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4);
  }
...
LAB_0071b985:
      ...
      if (piVar7 != (int *)0x0) {
        ...
        if ((int)*(t_INSBotEscortMember **)(pCVar6 + 0x2c) < (int)((-(uint)(cVar3 == '\0') & 2) + 3)
          ...
          CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>>::InsertBefore
                    (*(CUtlVector<t_INSBotEscortMember,CUtlMemory<t_INSBotEscortMember,int>> **)
                      (*(int *)(unaff_EBX + 0x48ae31 /* &vec3_origin */ /* &vec3_origin */) + 4),(int)(pCVar6 + 0x20),
...

{
  ...
  return (*(float *)(unaff_EBX + 0x222e1c /* 256.0f */ /* 256.0f */) < *(float *)(param_1 + 0x4c) ||
         *(float *)(unaff_EBX + 0x222e1c /* 256.0f */ /* 256.0f */) == *(float *)(param_1 + 0x4c)) + '\x01';
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  iVar2 = *(int *)(unaff_EBX + 0x5d1181 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */);
  if (0 < iVar2) {
    local_28 = iVar2 + -1;
    local_2c = (INSBotEscortFormation *)(iVar2 << 2);
    do {
      while (pCVar1 = (CUtlMemory<t_INSBotEscortMember,int> *)(local_2c + -4),
            **(char **)(local_2c + *(int *)(unaff_EBX + 0x5d1175 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */) + -4) == '\0') {
        iVar2 = (**(code **)(*(int *)(unaff_EBX + 0x5d1195 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */) + 0x40))(unaff_EBX + 0x5d1195 /* ins_bot_debug_escort_formations */ /* ins_bot_debug_escort_formations */);
        if (iVar2 != 0) {
          DevMsg((char *)(unaff_EBX + 0x265a11 /* "Removing Formation: %i" */ /* "Removing Formation: %i" */));
        }
        pvVar3 = *(void **)(pCVar1 + *(int *)(unaff_EBX + 0x5d1175 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */));
        this_00 = pCVar1;
          ...
          do {
            ...
            if ((iVar4 != 0) &&
               (pIVar5 = (INSBotEscortFormation *)
                         __dynamic_cast(iVar4,*(undefined4 *)(unaff_EBX + 0x48bd39 /* &typeinfo for CBaseEntity */ /* &typeinfo for CBaseEntity */),
                                        *(undefined4 *)(unaff_EBX + 0x48b65d /* &typeinfo for CINSNextBot */ /* &typeinfo for CINSNextBot */),0),
        ...
        *(undefined4 *)((int)pvVar3 + 0x2c) = 0;
        if (*(int *)((int)pvVar3 + 0x28) < 0) {
          ...
          if (this_00 != (CUtlMemory<t_INSBotEscortMember,int> *)0x0) {
            (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x48b4ad /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                      ((int *)**(undefined4 **)(unaff_EBX + 0x48b4ad /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),this_00);
        ...
        *(undefined4 *)((int)pvVar3 + 0x30) = uVar6;
        ...
        if (0 < iVar7) {
          _V_memmove(pCVar1 + *(int *)(unaff_EBX + 0x5d1175 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */),
                     local_2c + *(int *)(unaff_EBX + 0x5d1175 /* CINSBotEscort::m_escortFormations */ /* CINSBotEscort::m_escortFormations */),iVar7 * 4);
          iVar2 = *(int *)(unaff_EBX + 0x5d1181 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */);
        }
        local_28 = local_28 + -1;
        *(int *)(unaff_EBX + 0x5d1181 /* CINSBotEscort::m_escortFormations+0xc */ /* CINSBotEscort::m_escortFormations+0xc */) = iVar2 + -1;
...

{
  ...
  fVar7 = *(float *)(**(int **)(unaff_EBX + 0x48ba09 /* &gpGlobals */ /* &gpGlobals */) + 0xc) - *(float *)(iVar3 + 600);
  if (*(float *)(unaff_EBX + 0x20aeb9 /* 6.0f */ /* 6.0f */) <= fVar7 && fVar7 != *(float *)(unaff_EBX + 0x20aeb9 /* 6.0f */ /* 6.0f */)) {
    cVar2 = (**(code **)(*in_stack_00000008 + 0x8ac /* CINSNextBot::IsInCombat */))();
    if ((cVar2 == '\0') && (param_1[0x48] != (CINSNextBot)0x0)) {
      local_b4 = 0;
      pfVar1 = *(float **)(unaff_EBX + 0x48b735 /* &vec3_origin */ /* &vec3_origin */);
      local_40 = *pfVar1;
      local_3c = pfVar1[1];
      local_38 = pfVar1[2];
      ...
      if (*(float *)(param_1 + 0x88) <= (float)fVar6 && (float)fVar6 != *(float *)(param_1 + 0x88))
      {
        ...
        if (cVar2 != '\0') {
          ...
          if (*(float *)(unaff_EBX + 0x208bf5 /* 0.25f */ /* 0.25f */) <= (float)fVar6 &&
              (float)fVar6 != *(float *)(unaff_EBX + 0x208bf5 /* 0.25f */ /* 0.25f */)) {
            ...
            if (piVar5 != (int *)0x0) {
              ...
              if (cVar2 != '\0') {
                ...
                if (cVar2 == '\0') {
                  fVar7 = *(float *)(unaff_EBX + 0x245169 /* CSWTCH.586+0x1c */ /* CSWTCH.586+0x1c */);
                  ...
                  CTraceFilterSimple::CTraceFilterSimple
                            (this_07,(IHandleEntity *)&local_50,iVar3,
                             (_func_bool_IHandleEntity_ptr_int *)0x0);
                  (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x48b8e1 /* &enginetrace */ /* &enginetrace */) + 0x14))
                            ((int *)**(undefined4 **)(unaff_EBX + 0x48b8e1 /* &enginetrace */ /* &enginetrace */),&local_ac,0x2006241,
                             &local_50,local_100);
                  piVar5 = *(int **)(unaff_EBX + 0x48bba9 /* &r_visualizetraces */ /* &r_visualizetraces */);
                  ...
                  fVar7 = (float)CNavMesh::GetNearestNavAreaFast
                                           (this_00,(Vector *)
                                                    **(undefined4 **)(unaff_EBX + 0x48b821 /* &TheNavMesh */ /* &TheNavMesh */),
                                            SUB41(&local_f4,0));
                  if (fVar7 != 0.0) {
                    fVar6 = (float10)CNavArea::GetZ(this_08,fVar7,local_f4);
                    local_50 = local_f4;
                    local_48 = (float)fVar6 + *(float *)(unaff_EBX + 0x2431e1 /* 69.0f */ /* 69.0f */);
                    local_4c = local_f0;
                    piVar5 = (int *)(**(code **)(*in_stack_00000008 + 0x970 /* CINSNextBot::GetBodyInterface */))();
                    uVar11 = 3;
                    (**(code **)(*piVar5 + 0xd4 /* PlayerBody::AimHeadTowards */))
                              (piVar5,&local_50,3,0x3f19999a /* 0.6f */,0,unaff_EBX + 0x265fd9 /* "Looking at whatever Escort Target is paying attention to" */ /* "Looking at whatever Escort Target is paying attention to" */);
                  }
                }
              }
            }
...

{
  ...
  if (*(float *)(unaff_EBX + 0x266746 /* rodata:0x47FD2000 */ /* rodata:0x47FD2000 */) <=
  ...
  if ((uVar5 & 1) != 0) {
    ...
    if ((cVar3 != '\0') ||
       ...
       *(float *)(unaff_EBX + 0x20a77a /* 0.7f */ /* 0.7f */) <= (float)fVar9 &&
       (float)fVar9 != *(float *)(unaff_EBX + 0x20a77a /* 0.7f */ /* 0.7f */))) {
  ...
  if (((*(float *)(unaff_EBX + 0x209ece /* 30.0f */ /* 30.0f */) <= fVar10 && fVar10 != *(float *)(unaff_EBX + 0x209ece /* 30.0f */ /* 30.0f */)) &&
  ...
  if (cVar3 == '\0') {
    ...
    if (cVar3 != '\0') {
      if (*(float *)(unaff_EBX + 0x209eca /* 0.5f */ /* 0.5f */) <= fVar1 && fVar1 != *(float *)(unaff_EBX + 0x209eca /* 0.5f */ /* 0.5f */))
      goto LAB_0071ab90;
      if (fVar1 < *(float *)(unaff_EBX + 0x19e28e /* 0.1f */ /* 0.1f */) || fVar1 == *(float *)(unaff_EBX + 0x19e28e /* 0.1f */ /* 0.1f */))
      goto LAB_0071aa16;
      goto LAB_0071ac30;
    }
    iVar8 = *in_stack_00000008;
    if (*(float *)(unaff_EBX + 0x212e06 /* 0.33f */ /* 0.33f */) <= fVar1 && fVar1 != *(float *)(unaff_EBX + 0x212e06 /* 0.33f */ /* 0.33f */)) {
    ...
    if (*(float *)(unaff_EBX + 0x20c55a /* 0.85f */ /* 0.85f */) <= fVar1 && fVar1 != *(float *)(unaff_EBX + 0x20c55a /* 0.85f */ /* 0.85f */)) {
LAB_0071ab90:
      (**(code **)(*in_stack_00000008 + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_00000008);
      CINSBotBody::SetPosture();
      goto LAB_0071aa16;
...

{
  ...
  if (param_2 != (CINSNextBot *)0x0) {
    ...
    if (*(int *)(in_stack_0000000c + 0x20) != 0) {
      iVar8 = *(int *)(in_stack_0000000c + 0x20) - *(int *)(**(int **)(unaff_EBX + 0x48bbd5 /* &gpGlobals */ /* &gpGlobals */) + 0x5c)
              >> 4;
    }
    pfVar3 = *(float **)(unaff_EBX + 0x48b901 /* &vec3_origin */ /* &vec3_origin */);
    fVar10 = *pfVar3;
    fVar9 = pfVar3[1];
    fVar11 = pfVar3[2];
...
LAB_0071ad56:
    ...
    *(float *)(param_1 + 0x44) = fVar11;
    ...
    fVar10 = SQRT((fVar9 - *(float *)(in_stack_0000000c + 0x20c)) *
                  ...
                  (fVar11 - *(float *)(in_stack_0000000c + 0x210)));
    if ((*(float *)(unaff_EBX + 0x2129b9 /* 500.0f */ /* 500.0f */) <= fVar10) ||
    ...
    else if (*(float *)(unaff_EBX + 0x231a89 /* 128.0f */ /* 128.0f */) <= fVar10 &&
             fVar10 != *(float *)(unaff_EBX + 0x231a89 /* 128.0f */ /* 128.0f */)) {
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x47a143 /* vtable for CINSBotEscort+0x8 */ /* vtable for CINSBotEscort+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x47a2e3 /* vtable for CINSBotEscort+0x1a8 */ /* vtable for CINSBotEscort+0x1a8 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x48a913 /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x47a03a /* vtable for CINSBotEscort+0x8 */ /* vtable for CINSBotEscort+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x47a1da /* vtable for CINSBotEscort+0x1a8 */ /* vtable for CINSBotEscort+0x1a8 */;
