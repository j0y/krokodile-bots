...

{
  ...
  iVar2 = *(int *)(unaff_EBX + 0x4b2129 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */);
  ...
  if (bVar10) {
    ...
    if (iVar7 == iVar6) {
      ...
      if (*piVar8 != unaff_EBX + 0x28adc5 /* "CINSNextBotPathCost::operator()" */ /* "CINSNextBotPathCost::operator()" */ /* "CINSNextBotPathCost::operator()" */) {
        piVar8 = (int *)CVProfNode::GetSubNode
                                  ((char *)piVar8,unaff_EBX + 0x28adc5 /* "CINSNextBotPathCost::operator()" */ /* "CINSNextBotPathCost::operator()" */ /* "CINSNextBotPathCost::operator()" */,(char *)0x0,
                                   unaff_EBX + 0x28c41e /* "NextBot" */ /* "NextBot" */ /* "NextBot" */);
  ...
  iVar6 = (**(code **)(**(int **)(unaff_EBX + 0x4b24a5 /* &ins_nav_enable_pathfinding_updates */ /* &ins_nav_enable_pathfinding_updates */ /* &ins_nav_enable_pathfinding_updates */) + 0x40))(*(int **)(unaff_EBX + 0x4b24a5 /* &ins_nav_enable_pathfinding_updates */ /* &ins_nav_enable_pathfinding_updates */ /* &ins_nav_enable_pathfinding_updates */));
  if (iVar6 == 0) {
    if (param_3 != (CNavLadder *)0x0) {
      ...
      if (param_4 == (CFuncElevator *)0x0) {
        ...
        if (in_stack_00000018 < *(float *)(unaff_EBX + 0x1c42bd /* 0.0f */ /* 0.0f */ /* 0.0f */) ||
            in_stack_00000018 == *(float *)(unaff_EBX + 0x1c42bd /* 0.0f */ /* 0.0f */ /* 0.0f */)) {
      ...
      piVar8 = (int *)(*(int **)(unaff_EBX + 0x4b23b9 /* &ins_bot_path_simplify_range */ /* &ins_bot_path_simplify_range */ /* &ins_bot_path_simplify_range */))[7];
      if (piVar8 == *(int **)(unaff_EBX + 0x4b23b9 /* &ins_bot_path_simplify_range */ /* &ins_bot_path_simplify_range */ /* &ins_bot_path_simplify_range */)) {
...
LAB_006f4a18:
          ...
          local_38 = (float)iVar6 * local_34 * *(float *)(unaff_EBX + 0x22ff0d /* 0.5f */ /* 0.5f */ /* 0.5f */);
        }
        else {
...
LAB_006f4c30:
          local_30 = *(float *)(unaff_EBX + 0x1c42c5 /* -1.0f */ /* -1.0f */ /* -1.0f */);
          goto LAB_006f48f0;
        }
        local_34 = local_34 * *(float *)(&DAT_001c4731 + unaff_EBX);
      }
      else if (fVar12 <= (float)((uint)*(float *)(param_1 + 0x1c) ^ *(uint *)(unaff_EBX + 0x2303b5 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */))
              ) {
        if (fVar12 <= (float)(*(uint *)(param_1 + 0x24) ^ *(uint *)(unaff_EBX + 0x2303b5 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */)))
        goto LAB_006f4c30;
        local_34 = local_34 * *(float *)(&DAT_001c4731 + unaff_EBX);
      }
      if (((byte)param_2[0x68] & 0x80) != 0) {
        local_34 = local_34 * *(float *)(unaff_EBX + 0x22f965 /* 10.0f */ /* 10.0f */ /* 10.0f */);
      }
      ...
      if (iVar6 <= *(int *)(param_2 + 0x22c)) {
        local_34 = local_34 * *(float *)(unaff_EBX + 0x22ff11 /* 30.0f */ /* 30.0f */ /* 30.0f */);
      }
      iVar6 = *(int *)(param_1 + 8);
      local_3c = *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
      ...
      if (iVar6 == 0) {
        ...
        fVar13 = 0.0;
        if (*(int *)(iVar6 + 0x20) != 0) {
          uVar9 = ((int)(fVar12 * *(float *)(unaff_EBX + 0x1c42d1 /* 0.1f */ /* 0.1f */ /* 0.1f */)) + 1) * *(int *)(param_2 + 0x9c)
                  * (*(int *)(iVar6 + 0x20) - *(int *)(**(int **)(&LAB_004b2055 + unaff_EBX) + 0x5c)
                    >> 4);
          fVar13 = (float)(uVar9 >> 0x10) * *(float *)(unaff_EBX + 0x231501 /* 65536.0f */ /* 65536.0f */ /* 65536.0f */) +
                   (float)(uVar9 & 0xffff);
        }
        fVar11 = (float10)FastCos(fVar13);
        iVar6 = *(int *)(param_1 + 8);
        local_3c = *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */) +
                   ((float)fVar11 + *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */)) *
      ...
      if (iVar6 == 2) {
        ...
        local_40 = *(float *)(unaff_EBX + 0x28b1d9 /* 6.5f */ /* 6.5f */ /* 6.5f */);
        this_02 = this_04;
        if (cVar4 != '\0') {
      ...
      if (*(float *)(unaff_EBX + 0x1c42bd /* 0.0f */ /* 0.0f */ /* 0.0f */) <= (float)fVar11 &&
          (float)fVar11 != *(float *)(unaff_EBX + 0x1c42bd /* 0.0f */ /* 0.0f */ /* 0.0f */)) {
      ...
      local_30 = local_38 + *(float *)(param_3 + 0x54) +
                 (local_34 * *(float *)(unaff_EBX + 0x22ff21 /* 5.0f */ /* 5.0f */ /* 5.0f */) * (float)(byte)CVar5 + local_34) *
                 local_3c;
      goto LAB_006f48f0;
    }
  }
    ...
    if (*(float *)(param_1 + 0x1c) <= fVar12) {
      ...
      local_34 = *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
      local_30 = *(float *)(unaff_EBX + 0x22ff15 /* 4.0f */ /* 4.0f */ /* 4.0f */);
    }
    else if ((float)((uint)*(float *)(param_1 + 0x1c) ^ *(uint *)(unaff_EBX + 0x2303b5 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */)) < fVar12) {
      local_30 = *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
      local_34 = local_30;
    }
    else {
      if (fVar12 <= (float)(*(uint *)(param_1 + 0x24) ^ *(uint *)(unaff_EBX + 0x2303b5 /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */ /* SIGN_BIT_MASK */)))
    ...
    if ((*(uint *)(param_2 + 0x68) & 0x80) != 0) {
      local_30 = local_30 + *(float *)(unaff_EBX + 0x22ff21 /* 5.0f */ /* 5.0f */ /* 5.0f */);
    }
    ...
    iVar7 = (**(code **)(**(int **)(unaff_EBX + 0x4b28b1 /* &ins_nav_enable_distancetocp_pathing */ /* &ins_nav_enable_distancetocp_pathing */ /* &ins_nav_enable_distancetocp_pathing */) + 0x40))(*(int **)(unaff_EBX + 0x4b28b1 /* &ins_nav_enable_distancetocp_pathing */ /* &ins_nav_enable_distancetocp_pathing */ /* &ins_nav_enable_distancetocp_pathing */));
    if (iVar7 == 0) {
      ...
      if (iVar7 == -1) {
        ...
        fVar14 = SQRT((fVar13 - *(float *)(param_1 + 0x10)) * (fVar13 - *(float *)(param_1 + 0x10))
                      ...
                      + (*(float *)(param_2 + 0x34) - *(float *)(param_1 + 0x14)) *
                        (*(float *)(param_2 + 0x34) - *(float *)(param_1 + 0x14)));
        if (*(float *)(unaff_EBX + 0x2307c5 /* 1000.0f */ /* 1000.0f */ /* 1000.0f */) <= fVar14 && fVar14 != *(float *)(unaff_EBX + 0x2307c5 /* 1000.0f */ /* 1000.0f */ /* 1000.0f */)
           ) {
          ...
          if (fVar12 < 0.0) {
            local_30 = (float)((double)local_30 +
                              (double)((ulonglong)(double)fVar12 &
                                      *(ulonglong *)(unaff_EBX + 0x1c42e5 /* NaN / -1 */ /* NaN / -1 */ /* NaN / -1 */)));
          }
          else {
            fVar12 = (fVar12 + *(float *)(unaff_EBX + 0x1c42c5 /* -1.0f */ /* -1.0f */ /* -1.0f */)) * *(float *)(unaff_EBX + 0x28b1dd /* rodata:0x3A833405 */ /* rodata:0x3A833405 */ /* rodata:0x3A833405 */);
            if (local_34 <= fVar12) {
              fVar12 = local_34;
            }
            if (fVar12 <= 0.0) {
            ...
            local_30 = fVar12 * *(float *)(unaff_EBX + 0x230395 /* -4.0f */ /* -4.0f */ /* -4.0f */) + *(float *)(unaff_EBX + 0x22ff21 /* 5.0f */ /* 5.0f */ /* 5.0f */)
                       + local_30;
          }
          goto LAB_006f48f0;
        }
    ...
    local_30 = ((float)((uint)(fVar12 - *(float *)(param_1 + 0xc)) & *(uint *)(unaff_EBX + 0x230805 /* rodata:0x7FFFFFFF */ /* rodata:0x7FFFFFFF */ /* rodata:0x7FFFFFFF */)
                       ) +
               (float)((uint)(fVar13 - *(float *)(param_1 + 0x10)) & *(uint *)(unaff_EBX + 0x230805 /* rodata:0x7FFFFFFF */ /* rodata:0x7FFFFFFF */ /* rodata:0x7FFFFFFF */)
                      )) * local_30;
    goto LAB_006f48f0;
  }
  local_30 = *(float *)(unaff_EBX + 0x1c42c9 /* 1.0f */ /* 1.0f */ /* 1.0f */);
