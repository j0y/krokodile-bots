...

{
  ...
  *in_stack_00000004 = extraout_ECX + 0x462743 /* vtable for CINSBotActionAmbush+0x8 */ /* vtable for CINSBotActionAmbush+0x8 */ /* vtable for CINSBotActionAmbush+0x8 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  in_stack_00000004[1] = extraout_ECX + 0x4628d7 /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */;
...

{
  ...
  *(bool *)((int)param_2 + 0x38) = (float)fVar9 < *(float *)(unaff_EBX + 0x1ed761 /* 0.25f */ /* 0.25f */ /* 0.25f */);
  uVar3 = CBaseEntity::GetTeamNumber(in_stack_0000000c);
  cVar2 = CINSRules::IsAttackingTeam(this_01,**(int **)(unaff_EBX + 0x4705cd /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */));
  if (cVar2 != '\0') {
    ...
    if (iVar8 != 0) {
      ...
      if (iVar8 == 1) {
        ...
        *(int *)(param_1 + 8) = unaff_EBX + 0x24a292 /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        *(undefined4 *)param_1 = 2 /* SuspendFor */;
        *(int *)(param_1 + 8) = unaff_EBX + 0x24be23 /* "I have an investigation!" */ /* "I have an investigation!" */ /* "I have an investigation!" */;
        return param_1;
      }
      iVar8 = CINSNavMesh::GetRandomControlPointSurroundingArea(**(int **)(unaff_EBX + 0x47038d /* &TheNavMesh */ /* &TheNavMesh */ /* &TheNavMesh */));
      if (iVar8 != 0) {
...
LAB_00736395:
    ...
    *(void **)(param_1 + 4) = pvVar4;
    *(undefined4 *)param_1 = 2 /* SuspendFor */;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24be11 /* "Moving to capture" */ /* "Moving to capture" */ /* "Moving to capture" */;
    return param_1;
  }
...

{
  ...
  __i686_get_pc_thunk_cx();
  return extraout_ECX + 0x1f6f62 /* "Ambush" */ /* "Ambush" */ /* "Ambush" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x462673 /* vtable for CINSBotActionAmbush+0x8 */ /* vtable for CINSBotActionAmbush+0x8 */ /* vtable for CINSBotActionAmbush+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x462807 /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x470903 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  *in_stack_00000004 = &UNK_0046262a + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x4627be /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */ /* vtable for CINSBotActionAmbush+0x19c */;
