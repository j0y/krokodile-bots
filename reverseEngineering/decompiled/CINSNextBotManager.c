...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x43839d /* vtable for CINSNextBotManager+0x8 */ /* vtable for CINSNextBotManager+0x8 */ /* vtable for CINSNextBotManager+0x8 */;
  in_stack_00000004[0x14] = unaff_EBX + 0x4383e9 /* vtable for CINSNextBotManager+0x54 */ /* vtable for CINSNextBotManager+0x54 */ /* vtable for CINSNextBotManager+0x54 */;
  iVar2 = unaff_EBX + 0x3c32cd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
  *(undefined1 *)(in_stack_00000004 + 0x16) = 0;
  ...
  in_stack_00000004[0x26] = iVar2; /* CountdownTimer timer_0 */
  pcVar3 = (code *)(unaff_EBX + -0x53477b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
  in_stack_00000004[0x27] = 0;
  (*pcVar3)(piVar5,in_stack_00000004 + 0x27);
  in_stack_00000004[0x28] = -0x40800000 /* -1.0f */; /* timer_0.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x26] + 4))(piVar5,in_stack_00000004 + 0x28); /* timer_0.NetworkStateChanged() */
  piVar4 = in_stack_00000004 + 0x29;
  in_stack_00000004[0x2a] = 0;
  in_stack_00000004[0x29] = iVar2; /* CountdownTimer timer_1 */
  (*pcVar3)(piVar4,in_stack_00000004 + 0x2a);
  in_stack_00000004[0x2b] = -0x40800000 /* -1.0f */; /* timer_1.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x29] + 4))(piVar4,in_stack_00000004 + 0x2b); /* timer_1.NetworkStateChanged() */
  in_stack_00000004[0x2d] = 0;
  in_stack_00000004[0x2c] = iVar2; /* CountdownTimer timer_2 */
  (*pcVar3)(in_stack_00000004 + 0x2c,in_stack_00000004 + 0x2d);
  in_stack_00000004[0x2e] = -0x40800000 /* -1.0f */; /* timer_2.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x2c] + 4))(in_stack_00000004 + 0x2c,in_stack_00000004 + 0x2e); /* timer_2.NetworkStateChanged() */
  in_stack_00000004[0x33] = 0;
  in_stack_00000004[0x32] = iVar2; /* CountdownTimer timer_3 */
  (*pcVar3)(in_stack_00000004 + 0x32,in_stack_00000004 + 0x33);
  in_stack_00000004[0x34] = -0x40800000 /* -1.0f */; /* timer_3.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x32] + 4))(in_stack_00000004 + 0x32,in_stack_00000004 + 0x34); /* timer_3.NetworkStateChanged() */
  in_stack_00000004[0x36] = 0;
  in_stack_00000004[0x35] = iVar2; /* CountdownTimer timer_4 */
  (*pcVar3)(in_stack_00000004 + 0x35,in_stack_00000004 + 0x36);
  in_stack_00000004[0x37] = -0x40800000 /* -1.0f */; /* timer_4.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x35] + 4))(in_stack_00000004 + 0x35,in_stack_00000004 + 0x37); /* timer_4.NetworkStateChanged() */
  ...
  in_stack_00000004[0x44] = iVar2; /* CountdownTimer timer_5 */
  in_stack_00000004[0x45] = 0;
  (*pcVar3)(piVar6,in_stack_00000004 + 0x45);
  in_stack_00000004[0x46] = -0x40800000 /* -1.0f */; /* timer_5.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x44] + 4))(piVar6,in_stack_00000004 + 0x46); /* timer_5.NetworkStateChanged() */
  in_stack_00000004[0x48] = 0;
  in_stack_00000004[0x47] = iVar2; /* CountdownTimer timer_6 */
  (*pcVar3)(in_stack_00000004 + 0x47,in_stack_00000004 + 0x48);
  in_stack_00000004[0x49] = -0x40800000 /* -1.0f */; /* timer_6.m_timestamp = -1 (not running) */
  (**(code **)(in_stack_00000004[0x47] + 4))(in_stack_00000004 + 0x47,in_stack_00000004 + 0x49); /* timer_6.NetworkStateChanged() */
  ...
  *(int **)(unaff_EBX + 0x58d031 /* INSNextBotManager */ /* INSNextBotManager */ /* INSNextBotManager */) = in_stack_00000004;
...

{
  ...
  cVar2 = CINSRules::IsGameState(this_01,**(int **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */));
  if (cVar2 == '\0') {
    return;
  }
  fVar8 = (float10)CountdownTimer::Now();
  if (*(float *)(in_stack_00000004 + 0xa0) <= (float)fVar8 && /* timer_0.IsElapsed() */
      (float)fVar8 != *(float *)(in_stack_00000004 + 0xa0)) {
    UpdateGrenades(in_stack_00000004);
    UpdateGrenadeTargets(this_09);
    piVar11 = (int *)(*(int **)(unaff_EBX + 0x440921 /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */))[7];
    if (piVar11 == *(int **)(unaff_EBX + 0x440921 /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */)) {
    ...
    if (*(float *)(in_stack_00000004 + 0xa0) != (float)fVar8 + fVar9) {
      ...
      (**(code **)(*(int *)(in_stack_00000004 + 0x98) + 4))(in_stack_00000004 + 0x98,pCVar10); /* timer_0.NetworkStateChanged() */
      *(float *)(in_stack_00000004 + 0xa0) = (float)fVar8 + fVar9; /* timer_0.Start(...) */
    }
    if (*(float *)(in_stack_00000004 + 0x9c) != fVar9) {
      pCVar10 = in_stack_00000004 + 0x9c;
      (**(code **)(*(int *)(in_stack_00000004 + 0x98) + 4))(in_stack_00000004 + 0x98,pCVar10); /* timer_0.NetworkStateChanged() */
      *(float *)(in_stack_00000004 + 0x9c) = fVar9; /* timer_0.m_duration */
    }
  }
  fVar8 = (float10)CountdownTimer::Now();
  if ((*(float *)(in_stack_00000004 + 0x124) <= (float)fVar8 && /* timer_6.IsElapsed() */
       (float)fVar8 != *(float *)(in_stack_00000004 + 0x124)) &&
     ((*(int *)*(CINSRules **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) == 0 ||
      (cVar2 = CINSRules::IsSurvival(*(CINSRules **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */)), cVar2 == '\0')))) {
    local_4c = 0;
    local_48 = 0;
    local_44 = 0;
    ...
    if (0 < *(int *)(**(int **)(&DAT_00440205 + unaff_EBX) + 0x14)) {
      ...
      do {
        ...
        if (((pCVar3 != (CINSNextBotManager *)0x0) &&
          ...
          pCVar10 = *(CINSNextBotManager **)(unaff_EBX + 0x4400e9 /* &typeinfo for CBasePlayer */ /* &typeinfo for CBasePlayer */ /* &typeinfo for CBasePlayer */);
          local_2c = __dynamic_cast(pCVar3,pCVar10,*(undefined4 *)(unaff_EBX + 0x44038d /* &typeinfo for CINSNextBot */ /* &typeinfo for CINSNextBot */ /* &typeinfo for CINSNextBot */),0);
          if ((((local_2c != 0) &&
               ((CBasePlayer *)**(undefined4 **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) != (CBasePlayer *)0x0)) &&
              ((cVar2 = CINSRules::IsCoopBot((CBasePlayer *)**(undefined4 **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */))
               , pCVar10 = pCVar3, cVar2 != '\0' &&
               ((this_02 = extraout_ECX, *(int *)(local_2c + 0xb448) != 0 ||
                (iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x440195 /* &nb_blind */ /* &nb_blind */ /* &nb_blind */) + 0x40))
                                   (*(int **)(unaff_EBX + 0x440195 /* &nb_blind */ /* &nb_blind */ /* &nb_blind */)), this_02 = extraout_ECX_06,
    ...
    if (*(float *)(in_stack_00000004 + 0x124) != fVar9 + (float)fVar8) {
      (**(code **)(*(int *)(in_stack_00000004 + 0x11c) + 4)) /* timer_6.NetworkStateChanged() */
                (in_stack_00000004 + 0x11c,in_stack_00000004 + 0x124);
      *(float *)(in_stack_00000004 + 0x124) = fVar9 + (float)fVar8; /* timer_6.Start(...) */
    }
    if (*(float *)(in_stack_00000004 + 0x120) != fVar9) {
      (**(code **)(*(int *)(in_stack_00000004 + 0x11c) + 4)) /* timer_6.NetworkStateChanged() */
                (in_stack_00000004 + 0x11c,in_stack_00000004 + 0x120);
      *(float *)(in_stack_00000004 + 0x120) = fVar9; /* timer_6.m_duration */
    }
    local_40 = (CINSNextBotManager *)0x0;
    if (local_44 < 0) {
      local_3c = local_4c;
      ...
      if (local_4c != 0) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x4401dd /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x4401dd /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_4c);
        local_4c = 0;
      }
      local_48 = 0;
      local_3c = 0;
  ...
  fVar8 = (float10)CountdownTimer::Now();
  if (((*(float *)(in_stack_00000004 + 0xac) <= (float)fVar8 && /* timer_1.IsElapsed() */
        (float)fVar8 != *(float *)(in_stack_00000004 + 0xac)) &&
      (*(int *)*(CINSRules **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) != 0)) &&
     (piVar11 = *(int **)(unaff_EBX + 0x440681 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */), *piVar11 != 0)) {
    cVar2 = CINSRules::IsSurvival(*(CINSRules **)(unaff_EBX + 0x44025d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */));
    if (cVar2 != '\0') {
      iVar4 = *piVar11;
    ...
    fVar8 = (float10)CountdownTimer::Now();
    fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x1bd3f1 /* 0.25f */ /* 0.25f */ /* 0.25f */);
    if (*(float *)(in_stack_00000004 + 0xac) != fVar9) {
      (**(code **)(*(int *)(in_stack_00000004 + 0xa4) + 4)) /* timer_1.NetworkStateChanged() */
                (in_stack_00000004 + 0xa4,in_stack_00000004 + 0xac);
      *(float *)(in_stack_00000004 + 0xac) = fVar9; /* timer_1.Start(0.25f) */
    }
  ...
  if (*(float *)(in_stack_00000004 + 0xb8) <= (float)fVar8 && /* timer_2.IsElapsed() */
...
LAB_00766af0:
    fVar8 = (float10)CountdownTimer::Now();
    fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x1be0bd /* 0.5f */ /* 0.5f */ /* 0.5f */);
    this_07 = extraout_ECX_01;
    if (*(float *)(in_stack_00000004 + 0xb8) != fVar9) {
      (**(code **)(*(int *)(in_stack_00000004 + 0xb0) + 4)) /* timer_2.NetworkStateChanged() */
                (in_stack_00000004 + 0xb0,in_stack_00000004 + 0xb8);
      *(float *)(in_stack_00000004 + 0xb8) = fVar9; /* timer_2.Start(0.5f) */
...

{
  ...
  if ((piVar16 != (int *)0x0) && (param_2 != (CBaseCombatWeapon *)0x0)) {
    ...
    if ((iVar5 - 8U < 7) &&
       (local_188 = *(float *)(unaff_EBX + 0x222d03 /* CSWTCH.989 */ /* CSWTCH.989 */ /* CSWTCH.989 */ + (iVar5 - 8U) * 4), 0.0 < local_188)) {
      cVar3 = (**(code **)(*piVar16 + 0x760 /* CINSPlayer::ForceChangeTeam */))(piVar16);
      this_03 = extraout_ECX;
      if (cVar3 != '\0') {
        piVar16 = (int *)(*(int **)(unaff_EBX + 0x44281f /* &ins_bot_silenced_weapon_sound_reduction */ /* &ins_bot_silenced_weapon_sound_reduction */ /* &ins_bot_silenced_weapon_sound_reduction */))[7];
        if (piVar16 == *(int **)(unaff_EBX + 0x44281f /* &ins_bot_silenced_weapon_sound_reduction */ /* &ins_bot_silenced_weapon_sound_reduction */ /* &ins_bot_silenced_weapon_sound_reduction */)) {
...
LAB_007643d0:
          ...
          local_ac = 0;
          local_e8 = local_3c;
          local_dc = (*(float *)(unaff_EBX + 0x1e7a4f /* 16384.0f */ /* 16384.0f */ /* 16384.0f */) * fVar11 - local_40) + fVar14;
          local_e4 = local_38;
          local_d8 = (*(float *)(unaff_EBX + 0x1e7a4f /* 16384.0f */ /* 16384.0f */ /* 16384.0f */) * fVar12 - local_3c) + fVar1;
          local_d4 = (*(float *)(unaff_EBX + 0x1e7a4f /* 16384.0f */ /* 16384.0f */ /* 16384.0f */) * fVar13 - local_38) + fVar2;
          local_b4 = 0;
          local_b8 = 0;
          local_bc = 0;
          local_c4 = 0;
          ...
          pVVar15 = local_140;
          (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x442537 /* &enginetrace */ /* &enginetrace */ /* &enginetrace */) + 0x14))
                    ((int *)**(undefined4 **)(unaff_EBX + 0x442537 /* &enginetrace */ /* &enginetrace */ /* &enginetrace */),&local_ec,0x600400b);
          iVar8 = (**(code **)(**(int **)(unaff_EBX + 0x4427ff /* &r_visualizetraces */ /* &r_visualizetraces */ /* &r_visualizetraces */) + 0x40))
                            (*(int **)(unaff_EBX + 0x4427ff /* &r_visualizetraces */ /* &r_visualizetraces */ /* &r_visualizetraces */));
          if (iVar8 != 0) {
            iVar8 = (**(code **)(**(int **)(unaff_EBX + 0x4427ff /* &r_visualizetraces */ /* &r_visualizetraces */ /* &r_visualizetraces */) + 0x40))
                              (*(int **)(unaff_EBX + 0x4427ff /* &r_visualizetraces */ /* &r_visualizetraces */ /* &r_visualizetraces */));
            fVar17 = 0.5;
          ...
          if (cVar3 != '\0') {
            ...
            if ((cVar3 == '\0') || (*(float *)(unaff_EBX + 0x1c2b9f /* 250.0f */ /* 250.0f */ /* 250.0f */) <= fVar12)) goto LAB_0076472f;
LAB_00764390:
...
LAB_0076472f:
          if (fVar12 < *(float *)(unaff_EBX + 0x1548df /* 100.0f */ /* 100.0f */ /* 100.0f */)) goto LAB_00764390;
...
" */));
      ...
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x442637 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x442637 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_9c,piVar16,fVar17);
      return;
    }
  }
  local_90 = 0;
  if ((-1 < local_94) && (local_9c != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x442637 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x442637 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_9c);
  }
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  piVar1 = *(int **)(unaff_EBX + 0x443f1a /* &TheNavMesh */ /* &TheNavMesh */ /* &TheNavMesh */);
...
" */);
      ...
      if (*(char *)(in_stack_00000004 + 0x128) == '\0') {
        *(undefined1 *)(in_stack_00000004 + 0x128) = 1;
        Warning(unaff_EBX + 0x22452e /* "Forcing a load, This is bad and will most likely cause a hitch. This should n..." */ /* "Forcing a load, This is bad and will most likely cause a hitch. This should n..." */ /* "Forcing a load, This is bad and will most likely cause a hitch. This should n..." */);
        piVar1 = (int *)*piVar1;
...

{
  ...
  if (**(int **)(unaff_EBX + 0x443e57 /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) != 0) {
    if (iVar2 == 2) {
      ...
      if (*(float *)(param_1 + 0xd0) != (float)fVar3 + fVar1) {
        ...
        *(float *)(param_1 + 0xd0) = (float)fVar3 + fVar1; /* timer_3.Start(...) */
      }
      if (*(float *)(param_1 + 0xcc) != fVar1) {
        (**(code **)(*(int *)(param_1 + 200) + 4))(param_1 + 200,param_1 + 0xcc);
        *(float *)(param_1 + 0xcc) = fVar1; /* timer_3.m_duration */
      }
    }
    else if (iVar2 == 3) {
      fVar3 = (float10)GetCallForReinforcementCooldown();
      ...
      if (*(float *)(param_1 + 0xdc) != (float)fVar3 + fVar1) {
        (**(code **)(*(int *)(param_1 + 0xd4) + 4))(param_1 + 0xd4,param_1 + 0xdc); /* timer_4.NetworkStateChanged() */
        *(float *)(param_1 + 0xdc) = (float)fVar3 + fVar1; /* timer_4.Start(...) */
      }
      if (*(float *)(param_1 + 0xd8) != fVar1) {
        (**(code **)(*(int *)(param_1 + 0xd4) + 4))(param_1 + 0xd4,param_1 + 0xd8); /* timer_4.NetworkStateChanged() */
        *(float *)(param_1 + 0xd8) = fVar1; /* timer_4.m_duration */
        return;
      }
    }
  }
...

{
  ...
  this_00 = *(CINSRules **)(unaff_EBX + 0x443ff8 /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */);
  if (*(int *)this_00 != 0) {
    if (in_stack_00000008 == 2) {
      fVar2 = (float10)CountdownTimer::Now();
      if ((float)fVar2 < *(float *)(param_1 + 0xd0) || (float)fVar2 == *(float *)(param_1 + 0xd0)) { /* !timer_3.IsElapsed() */
        return uVar1 & 0xff;
      }
    }
    else if (in_stack_00000008 == 3) {
      fVar2 = (float10)CountdownTimer::Now();
      if ((float)fVar2 < *(float *)(param_1 + 0xdc) || (float)fVar2 == *(float *)(param_1 + 0xdc)) { /* !timer_4.IsElapsed() */
        return uVar1 & 0xff;
      }
    }
...
LAB_007649bc:
  ...
  if ((-1 < local_3c[2]) && (local_3c[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x441f1a /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x441f1a /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_3c[0]);
  }
  return;
}
...
LAB_00764b68:
  ...
  local_3c[3] = 0;
  if ((-1 < local_3c[2]) && (local_3c[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x441d6a /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x441d6a /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_3c[0]);
  }
  return;
}
...

{
  ...
  if (iVar4 != -1) {
    iVar9 = unaff_EBX + 0x1f1335 /* "userid" */ /* "userid" */ /* "userid" */;
    uVar11 = 0;
    ...
    if (iVar4 == 0x6e) {
      iVar4 = unaff_EBX + 0x1c6b30 /* "entityid" */ /* "entityid" */ /* "entityid" */;
      uVar11 = 0;
      iVar9 = (**(code **)(*in_stack_00000008 + 0x1c))();
      pbVar2 = *(byte **)(**(int **)(unaff_EBX + 0x444dcc /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x5c);
      if (((pbVar2 != (byte *)0x0) &&
      ...
      if (iVar4 == 0x79) {
        ...
        iVar4 = (**(code **)(*in_stack_00000008 + 0x1c))();
        uVar11 = *(undefined4 *)(**(int **)(unaff_EBX + 0x445248 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490 + iVar4 * 4);
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (param_2 < 0) {
    DevWarning((char *)(unaff_EBX + 0x221005 /* "Tried to call GenerateCPGrenadeTargets with an invalid control point index (%..." */ /* "Tried to call GenerateCPGrenadeTargets with an invalid control point index (%..." */ /* "Tried to call GenerateCPGrenadeTargets with an invalid control point index (%..." */));
    return;
  }
  local_1d = *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) != 0;
  if (((bool)local_1d) &&
     (iVar10 = *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8), iVar7 = ThreadGetCurrentId(),
     iVar10 == iVar7)) {
    piVar9 = *(int **)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
    if (*piVar9 != unaff_EBX + 0x221061 /* "CINSNextBotManager::GenerateCPGrenadeTargets" */ /* "CINSNextBotManager::GenerateCPGrenadeTargets" */ /* "CINSNextBotManager::GenerateCPGrenadeTargets" */) {
      piVar9 = (int *)CVProfNode::GetSubNode
                                ((char *)piVar9,unaff_EBX + 0x221061 /* "CINSNextBotManager::GenerateCPGrenadeTargets" */ /* "CINSNextBotManager::GenerateCPGrenadeTargets" */ /* "CINSNextBotManager::GenerateCPGrenadeTargets" */,(char *)0x0,
                                 unaff_EBX + 0x21ae6b /* "INSNextBot" */ /* "INSNextBot" */ /* "INSNextBot" */);
      *(int **)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = piVar9;
    }
    puVar2 = (uint *)(piVar9[0x1c] * 8 + *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x10a0) + 4);
    *puVar2 = *puVar2 | 4;
    CVProfNode::EnterScope();
    *(undefined1 *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) = 0;
  }
  ...
  if ((float)fVar12 < *(float *)(iVar11 + 0x14) || (float)fVar12 == *(float *)(iVar11 + 0x14)) {
    ...
    if ((*(char *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) != '\0') &&
       (*(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x100c) == 0)) {
      return;
    }
    iVar10 = *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x19b8);
    iVar7 = ThreadGetCurrentId(iVar7);
    if (iVar10 != iVar7) {
      return;
    }
    cVar6 = CVProfNode::ExitScope();
    iVar10 = *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014);
    if (cVar6 != '\0') {
      iVar10 = *(int *)(iVar10 + 100);
      *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = iVar10;
    }
  }
  else {
    fVar12 = (float10)CountdownTimer::Now();
    fVar13 = *(float *)(unaff_EBX + 0x1c0da5 /* 40.0f */ /* 40.0f */ /* 40.0f */) + (float)fVar12;
    ...
    iVar10 = **(int **)(unaff_EBX + 0x4408bd /* &TheNavMesh */ /* &TheNavMesh */ /* &TheNavMesh */);
    if ((uint)param_2 < 0x10) {
      ...
      if (piVar9 != (int *)0x0) {
              ...
              do {
                if (*(int *)(iVar10 + local_68 * 4) != 0) {
                  ...
                  while( true ) {
                    ...
                    puVar1 = puVar8 + 1;
                    puVar8[2] = 0;
                    puVar8[1] = unaff_EBX + 0x3c23bd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
        ...
        if (-1 < (int)local_44) {
          if (iVar10 != 0) {
            (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x440a7d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                      ((int *)**(undefined4 **)(unaff_EBX + 0x440a7d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),iVar10);
            local_4c[0] = 0;
    ...
    if (cVar6 == '\0') {
      ...
      iVar10 = *(int *)(*(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) + 100);
      *(int *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1014) = iVar10;
    }
  }
  *(bool *)(*(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1010) =
       iVar10 == *(int *)(unaff_EBX + 0x440b79 /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 0x1018;
  return;
}
...
LAB_00762dc8:
  fVar5 = *(float *)(unaff_EBX + 0x155e11 /* 1.0f */ /* 1.0f */ /* 1.0f */) / (float)local_24;
...

{
  ...
  fVar4 = 0.0;
  __i686_get_pc_thunk_bx();
  piVar1 = *(int **)(unaff_EBX + 0x443ef7 /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */);
  if (*piVar1 != 0) {
    cVar2 = CINSRules::IsSurvival(this);
    fVar4 = *(float *)(unaff_EBX + 0x1c17af /* 10.0f */ /* 10.0f */ /* 10.0f */);
    if (cVar2 != '\0') {
      fVar3 = (float10)RandomFloat(0x42200000 /* 40.0f */,0x42480000 /* 50.0f */);
      fVar4 = (*(float *)(unaff_EBX + 0x1c67c3 /* -10.0f */ /* -10.0f */ /* -10.0f */) -
              ((float)*(int *)(*piVar1 + 1000) + *(float *)(unaff_EBX + 0x15610f /* -1.0f */ /* -1.0f */ /* -1.0f */)) *
              *(float *)(unaff_EBX + 0x224567 /* CSWTCH.989+0x24 */ /* CSWTCH.989+0x24 */ /* CSWTCH.989+0x24 */)) + (float)fVar3;
    }
  }
...

{
  ...
  uStack_14 = 0x7621ad;
  __i686_get_pc_thunk_bx();
  piVar1 = *(int **)(unaff_EBX + 0x444b6f /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (((**(int **)(unaff_EBX + 0x4441de /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) != 0) &&
      (piVar1 = *(int **)(unaff_EBX + 0x444602 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */), *piVar1 != 0)) &&
  ...
  if (0 < iVar5) {
    ...
    do {
      if ((iVar4 != *(int *)(iVar3 + 0x490 + iVar7 * 4)) || (iVar8 = iVar9, 1 < iVar4 - 2U)) {
        pfVar1 = (float *)(unaff_EBX + 0x1c6ccf /* -0.01f */ /* -0.01f */ /* -0.01f */);
        iVar8 = iVar7;
        if (((fVar17 < *(float *)(unaff_EBX + 0x1c6ccf /* -0.01f */ /* -0.01f */ /* -0.01f */) ||
              fVar17 == *(float *)(unaff_EBX + 0x1c6ccf /* -0.01f */ /* -0.01f */ /* -0.01f */)) ||
            (((*(float *)(unaff_EBX + 0x1c2b33 /* 0.01f */ /* 0.01f */ /* 0.01f */) <= fVar17 ||
              (local_24 < *pfVar1 || local_24 == *pfVar1)) ||
             (*(float *)(unaff_EBX + 0x1c2b33 /* 0.01f */ /* 0.01f */ /* 0.01f */) <= local_24)))) ||
           ((local_28 < *pfVar1 || local_28 == *pfVar1 ||
            (*(float *)(unaff_EBX + 0x1c2b33 /* 0.01f */ /* 0.01f */ /* 0.01f */) <= local_28)))) {
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (((**(int **)(unaff_EBX + 0x44449a /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) == 0) ||
      (piVar1 = *(int **)(unaff_EBX + 0x4448be /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */), *piVar1 == 0)) ||
...

{
  ...
  __i686_get_pc_thunk_bx();
  local_70 = 2;
  piVar1 = *(int **)(unaff_EBX + 0x444ecb /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  if ((((*(int *)(*piVar1 + 0x37c) != 0) && (*(int *)(*piVar1 + 0x37c) < 0x11)) &&
...

{
  ...
  __i686_get_pc_thunk_bx();
  local_38 = 0;
  piVar4 = *(int **)(unaff_EBX + 0x441581 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  ...
  if (iVar5 != 0) {
    ...
    local_38 = -1;
    if (0 < iVar5) {
      local_44 = *(float *)(unaff_EBX + 0x1c3a11 /* FLT_MAX */ /* FLT_MAX */ /* FLT_MAX */);
      do {
        ...
        if (((((fVar12 < *(float *)(&LAB_001c3a31 + unaff_EBX) ||
              ...
              (fVar13 = *(float *)(unaff_EBX + 0x1bf895 /* 0.01f */ /* 0.01f */ /* 0.01f */), fVar13 <= fVar12)) ||
...

{
  ...
  *(undefined1 *)(in_stack_00000004 + 0x58) = 1;
  puVar2 = *(undefined4 **)(unaff_EBX + 0x43ffd5 /* &gameeventmanager */ /* &gameeventmanager */ /* &gameeventmanager */);
...
LAB_007641c0:
  local_3c[3] = 0;
  if ((-1 < local_3c[2]) && (local_3c[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x4427da /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x4427da /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_3c[0]);
  }
  return;
}
...

{
  ...
  if (in_stack_00000008 != 0) {
    ...
    *puVar4 = *(undefined4 *)(in_stack_00000008 + 0x208);
    ...
    iVar3 = **(int **)(unaff_EBX + 0x440cdc /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
...

{
  ...
  piVar1 = (int *)(*(int **)(unaff_EBX + 0x445691 /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */))[7];
  if (piVar1 == *(int **)(unaff_EBX + 0x445691 /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */ /* &ins_bot_grenade_think_time */)) {
  ...
  if (*(float *)(in_stack_00000004 + 0xa0) != (float)fVar5 + fVar4) {
    (**(code **)(*(int *)(in_stack_00000004 + 0x98) + 4)) /* timer_0.NetworkStateChanged() */
              (in_stack_00000004 + 0x98,in_stack_00000004 + 0xa0);
    *(float *)(in_stack_00000004 + 0xa0) = (float)fVar5 + fVar4; /* timer_0.Start(...) */
  }
  if (*(float *)(in_stack_00000004 + 0x9c) != fVar4) {
    (**(code **)(*(int *)(in_stack_00000004 + 0x98) + 4)) /* timer_0.NetworkStateChanged() */
              (in_stack_00000004 + 0x98,in_stack_00000004 + 0x9c);
    *(float *)(in_stack_00000004 + 0x9c) = fVar4; /* timer_0.m_duration */
  }
  if (*(int *)(in_stack_00000004 + 0x118) != -0x40800000 /* -1.0f */) {
    (**(code **)(*(int *)(in_stack_00000004 + 0x110) + 4)) /* timer_5.NetworkStateChanged() */
  ...
  piVar1 = *(int **)(unaff_EBX + 0x444f75 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */);
  *(undefined1 *)(in_stack_00000004 + 0x128) = 0;
  iVar3 = *(int *)(*piVar1 + 0x3c);
  if (iVar3 == 0) {
    iVar3 = unaff_EBX + 0x1f8150 /* rodata:0x73250900 */ /* rodata:0x73250900 */ /* rodata:0x73250900 */;
  }
...
LAB_00764e68:
  local_3c[3] = 0;
  if ((-1 < local_3c[2]) && (local_3c[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x441afa /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x441afa /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_3c[0]);
  }
  return;
}
  ...
  *(undefined4 *)(in_stack_00000004 + 0x68) = 0;
  if (*(int *)(in_stack_00000004 + 100) < 0) {
    ...
    if (*(int *)(in_stack_00000004 + 0x5c) != 0) {
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44523d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x44523d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),*(int *)(in_stack_00000004 + 0x5c));
  ...
  do {
    ...
    *(undefined4 *)(iVar5 + 0x14) = 0;
    if (*(int *)(iVar5 + 0x10) < 0) {
      ...
      if (*(int *)(iVar5 + 8) != 0) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44523d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x44523d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),*(int *)(iVar5 + 8));
...

{
  ...
  uStack_14 = 0x76305b;
  __i686_get_pc_thunk_bx();
  iVar7 = (**(code **)(**(int **)(unaff_EBX + 0x443a8d /* &ins_debug_grenade_targets */ /* &ins_debug_grenade_targets */ /* &ins_debug_grenade_targets */) + 0x40))(*(int **)(unaff_EBX + 0x443a8d /* &ins_debug_grenade_targets */ /* &ins_debug_grenade_targets */ /* &ins_debug_grenade_targets */));
  if (iVar7 != 0) {
    local_170 = 0;
    do {
        ...
        do {
          ...
          if (iVar8 != 0) {
            ...
            if ((float)fVar17 < *pfVar1 || (float)fVar17 == *pfVar1) {
              ...
              iVar8 = unaff_EBX + 0x1f6a20 /* rodata:0x73250900 */ /* rodata:0x73250900 */ /* rodata:0x73250900 */;
              iVar12 = unaff_EBX + 0x223aba /* "INCENDIARY" */ /* "INCENDIARY" */ /* "INCENDIARY" */;
              if ((*pbVar5 & 8) == 0) {
                iVar12 = iVar8;
              }
              iVar16 = unaff_EBX + 0x223ac5 /* "SMOKE" */ /* "SMOKE" */ /* "SMOKE" */;
              if ((*pbVar5 & 2) == 0) {
                iVar16 = iVar8;
              }
              iVar14 = unaff_EBX + 0x1c34c3 /* "FLASH" */ /* "FLASH" */ /* "FLASH" */;
              if ((*pbVar5 & 4) == 0) {
                iVar14 = iVar8;
              }
              if ((*pbVar5 & 1) != 0) {
                iVar8 = unaff_EBX + 0x223acb /* "FRAG" */ /* "FRAG" */ /* "FRAG" */;
              }
              iVar9 = unaff_EBX + 0x1bffa3 /* "YES" */ /* "YES" */ /* "YES" */;
              if (pbVar5[0x1d] == 0) {
                iVar9 = unaff_EBX + 0x1bffbc /* "NO" */ /* "NO" */ /* "NO" */;
              }
              iVar10 = unaff_EBX + 0x1bffa3 /* "YES" */ /* "YES" */ /* "YES" */;
              if (pbVar5[0x1c] == 0) {
                iVar10 = unaff_EBX + 0x1bffbc /* "NO" */ /* "NO" */ /* "NO" */;
              }
...
Types: %s %s %s %s" */),iVar10,iVar9,iVar8,iVar14,
  ...
  fVar17 = (float10)CountdownTimer::Now();
  if ((float)fVar17 < *(float *)(in_stack_00000004 + 0x118) || /* !timer_5.IsElapsed() */
      (float)fVar17 == *(float *)(in_stack_00000004 + 0x118)) {
    return;
  }
  fVar17 = (float10)CountdownTimer::Now();
  fVar18 = (float)fVar17 + *(float *)(unaff_EBX + 0x1c0a31 /* 0.25f */ /* 0.25f */ /* 0.25f */);
  if (*(float *)(in_stack_00000004 + 0x118) != fVar18) {
    (**(code **)(*(int *)(in_stack_00000004 + 0x110) + 4)) /* timer_5.NetworkStateChanged() */
              (in_stack_00000004 + 0x110,in_stack_00000004 + 0x118);
    *(float *)(in_stack_00000004 + 0x118) = fVar18; /* timer_5.Start(0.25f) */
  }
        ...
        if (0 < piVar2[3]) {
          ...
          do {
            ...
            if ((iVar7 != 0) && (*(char *)(iVar7 + 0x1d) == '\0')) {
              ...
              if (*(int *)(**(int **)(unaff_EBX + 0x443845 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x14) < 1) {
                bVar13 = true;
              }
              else {
                do {
...
LAB_007635ca:
                    ...
                    if (iVar7 == 3 - (uint)(local_16c == 0)) {
                      ...
                      bVar13 = *(float *)(unaff_EBX + 0x1d4dbd /* 32.0f */ /* 32.0f */ /* 32.0f */) +
                               *(float *)(*(int *)(*piVar2 + local_164 * 4) + 0x20) <=
                               SQRT(fVar19 * fVar19 + fVar21 * fVar21 + fVar20 * fVar20);
                    }
                  }
                  iVar15 = iVar15 + 1;
                } while ((iVar15 <= *(int *)(**(int **)(unaff_EBX + 0x443845 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x14)) && (bVar13));
                iVar7 = *(int *)(*piVar2 + local_164 * 4);
              }
  ...
  if (0 < iVar7) {
    ...
    while( true ) {
      if ((((iVar8 < iVar7) &&
           ...
           pvVar2 != (void *)0x0)) &&
          (fVar1 = *(float *)(**(int **)(unaff_EBX + 0x443a65 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc),
  ...
  if (0 < iVar7) {
    ...
    do {
      while( true ) {
        ...
        uVar3 = *puVar4;
        if (((uVar3 != 0xffffffff) &&
            (iVar6 = (uVar3 & 0xffff) * 0x18 + **(int **)(unaff_EBX + 0x44399d /* &g_pEntityList */ /* &g_pEntityList */ /* &g_pEntityList */),
...

{
  ...
  *(int *)in_stack_00000004 = unaff_EBX + 0x437e3d /* vtable for CINSNextBotManager+0x8 */ /* vtable for CINSNextBotManager+0x8 */ /* vtable for CINSNextBotManager+0x8 */;
  pCVar5 = in_stack_00000004 + 0xfc;
  *(int *)(in_stack_00000004 + 0x50) = unaff_EBX + 0x437e89 /* vtable for CINSNextBotManager+0x54 */ /* vtable for CINSNextBotManager+0x54 */ /* vtable for CINSNextBotManager+0x54 */;
  *(undefined4 *)(unaff_EBX + 0x58cad1 /* INSNextBotManager */ /* INSNextBotManager */ /* INSNextBotManager */) = 0;
  **(undefined4 **)(unaff_EBX + 0x441401 /* &NextBotManager::sInstance */ /* &NextBotManager::sInstance */ /* &NextBotManager::sInstance */) = 0;
  this_00 = extraout_ECX;
  do {
    *(undefined4 *)(pCVar4 + -8) = 0;
    ...
    if (-1 < *(int *)(pCVar4 + -0xc)) {
      if (iVar2 != 0) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),iVar2);
        *(int *)pCVar5 = 0;
  ...
  *(undefined4 *)(in_stack_00000004 + 0x90) = 0;
  if (*(int *)(in_stack_00000004 + 0x8c) < 0) {
    ...
    if (*(int *)(in_stack_00000004 + 0x84) != 0) {
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),*(int *)(in_stack_00000004 + 0x84));
  ...
  *(undefined4 *)(in_stack_00000004 + 0x7c) = 0;
  if (*(int *)(in_stack_00000004 + 0x78) < 0) {
    ...
    if (*(int *)(in_stack_00000004 + 0x70) != 0) {
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),*(int *)(in_stack_00000004 + 0x70));
  ...
  *(undefined4 *)(in_stack_00000004 + 0x68) = 0;
  if (*(int *)(in_stack_00000004 + 100) < 0) {
    ...
    if (*(int *)(in_stack_00000004 + 0x5c) != 0) {
      (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                ((int *)**(undefined4 **)(unaff_EBX + 0x44142d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),*(int *)(in_stack_00000004 + 0x5c));
      *(undefined4 *)(in_stack_00000004 + 0x5c) = 0;
    }
    uVar3 = 0;
    *(undefined4 *)(in_stack_00000004 + 0x60) = 0;
  ...
  *(int *)(in_stack_00000004 + 0x50) = unaff_EBX + 0x3bd2e5 /* vtable for CGameEventListener+0x8 */ /* vtable for CGameEventListener+0x8 */ /* vtable for CGameEventListener+0x8 */;
  *(undefined4 *)(in_stack_00000004 + 0x54) = 0xd;
  this_01 = extraout_ECX_02;
  if (in_stack_00000004[0x58] != (CUtlMemory<CINSNavArea*,int>)0x0) {
    piVar1 = (int *)**(int **)(unaff_EBX + 0x441a85 /* &gameeventmanager */ /* &gameeventmanager */ /* &gameeventmanager */);
    if (piVar1 != (int *)0x0) {
  ...
  *(int *)(in_stack_00000004 + 0x50) = unaff_EBX + 0x3bd2fd /* vtable for IGameEventListener2+0x8 */ /* vtable for IGameEventListener2+0x8 */ /* vtable for IGameEventListener2+0x8 */;
