...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x48f35a /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x48f4fa /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */;
  in_stack_00000004[0xe] = unaff_EBX + 0x422b0a /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
...

{
  ...
  __i686_get_pc_thunk_bx();
  if (**(int **)(unaff_EBX + 0x4a1b0a /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */) == 0) {
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x27b08e /* "INSRules failed to initialize." */ /* "INSRules failed to initialize." */ /* "INSRules failed to initialize." */;
    return param_1;
  }
  if ((*(int *)(in_stack_0000000c + 0xb338) == -1) ||
    ...
    if ((piVar3 == (int *)0x0) || (iVar2 = (**(code **)(*piVar3 + 0x10))(piVar3), iVar2 == 0)) {
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x27af9a /* " No Active Combat Target" */ /* " No Active Combat Target" */ /* " No Active Combat Target" */;
      return param_1;
    }
  }
  if ((*(int *)(in_stack_0000000c + 0xb338) == -1) ||
    ...
    *(undefined4 *)(param_2 + 0x48) = *puVar4;
    ...
    if (((piVar3 != (int *)0x0) && (iVar2 = (**(code **)(*piVar3 + 0x10))(piVar3), iVar2 != 0)) &&
      ...
      if (iVar2 != 0) {
        ...
        *(undefined4 *)param_1 = 3 /* Done */;
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x27b0d2 /* "Unable to determine active weapon." */ /* "Unable to determine active weapon." */ /* "Unable to determine active weapon." */;
        return param_1;
      }
    }
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x27b0ae /* "Unable to determine initial threat." */ /* "Unable to determine initial threat." */ /* "Unable to determine initial threat." */;
    return param_1;
  }
LAB_00704f14:
  *(undefined4 *)param_1 = 3 /* Done */;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x27afb3 /* "Invalid Threat" */ /* "Invalid Threat" */ /* "Invalid Threat" */;
  return param_1;
}
...

{
  ...
  if (in_stack_00000008 == (CKnownEntity *)0x0) {
    ...
    if (piVar1 == (int *)0x0) {
      ...
      iVar2 = (**(code **)(**(int **)(unaff_EBX + 0x4a1b78 /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */) + 0x40))
                        (*(int **)(unaff_EBX + 0x4a1b78 /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */));
      if (iVar2 != 0) {
        pvVar3 = ::operator_new(0x48c0);
        CINSBotAttackMelee::CINSBotAttackMelee(this_02);
        return pvVar3;
      }
      iVar2 = (**(code **)(**(int **)(unaff_EBX + 0x4a22d8 /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */) + 0x40))
                        (*(int **)(unaff_EBX + 0x4a22d8 /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */));
      if (iVar2 == 0) {
        ...
        if (uVar4 < 0xf) {
          ...
          pvVar3 = (void *)(*(code *)(*(int *)(unaff_EBX + 0x27b448 /* rodata:0xFFB5D900 */ /* rodata:0xFFB5D900 */ /* rodata:0xFFB5D900 */ + uVar4 * 4) +
                                     unaff_EBX + 0x4a27a4 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */))();
          return pvVar3;
        }
...

{
  ...
  if (*(float *)((int)param_2 + 0x40) <= (float)fVar10 && /* timer_0.IsElapsed() */
    ...
    if ((cVar2 != '\0') &&
       ...
       *(float *)(unaff_EBX + 0x21f70e /* 5.0f */ /* 5.0f */ /* 5.0f */) <= (float)fVar10 &&
       (float)fVar10 != *(float *)(unaff_EBX + 0x21f70e /* 5.0f */ /* 5.0f */ /* 5.0f */))) {
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x27ad52 /* "Idle in attack" */ /* "Idle in attack" */ /* "Idle in attack" */;
      return param_1;
    }
    ...
    if (iVar4 == 1) {
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x27ad61 /* "Retreating to cover" */ /* "Retreating to cover" */ /* "Retreating to cover" */;
      return param_1;
    }
    if ((*(int *)(in_stack_0000000c + 0xb338) == -1) ||
...
LAB_00705121:
      ...
      if ((cVar2 != '\0') && (cVar2 = (**(code **)(*piVar3 + 0x118))(piVar3), cVar2 != '\0')) {
        ...
        if (piVar5 == (int *)0x0) {
          ...
          iVar4 = 0;
          if (piVar3[8] != 0) {
            iVar4 = piVar3[8] - *(int *)(**(int **)(unaff_EBX + 0x4a1842 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
          }
        ...
        if ((cVar2 == '\0') &&
           ...
           *(float *)(unaff_EBX + 0x21f6fa /* 0.5f */ /* 0.5f */ /* 0.5f */) <= (float)fVar10 &&
           (float)fVar10 != *(float *)(unaff_EBX + 0x21f6fa /* 0.5f */ /* 0.5f */ /* 0.5f */))) {
          *(undefined4 *)param_1 = 3 /* Done */;
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x27ad75 /* "Lost sight of my threat" */ /* "Lost sight of my threat" */ /* "Lost sight of my threat" */;
          return param_1;
        }
        ...
        local_2c = 0;
        if ((uVar9 != 0xffffffff) &&
           (iVar8 = **(int **)(unaff_EBX + 0x4a177a /* &g_pEntityList */ /* &g_pEntityList */ /* &g_pEntityList */) + (uVar9 & 0xffff) * 0x18,
        ...
        if (iVar4 == 0) {
          *(undefined4 *)param_1 = 3 /* Done */;
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x27ae86 /* "I should not attack this threat" */ /* "I should not attack this threat" */ /* "I should not attack this threat" */;
          return param_1;
        }
        fVar10 = (float10)CINSNextBot::GetActiveWeaponAmmoRatio();
        if ((float)fVar10 < *(float *)(unaff_EBX + 0x1b3abe /* 0.1f */ /* 0.1f */ /* 0.1f */)) {
          *(undefined4 *)param_1 = 3 /* Done */;
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x27ad8d /* "Exiting attack to Reload" */ /* "Exiting attack to Reload" */ /* "Exiting attack to Reload" */;
          return param_1;
        }
        cVar2 = (**(code **)(*piVar5 + 0x38 /* INextBotEventResponder::OnAnimationEvent */))(piVar5);
        if (cVar2 == '\0') {
...
LAB_007053fc:
          ...
          uVar12 = 0x3e99999a /* 0.3f */;
          uVar11 = 4;
          (**(code **)(*piVar3 + 0xd8 /* PlayerBody::AimHeadTowards */))(piVar3,uVar7,4,0x3e99999a /* 0.3f */,0,unaff_EBX + 0x27ada6 /* "Aiming at active enemy" */ /* "Aiming at active enemy" */ /* "Aiming at active enemy" */);
           ...
           (uVar9 = CINSPlayer::GetPlayerFlags((CINSPlayer *)in_stack_0000000c), (uVar9 & 1) == 0))
        {
          ...
          if (cVar2 == '\0') {
            ...
            iVar4 = unaff_EBX + 0x254a1d /* rodata:0x73250900 */ /* rodata:0x73250900 */ /* rodata:0x73250900 */;
    ...
    *(undefined4 *)param_1 = 3 /* Done */;
    *(undefined4 *)(param_1 + 4) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x27ad43 /* "Invalid Threat" */ /* "Invalid Threat" */ /* "Invalid Threat" */;
  }
  else {
LAB_0070508c:
    *(undefined4 *)param_1 = 0 /* Continue */;
...

{
  ...
  return extraout_ECX + 0x22b4c9 /* "Attacking" */ /* "Attacking" */ /* "Attacking" */;
}
...

{
  ...
  if (piVar1 != (int *)0x0) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      if (cVar2 == '\0') {
        cVar6 = '\x02';
        iVar3 = (**(code **)(**(int **)(unaff_EBX + 0x4a1dfb /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */) + 0x40))
                          (*(int **)(unaff_EBX + 0x4a1dfb /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */));
        if (iVar3 == 0) {
          pfVar5 = (float *)(**(code **)(*piVar4 + 0x14))(piVar4);
          if ((*(byte *)((int)piVar1 + 0xd1) & 8) != 0) {
            CBaseEntity::CalcAbsolutePosition(this);
          }
          cVar6 = (*(float *)(unaff_EBX + 0x27b7ff /* 32400.0f */ /* 32400.0f */ /* 32400.0f */) <=
...

{
  ...
  if (iVar4 != 0) {
    ...
    if (cVar3 != '\0') {
      cVar7 = '\0';
      iVar5 = (**(code **)(**(int **)(unaff_EBX + 0x4a1ceb /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */) + 0x40))
                        (*(int **)(unaff_EBX + 0x4a1ceb /* &ins_bot_knives_only */ /* &ins_bot_knives_only */ /* &ins_bot_knives_only */));
      if (iVar5 == 0) {
        ...
        if (((*(float *)(unaff_EBX + 0x21fef7 /* 0.5f */ /* 0.5f */ /* 0.5f */) <= (float)fVar8) || (iVar5 < 2)) ||
...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x4a23bd /* &vtable for CINSBotStuck */ /* &vtable for CINSBotStuck */ /* &vtable for CINSBotStuck */);
  piVar2[0xf] = 0;
  piVar2[1] = iVar1 + 0x198;
  *piVar2 = iVar1 + 8;
  piVar2[0xe] = unaff_EBX + 0x423bbd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x48f243 /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x48f3e3 /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x4a19b3 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48f1fa /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */ /* vtable for CINSBotAttack+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x48f39a /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */ /* vtable for CINSBotAttack+0x1a8 */;
