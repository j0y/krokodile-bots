  ...
  if (cVar2 == '\0') {
    ...
    if (iVar5 != 0) {
      ...
      if (iVar5 == 1) {
        ...
        *(int *)(param_1 + 8) = unaff_EBX + 0x24873c /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
        return param_1;
      }
    }
      ...
      if (cVar2 == '\0') {
        ...
        if (iVar5 - 2U < 2) {
          ...
          pCVar1 = *(CINSBotActionFirefight **)
                    (**(int **)(unaff_EBX + 0x46ee9b /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490 + (int)this_00 * 4);
          if (this_07 == pCVar1) {
            ...
            *(undefined **)(param_1 + 8) = &UNK_0024a46b + unaff_EBX;
            ...
            CINSNavMesh::GetRandomControlPointArea(**(int **)(unaff_EBX + 0x46e837 /* &TheNavMesh */ /* &TheNavMesh */ /* &TheNavMesh */));
            ...
            *(undefined4 *)param_1 = 2 /* SuspendFor */;
            *(int *)(param_1 + 8) = unaff_EBX + 0x24a45a /* "Defending our CP" */ /* "Defending our CP" */ /* "Defending our CP" */;
          }
          else {
            pvVar3 = ::operator_new(0x88);
            CINSBotCaptureCP::CINSBotCaptureCP(this_00,(int)pvVar3,SUB41(this_00,0));
          ...
          *(undefined4 *)(param_1 + 4) = 0;
          *(int *)(param_1 + 8) = unaff_EBX + 0x248755 /* "Bot is not on a playteam" */ /* "Bot is not on a playteam" */ /* "Bot is not on a playteam" */;
        }
      }
      else {
    ...
    *(void **)(param_1 + 4) = pvVar3;
    *(undefined4 *)param_1 = 2 /* SuspendFor */;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24a3d7 /* "Escorting " */ /* "Escorting " */ /* "Escorting " */;
  }
  return param_1;
}
...

{
  ...
  return extraout_ECX + 0x1f7ccc /* "Firefight" */ /* "Firefight" */ /* "Firefight" */;
}
...

{
  ...
  iVar1 = **(int **)(unaff_EBX + 0x46efa3 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  if (*(int *)(iVar1 + 0x494) - 2U < 2) {
    ...
    if ((in_stack_00000008 != *(int *)(iVar1 + 0x494)) &&
       ...
       (float)fVar2 < *(float *)(unaff_EBX + 0x1ec9df /* 0.5f */ /* 0.5f */ /* 0.5f */) ||
       (float)fVar2 == *(float *)(unaff_EBX + 0x1ec9df /* 0.5f */ /* 0.5f */ /* 0.5f */))) {
      return 1;
    }
  }
    ...
    fVar2 = (float10)RandomFloat(0,0x3f800000 /* 1.0f */);
    if (*(double *)(unaff_EBX + 0x1eca07 /* rodata:0x9999999A */ /* rodata:0x9999999A */ /* rodata:0x9999999A */) <= (double)(float)fVar2) {
      return 1;
    }
  }
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x461243 /* vtable for CINSBotActionFirefight+0x8 */ /* vtable for CINSBotActionFirefight+0x8 */ /* vtable for CINSBotActionFirefight+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x4613d7 /* vtable for CINSBotActionFirefight+0x19c */ /* vtable for CINSBotActionFirefight+0x19c */ /* vtable for CINSBotActionFirefight+0x19c */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46ef13 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x4611fa /* vtable for CINSBotActionFirefight+0x8 */ /* vtable for CINSBotActionFirefight+0x8 */ /* vtable for CINSBotActionFirefight+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x46138e /* vtable for CINSBotActionFirefight+0x19c */ /* vtable for CINSBotActionFirefight+0x19c */ /* vtable for CINSBotActionFirefight+0x19c */;
