...

{
  ...
  *in_stack_00000004 = extraout_ECX + 0x461203 /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  in_stack_00000004[1] = extraout_ECX + 0x461397 /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */;
  return;
}
...

{
  ...
  if (iVar3 != 0) {
    piVar2 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x97c /* CINSNextBot::GetIntentionInterface */))(in_stack_0000000c);
    iVar3 = (**(code **)(*piVar2 + 0xd4 /* IIntention::ShouldAttack */))(piVar2,in_stack_0000000c + 0x2060,iVar3);
    ...
    if (iVar3 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x247eb2 /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
      return param_1;
    }
  }
  ...
  if (cVar1 == '\0') {
    ...
    if (cVar1 != '\0') {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x249a43 /* "I have an investigation!" */ /* "I have an investigation!" */ /* "I have an investigation!" */;
      *(undefined4 *)((int)param_2 + 0x20) = 0;
      *(undefined4 *)((int)param_2 + 0x24) = 0;
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
    ...
    *(bool *)((int)param_2 + 0x38) = (float)fVar6 < *(float *)(unaff_EBX + 0x1eb381 /* 0.25f */ /* 0.25f */ /* 0.25f */);
    ...
    if (this_00 != (CFmtStrN<256,false> *)0xffffffff) {
      ...
      if (*(int *)(local_24c + 0x6f0 + (int)this_00 * 4) == 0) {
        ...
        if ((cVar1 != '\0') && (*(int *)(*(int *)(unaff_EBX + 0x46e901 /* &CINSBotDestroyCache::m_nTotalDestroyers */ /* &CINSBotDestroyCache::m_nTotalDestroyers */ /* &CINSBotDestroyCache::m_nTotalDestroyers */) + (int)this_00 * 4) < 1)) {
          CFmtStrN<256,false>::CFmtStrN(this_00,local_234,unaff_EBX + 0x249c41 /* "Destroying %i" */ /* "Destroying %i" */ /* "Destroying %i" */,this_00);
      ...
      CFmtStrN<256,false>::CFmtStrN(this_00,local_128,unaff_EBX + 0x249c4f /* "Capturing %i" */ /* "Capturing %i" */ /* "Capturing %i" */,this_00);
      pvVar5 = ::operator_new(0x88);
...

{
  ...
  __i686_get_pc_thunk_cx();
  return extraout_ECX + 0x1f75e0 /* "Flashpoint" */ /* "Flashpoint" */ /* "Flashpoint" */;
}
...

{
  ...
  piVar1 = *(int **)(unaff_EBX + 0x46e80b /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  iVar5 = (iVar2 == 2) + 2;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x460b63 /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x460cf7 /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46e653 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x460b1a /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */ /* vtable for CINSBotActionFlashpoint+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x460cae /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */ /* vtable for CINSBotActionFlashpoint+0x19c */;
