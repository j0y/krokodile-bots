...

{
  ...
  *in_stack_00000004 = extraout_ECX + 0x45ebd3 /* vtable for CINSBotActionSkirmish+0x8 */ /* vtable for CINSBotActionSkirmish+0x8 */ /* vtable for CINSBotActionSkirmish+0x8 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  in_stack_00000004[1] = extraout_ECX + 0x45ed67 /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */;
  ...
  if (cVar1 == '\0') {
    ...
    if (iVar4 != 0) {
      ...
      if (iVar4 == 1) {
        ...
        *(int *)(param_1 + 8) = unaff_EBX + 0x244ca2 /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
    ...
    *(bool *)((int)param_2 + 0x38) = (float)fVar7 < *(float *)(unaff_EBX + 0x1e8171 /* 0.25f */ /* 0.25f */ /* 0.25f */);
    ...
    if (this_00 == (CFmtStrN<256,false> *)0xffffffff) {
      ...
      *(undefined4 *)(param_1 + 8) = 0;
      ...
      iVar6 = **(int **)(unaff_EBX + 0x46b401 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
      this_08 = *(CFmtStrN<256,false> **)(iVar6 + 0x450 + (int)this_00 * 4);
      if ((*(char *)((int)param_2 + 0x38) != '\0') ||
         ((CFmtStrN<256,false> *)((iVar4 == 2) + 2) == this_08)) {
        iVar4 = CINSNavMesh::GetRandomControlPointSurroundingArea(**(int **)(unaff_EBX + 0x46ad9d /* &TheNavMesh */ /* &TheNavMesh */ /* &TheNavMesh */));
        if (iVar4 != 0) {
          CNavArea::GetRandomPoint();
          CINSNextBot::AddInvestigation(in_stack_0000000c,local_34,local_30,local_2c,0);
        }
        this_08 = *(CFmtStrN<256,false> **)(unaff_EBX + 0x46b401 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
        iVar6 = *(int *)this_08;
      }
      if (*(int *)(iVar6 + 0x6f0 + (int)this_00 * 4) == 0) {
        cVar1 = CINSBotDestroyCache::CanIDestroyCache((CINSNextBot *)in_stack_0000000c);
        if ((cVar1 != '\0') && (*(int *)(*(int *)(unaff_EBX + 0x46b6f1 /* &CINSBotDestroyCache::m_nTotalDestroyers */ /* &CINSBotDestroyCache::m_nTotalDestroyers */ /* &CINSBotDestroyCache::m_nTotalDestroyers */) + (int)this_00 * 4) < 1)) {
          CFmtStrN<256,false>::CFmtStrN(this_00,local_24c,unaff_EBX + 0x246a31 /* "Destroying %i" */ /* "Destroying %i" */ /* "Destroying %i" */,this_00);
      ...
      CFmtStrN<256,false>::CFmtStrN(this_08,local_140,unaff_EBX + 0x246a3f /* "Capturing %i" */ /* "Capturing %i" */ /* "Capturing %i" */,this_00);
      pvVar2 = ::operator_new(0x88);
    ...
    *(void **)(param_1 + 4) = pvVar2;
    *(undefined4 *)param_1 = 2 /* SuspendFor */;
    *(int *)(param_1 + 8) = unaff_EBX + 0x24693d /* "Escorting " */ /* "Escorting " */ /* "Escorting " */;
  }
  return param_1;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  return extraout_ECX + 0x1f6ae6 /* "Skirmish" */ /* "Skirmish" */ /* "Skirmish" */;
}
...

{
  ...
  if (param_1[0x38] != (CINSNextBot)0x0) {
    if (iVar4 == 2) {
      piVar9 = (int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x450);
      piVar10 = (int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490);
      iVar1 = *piVar10;
      iVar8 = *piVar9;
      iVar7 = 0;
      iVar5 = -1;
      ...
      iVar1 = **(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  ...
  if (iVar4 == 2) {
    iVar7 = 0;
    do {
      if ((*(int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490 + iVar7 * 4) != 2) ||
         (iVar6 == *(int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x450 + iVar7 * 4)))
      goto LAB_0073b7b6;
      iVar7 = iVar7 + 1;
    } while (iVar7 != 5);
    iVar7 = -1;
    ...
    iVar7 = 4;
    do {
      if ((iVar4 != *(int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490 + iVar7 * 4)) ||
         (iVar6 == *(int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x450 + iVar7 * 4)))
      goto LAB_0073b7b6;
      iVar7 = iVar7 + -1;
    } while (iVar7 != -1);
...
LAB_0073b7b6:
  ...
  iVar6 = iVar7;
  if (((double)(float)fVar11 < *(double *)(unaff_EBX + 0x245c65 /* rodata:0x66666666 */ /* rodata:0x66666666 */ /* rodata:0x66666666 */)) && (iVar6 = -1, iVar7 != -1)) {
    ...
    if (iVar4 == *(int *)(**(int **)(unaff_EBX + 0x46b661 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */) + 0x490 + iVar6 * 4)) {
      iVar6 = iVar7;
    }
  }
  return iVar6;
...

{
  ...
  *in_stack_00000004 = &UNK_0045e3e3 + extraout_ECX;
  in_stack_00000004[1] = extraout_ECX + 0x45e577 /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46b353 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45e39a /* vtable for CINSBotActionSkirmish+0x8 */ /* vtable for CINSBotActionSkirmish+0x8 */ /* vtable for CINSBotActionSkirmish+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x45e52e /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */ /* vtable for CINSBotActionSkirmish+0x19c */;
