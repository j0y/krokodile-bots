...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x466dc5 /* &vtable for CINSBotInvestigationMonitor */ /* &vtable for CINSBotInvestigationMonitor */ /* &vtable for CINSBotInvestigationMonitor */);
  piVar2[0xf] = 0;
  piVar2[1] = iVar1 + 0x198;
  piVar2[0xe] = (int)(&UNK_003e846d + unaff_EBX);
  *piVar2 = iVar1 + 8;
  (*(code *)(unaff_EBX + -0x50f5db /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar2 + 0xe,piVar2 + 0xf);
  piVar2[0x10] = -0x40800000 /* -1.0f */;
  (**(code **)(piVar2[0xe] + 4))(piVar2 + 0xe,piVar2 + 0x10);
  piVar2[0x15] = 0;
  piVar2[0x14] = (int)(&UNK_003e846d + unaff_EBX);
  (*(code *)(unaff_EBX + -0x50f5db /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar2 + 0x14,piVar2 + 0x15);
...

{
  ...
  if (*(float *)((int)param_2 + 0x40) <= (float)fVar14 &&
    ...
    if (bVar13) {
      ...
      if (*(float *)(unaff_EBX + 0x1f1f71 /* 240.0f */ /* 240.0f */ /* 240.0f */) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x1f1f71 /* 240.0f */ /* 240.0f */ /* 240.0f */)) {
...
LAB_0074218d:
      ...
      if (*(float *)(unaff_EBX + 0x23fad9 /* 1200.0f */ /* 1200.0f */ /* 1200.0f */) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x23fad9 /* 1200.0f */ /* 1200.0f */ /* 1200.0f */)) {
        pVVar10 = local_28;
        cVar3 = CINSBotFireRPG::HasRPGTarget((CINSNextBot *)in_stack_0000000c,pVVar10);
        if (cVar3 != '\0') {
          piVar6 = (int *)(*(int **)(unaff_EBX + 0x464ce5 /* &bot_rpg_spawn_attackdelay */ /* &bot_rpg_spawn_attackdelay */ /* &bot_rpg_spawn_attackdelay */))[7];
          if (piVar6 == *(int **)(unaff_EBX + 0x464ce5 /* &bot_rpg_spawn_attackdelay */ /* &bot_rpg_spawn_attackdelay */ /* &bot_rpg_spawn_attackdelay */)) {
          ...
          piVar6 = *(int **)(unaff_EBX + 0x464d2d /* &g_pGameRules */ /* &g_pGameRules */ /* &g_pGameRules */);
          pVVar10 = (Vector *)CINSRules::GetHumanTeam(this_04);
          fVar14 = (float10)CINSRules::GetLastDeploymentTime(this_05,*piVar6);
          pfVar1 = (float *)(**(int **)(unaff_EBX + 0x464cd5 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
          if ((float)fVar14 + local_50 < *pfVar1 || (float)fVar14 + local_50 == *pfVar1) {
            ...
            *(int *)(param_1 + 8) = unaff_EBX + 0x240dda /* "Firing an RPG!" */ /* "Firing an RPG!" */ /* "Firing an RPG!" */;
            return param_1;
          }
        }
      }
...
LAB_00741c53:
      ...
      if (cVar3 != '\0') {
        ...
        *(undefined4 *)param_1 = 2 /* SuspendFor */;
        *(void **)(param_1 + 4) = pvVar11;
        *(int *)(param_1 + 8) = unaff_EBX + 0x240dc6 /* "Throwing a grenade!" */ /* "Throwing a grenade!" */ /* "Throwing a grenade!" */;
        return param_1;
      }
    ...
    if (cVar3 == '\0') {
      fVar14 = (float10)CountdownTimer::Now();
      this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x1e2b95 /* 4.0f */ /* 4.0f */ /* 4.0f */));
      ...
      fVar14 = (float10)CountdownTimer::Now();
      this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x176f49 /* 1.0f */ /* 1.0f */ /* 1.0f */));
      if (*(CINSNextBot **)((int)param_2 + 0x40) != this_08) {
        (**(code **)(*(int *)((int)param_2 + 0x38) + 4))(iVar9,(int)param_2 + 0x40);
        *(CINSNextBot **)((int)param_2 + 0x40) = this_08;
...
LAB_00741d1f:
    *(undefined4 *)((int)param_2 + 0x94) = 0xffffffff;
    ...
    if (*(float *)((int)param_2 + 0x7c) <= (float)fVar14 &&
      ...
      if (cVar3 != '\0') {
        ...
        fVar14 = (float10)CountdownTimer::Now();
        this_08 = (CINSNextBot *)((float)fVar14 + *(float *)(unaff_EBX + 0x1e25e5 /* 10.0f */ /* 10.0f */ /* 10.0f */));
  ...
  if (((!bVar13) && (cVar3 = CINSNextBot::ShouldReload(this_08), cVar3 != '\0')) &&
    ...
    *(undefined1 *)((int)piVar4 + 0x31) = 0;
    piVar4[0xb] = 0;
    piVar4[0xd] = 0;
    iVar12 = *(int *)(unaff_EBX + 0x464e2d /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
    piVar4[0xf] = 0;
    piVar4[1] = iVar12 + 0x198;
    iVar9 = unaff_EBX + 0x3e65ed /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
    *piVar4 = iVar12 + 8;
    pcVar2 = (code *)(unaff_EBX + -0x51145b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
    piVar4[0xe] = iVar9;
    ...
    *(int *)(param_1 + 8) = unaff_EBX + 0x240de9 /* "Opportunistic reload in-place" */ /* "Opportunistic reload in-place" */ /* "Opportunistic reload in-place" */;
    return param_1;
  }
  fVar14 = (float10)CountdownTimer::Now();
  if (*(float *)((int)param_2 + 0x90) <= (float)fVar14 &&
    ...
    fVar14 = (float10)CountdownTimer::Now();
    fVar15 = (float)fVar14 + *(float *)(unaff_EBX + 0x1e2b8d /* 0.5f */ /* 0.5f */ /* 0.5f */);
...

{
  ...
  return extraout_ECX + 0x23fcbc /* "Tactics" */ /* "Tactics" */ /* "Tactics" */;
}
  ...
  if (((uVar4 != 0xffffffff) && (*(uint *)(local_38 + (uVar4 & 0xffff) * 0x18 + 8) == uVar4 >> 0x10)
    ...
    if (iVar5 != iVar6) {
      if ((*(byte *)(in_stack_00000010 + 0x3c) & 8) != 0) {
        ...
        *(undefined4 *)param_1 = 2 /* SuspendFor */;
        *(int *)(param_1 + 8) = unaff_EBX + 0x241e31 /* "We're in fire, get out of here!" */ /* "We're in fire, get out of here!" */ /* "We're in fire, get out of here!" */;
      ...
      if ((iVar5 != 0) ||
        ...
        if (*(float *)(unaff_EBX + 0x20b091 /* "@T	J" */ /* "@T	J" */ /* "@T	J" */) <= fVar10 * fVar10 + fVar12 * fVar12 + fVar11 * fVar11)
        {
          piVar7 = (int *)(**(code **)(*in_stack_0000000c + 0x974 /* CINSNextBot::GetVisionInterface */))(in_stack_0000000c);
          local_34 = 0;
          uVar4 = *(uint *)(in_stack_00000010 + 0x28);
      ...
      (*pcVar2)(piVar7,local_28,3,0x3f800000 /* 1.0f */,0,unaff_EBX + 0x241e51 /* "Looking at attacker who just injured me" */ /* "Looking at attacker who just injured me" */ /* "Looking at attacker who just injured me" */);
    }
  }
LAB_00740fb0:
  *(undefined4 *)param_1 = 0 /* Continue */;
...

{
  ...
  if (((cVar1 == '\0') && (iVar2 = __dynamic_cast(), iVar2 != 0)) &&
     ...
     *(float *)(unaff_EBX + 0x1780b4 /* 0.0f */ /* 0.0f */ /* 0.0f */) <= (float)fVar4 &&
     (float)fVar4 != *(float *)(unaff_EBX + 0x1780b4 /* 0.0f */ /* 0.0f */ /* 0.0f */))) {
    this_00 = this;
    ...
    if (SQRT(fVar5 * fVar5 + fVar7 * fVar7 + fVar6 * fVar6) < (float)fVar4) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x241f1d /* "Fleeing from nade" */ /* "Fleeing from nade" */ /* "Fleeing from nade" */;
      *(undefined4 *)(param_1 + 0xc) = 1;
      return param_1;
    }
  }
  ...
  if ((in_stack_00000010 != (CBaseEntity *)0x0) && (param_3 != (CBaseCombatWeapon *)0x0)) {
      ...
      if (iVar4 == iVar5) {
        ...
        if (*(int *)(in_stack_00000010 + 0x20) != 0) {
          iVar4 = *(int *)(in_stack_00000010 + 0x20) -
                  *(int *)(**(int **)(unaff_EBX + 0x466165 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
        }
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        CINSNextBot::GetViewPosition(local_28);
        (*pcVar1)(piVar3,local_28,3,0x3f400000 /* 0.75f */,0,unaff_EBX + 0x24221f /* "Looking at Weapon Fire" */ /* "Looking at Weapon Fire" */ /* "Looking at Weapon Fire" */);
      }
    }
  }
  *(undefined4 *)param_1 = 0 /* Continue */;
...

{
  ...
  fVar5 = pfVar11[1];
  fVar6 = pfVar11[2];
  piVar7 = (int *)(*(int **)(unaff_EBX + 0x464f81 /* &bot_silhouette_range_close */ /* &bot_silhouette_range_close */ /* &bot_silhouette_range_close */))[7];
  if (piVar7 == *(int **)(unaff_EBX + 0x464f81 /* &bot_silhouette_range_close */ /* &bot_silhouette_range_close */ /* &bot_silhouette_range_close */)) {
  ...
  fVar4 = pfVar11[1];
  fVar5 = pfVar12[2];
  piVar7 = (int *)(*(int **)(unaff_EBX + 0x465049 /* &bot_silhouette_range_far */ /* &bot_silhouette_range_far */ /* &bot_silhouette_range_far */))[7];
  fVar6 = pfVar11[2];
  if (piVar7 == *(int **)(unaff_EBX + 0x465049 /* &bot_silhouette_range_far */ /* &bot_silhouette_range_far */ /* &bot_silhouette_range_far */)) {
    fVar13 = (float)((uint)piVar7 ^ piVar7[0xb]);
    this_00 = extraout_ECX;
  }
  else {
  ...
  if (iVar10 == 0) {
    ...
    if (bVar8) {
      ...
      if (*(float *)(unaff_EBX + 0x1f6635 /* 0.8f */ /* 0.8f */ /* 0.8f */) <= (float)fVar14 &&
          (float)fVar14 != *(float *)(unaff_EBX + 0x1f6635 /* 0.8f */ /* 0.8f */ /* 0.8f */)) {
    ...
    fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                (this_00,(float)param_2,0x3f800000 /* 1.0f */);
    if (*(float *)(unaff_EBX + 0x1e30a1 /* 0.3f */ /* 0.3f */ /* 0.3f */) <= (float)fVar14 &&
        (float)fVar14 != *(float *)(unaff_EBX + 0x1e30a1 /* 0.3f */ /* 0.3f */ /* 0.3f */)) {
    ...
    if (iVar10 == 1) {
      ...
      if (bVar8) {
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000 /* 1.0f */);
        if ((float)fVar14 < *(float *)(unaff_EBX + 0x1e23e1 /* 0.25f */ /* 0.25f */ /* 0.25f */) ||
            (float)fVar14 == *(float *)(unaff_EBX + 0x1e23e1 /* 0.25f */ /* 0.25f */ /* 0.25f */)) {
          return;
        }
        ...
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000 /* 1.0f */);
        if (*(float *)(unaff_EBX + 0x1e30a5 /* 0.6f */ /* 0.6f */ /* 0.6f */) <= (float)fVar14 &&
            (float)fVar14 != *(float *)(unaff_EBX + 0x1e30a5 /* 0.6f */ /* 0.6f */ /* 0.6f */)) {
...
LAB_007418a7:
        ...
        if (bVar9) {
          ...
          if (*(float *)(unaff_EBX + 0x1e7b09 /* 0.35f */ /* 0.35f */ /* 0.35f */) <= (float)fVar14 &&
              (float)fVar14 != *(float *)(unaff_EBX + 0x1e7b09 /* 0.35f */ /* 0.35f */ /* 0.35f */)) {
            RandomFloat(0x40400000 /* 3.0f */,0x40c00000 /* 6.0f */,uVar17);
            (**(code **)(*(int *)param_2 + 0x970 /* CINSNextBot::GetBodyInterface */))(param_2);
            goto LAB_007418a7;
          }
      ...
      if (bVar8) {
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000 /* 1.0f */);
        if ((float)fVar14 < *(float *)(unaff_EBX + 0x1e30ad /* 0.5f */ /* 0.5f */ /* 0.5f */) ||
            (float)fVar14 == *(float *)(unaff_EBX + 0x1e30ad /* 0.5f */ /* 0.5f */ /* 0.5f */)) {
          return;
        }
      }
      else if (bVar9) {
        ...
        fVar14 = (float10)CINSNextBot::TransientlyConsistentRandomValue
                                    (this_00,(float)param_2,0x3f800000 /* 1.0f */);
        if (*(float *)(unaff_EBX + 0x1e30ad /* 0.5f */ /* 0.5f */ /* 0.5f */) <= (float)fVar14 &&
            (float)fVar14 != *(float *)(unaff_EBX + 0x1e30ad /* 0.5f */ /* 0.5f */ /* 0.5f */)) {
          RandomFloat(0x40400000 /* 3.0f */,0x40c00000 /* 6.0f */,uVar17);
          (**(code **)(*(int *)param_2 + 0x970 /* CINSNextBot::GetBodyInterface */))(param_2);
          goto LAB_007418a7;
        ...
        if (iVar3 == 0) {
          ...
          if (cVar2 != '\0') {
            ...
            if (cVar2 == '\0') {
              ...
              CINSNextBot::GetViewPosition(local_28);
              (*pcVar1)(piVar5,local_28,2,0x3f800000 /* 1.0f */,0,unaff_EBX + 0x242694 /* "Looking at footsteps" */ /* "Looking at footsteps" */ /* "Looking at footsteps" */);
              goto LAB_007402c7;
            }
          }
          CINSNextBot::AddInvestigation
    ...
    if (cVar2 != '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        if (iVar3 == iVar5) {
          ...
          if (*(int *)(in_stack_00000010 + 0x20) != 0) {
            iVar3 = *(int *)(in_stack_00000010 + 0x20) -
                    *(int *)(**(int **)(unaff_EBX + 0x46682f /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0x5c) >> 4;
          }
        ...
        if (cVar2 == '\0') {
          ...
          if (iVar3 == 0) {
            ...
            if (cVar2 == '\0') {
              ...
              CINSNextBot::GetViewPosition(local_28);
              (*pcVar1)(piVar4,local_28,2,0x3f800000 /* 1.0f */,0,unaff_EBX + 0x242997 /* "Looking at footsteps in Tac Monitor" */ /* "Looking at footsteps in Tac Monitor" */ /* "Looking at footsteps in Tac Monitor" */);
            }
          }
        }
      }
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4580b3 /* vtable for CINSBotTacticalMonitor+0x8 */ /* vtable for CINSBotTacticalMonitor+0x8 */ /* vtable for CINSBotTacticalMonitor+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x45824b /* vtable for CINSBotTacticalMonitor+0x1a0 */ /* vtable for CINSBotTacticalMonitor+0x1a0 */ /* vtable for CINSBotTacticalMonitor+0x1a0 */;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x457ffa /* vtable for CINSBotTacticalMonitor+0x8 */ /* vtable for CINSBotTacticalMonitor+0x8 */ /* vtable for CINSBotTacticalMonitor+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x458192 /* vtable for CINSBotTacticalMonitor+0x1a0 */ /* vtable for CINSBotTacticalMonitor+0x1a0 */ /* vtable for CINSBotTacticalMonitor+0x1a0 */;
