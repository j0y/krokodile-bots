...

{
  ...
  *in_stack_00000004 = &UNK_0048742d + unaff_EBX;
  in_stack_00000004[1] = unaff_EBX + 0x4875d5 /* vtable for CINSBotAttackLMG+0x1b0 */ /* vtable for CINSBotAttackLMG+0x1b0 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x4dda8b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(puVar1,in_stack_00000004 + 0xf);
  ...
  (*(code *)(unaff_EBX + -0x4dda8b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(puVar2,in_stack_00000004 + 0x12);
...

{
  ...
  pfVar2 = *(float **)(unaff_EBX + 0x498dc2 /* &vec3_origin */ /* &vec3_origin */);
    ...
    if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
        ...
        if (cVar2 != '\0') {
          ...
          iVar3 = unaff_EBX + 0x2727e6 /* "CProne from aiming threat" */ /* "CProne from aiming threat" */;
          goto LAB_0070ded6;
        }
      }
      (**(code **)(*(int *)in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_0000000c);
      ...
      uVar11 = 7;
      iVar3 = unaff_EBX + 0x2727d1 /* "Crouch for stability" */ /* "Crouch for stability" */;
      uVar10 = 3;
      CINSBotBody::SetPosture();
    }
    else {
      (**(code **)(*(int *)in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))(in_stack_0000000c);
      iVar3 = unaff_EBX + 0x2727ba /* "Prone From Suppression" */ /* "Prone From Suppression" */;
LAB_0070ded6:
      uVar12 = 0x3f0ccccd /* 0.55f */;
      uVar11 = 7;
      uVar10 = 1;
    ...
    uVar12 = 0x3f0ccccd /* 0.55f */;
    uVar11 = 7;
    iVar3 = unaff_EBX + 0x272410 /* "Walking At Target" */ /* "Walking At Target" */;
    uVar10 = 0xc;
    CINSBotBody::SetPosture();
  }
...
LAB_0070dde8:
        ...
        uVar10 = 0;
        fVar8 = (float10)CINSNextBot::GetDesiredAttackRange(pCVar4,in_stack_0000000c);
        if (((fVar9 <= (float)fVar8 * *(float *)(unaff_EBX + 0x215de2 /* 0.75f */ /* 0.75f */)) ||
...
LAB_0070de08:
  ...
  fVar8 = (float10)CountdownTimer::Now();
  fVar9 = (float)fVar8 + *(float *)(unaff_EBX + 0x216aaa /* 0.5f */ /* 0.5f */);
...

{
  ...
  return extraout_ECX + 0x2720f2 /* "CINSBotAttackLMG" */ /* "CINSBotAttackLMG" */;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x487293 /* vtable for CINSBotAttackLMG+0x8 */ /* vtable for CINSBotAttackLMG+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x48743b /* vtable for CINSBotAttackLMG+0x1b0 */ /* vtable for CINSBotAttackLMG+0x1b0 */;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48724a /* vtable for CINSBotAttackLMG+0x8 */ /* vtable for CINSBotAttackLMG+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x4873f2 /* vtable for CINSBotAttackLMG+0x1b0 */ /* vtable for CINSBotAttackLMG+0x1b0 */;
