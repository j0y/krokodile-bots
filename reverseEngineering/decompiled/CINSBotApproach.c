...

{
  ...
  *param_2 = &UNK_0049d18d + unaff_EBX;
  param_2[1] = unaff_EBX + 0x49d325 /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */;
  param_2[0xe] = unaff_EBX + 0x430d1d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
  param_2[10] = 0;
  param_2[3] = 0;
  param_2[4] = 0;
  param_2[5] = 0;
  ...
  *(undefined1 *)((int)param_2 + 0x31) = 0;
  ...
  param_2[0xd] = 0;
  param_2[0xf] = 0;
  (*(code *)(unaff_EBX + -0x4c6d2b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(param_2 + 0xe,param_2 + 0xf);
  ...
  param_2[0x16] = 0;
  param_2[0x15] = unaff_EBX + 0x430d1d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_1 */
  (*(code *)(unaff_EBX + -0x4c6d2b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(param_2 + 0x15,param_2 + 0x16);
...

{
  ...
  if (*(float *)((int)param_2 + 0x40) <= (float)fVar5 && /* timer_0.IsElapsed() */
    ...
    fVar5 = (float10)CountdownTimer::Now();
    fVar6 = (float)fVar5 + *(float *)(unaff_EBX + 0x22d6ed /* 0.5f */ /* 0.5f */ /* 0.5f */);
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 == 1) {
        ...
        *(undefined4 *)(param_1 + 4) = 0;
        *(int *)(param_1 + 8) = unaff_EBX + 0x2889f0 /* "Found a threat!" */ /* "Found a threat!" */ /* "Found a threat!" */;
        return param_1;
      }
    }
...

{
  ...
  return extraout_ECX + 0x295681 /* "Approach" */ /* "Approach" */ /* "Approach" */;
}
...

{
  ...
  if (iVar2 != 0) {
    ...
    cVar4 = ((float)fVar5 < *(float *)(unaff_EBX + 0x2550a4 /* 2000.0f */ /* 2000.0f */ /* 2000.0f */) ||
            (float)fVar5 == *(float *)(unaff_EBX + 0x2550a4 /* 2000.0f */ /* 2000.0f */ /* 2000.0f */)) + '\x01';
  }
  return cVar4;
}
...

{
  ...
  *param_1 = 3;
  param_1[1] = 0;
  param_1[2] = extraout_ECX + 0x28924f /* "Failed pathing to patrol target." */ /* "Failed pathing to patrol target." */ /* "Failed pathing to patrol target." */;
  param_1[3] = 3;
  return;
}
...

{
  ...
  *(undefined1 *)((int)piVar2 + 0x31) = 0;
  piVar2[0xb] = 0;
  piVar2[0xd] = 0;
  iVar1 = *(int *)(unaff_EBX + 0x4afcbd /* &vtable for CINSBotStuck */ /* &vtable for CINSBotStuck */ /* &vtable for CINSBotStuck */);
  piVar2[0xf] = 0;
  piVar2[1] = iVar1 + 0x198;
  *piVar2 = iVar1 + 8;
  piVar2[0xe] = unaff_EBX + 0x4314bd /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
  ...
  piVar2[0x16] = 0;
  *(int *)(param_1 + 8) = unaff_EBX + 0x288d56 /* "I'm Stuck" */ /* "I'm Stuck" */ /* "I'm Stuck" */;
  piVar2[0x17] = 0;
  piVar2[0x18] = 0;
  piVar2[0x19] = 0;
  piVar2[0x1a] = 0;
...

{
  ...
  *(undefined4 *)param_1 = 3 /* Done */;
  *(undefined4 *)(param_1 + 4) = 0;
  *(int *)(param_1 + 8) = extraout_ECX + 0x288f2f /* "Received the order to attack" */ /* "Received the order to attack" */ /* "Received the order to attack" */;
...

{
  ...
  if ((in_stack_00000010 != 0) && (param_3 != (CNavArea *)0x0)) {
    ...
    if ((*(char *)(iVar2 + 0x129) != '\0') &&
        ...
        *(float *)(unaff_EBX + 0x22c7d8 /* 0.25f */ /* 0.25f */ /* 0.25f */) < *(float *)(unaff_EBX + 0x231f00 /* 0.35f */ /* 0.35f */ /* 0.35f */))) {
        ...
        if (iVar2 != 0) {
          ...
          if (cVar1 != '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              fVar4 = (float)fVar3 + *(float *)(unaff_EBX + 0x1c1cc8 /* 3.0f */ /* 3.0f */ /* 3.0f */);
...

{
  ...
  if (iVar2 != 0) {
    ...
    (**(code **)(*piVar3 + 0x18))(piVar3);
    fVar5 = (float10)(*pcVar1)();
    cVar4 = (*(float *)(unaff_EBX + 0x22e394 /* 400.0f */ /* 400.0f */ /* 400.0f */) <= (float)fVar5) + '\x01';
  }
  return cVar4;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x49cf63 /* vtable for CINSBotApproach+0x8 */ /* vtable for CINSBotApproach+0x8 */ /* vtable for CINSBotApproach+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x49d0fb /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x4afab3 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x49c4ca /* vtable for CINSBotApproach+0x8 */ /* vtable for CINSBotApproach+0x8 */ /* vtable for CINSBotApproach+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x49c662 /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */ /* vtable for CINSBotApproach+0x1a0 */;
