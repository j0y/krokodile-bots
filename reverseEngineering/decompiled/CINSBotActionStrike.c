...

{
  ...
  *in_stack_00000004 = extraout_ECX + 0x45e3c3 /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  in_stack_00000004[1] = extraout_ECX + 0x45e553 /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */;
  return;
}
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 == 1) {
      ...
      *(int *)(param_1 + 8) = unaff_EBX + 0x244372 /* "Attacking nearby threats" */ /* "Attacking nearby threats" */ /* "Attacking nearby threats" */;
      return param_1;
    }
  }
  ...
  if (cVar1 == '\0') {
    ...
    if (iVar3 == iVar5) {
      ...
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2464bd /* "Defending a cache" */ /* "Defending a cache" */ /* "Defending a cache" */;
    }
    else {
      ...
      *(undefined4 *)((int)param_2 + 0x28) = 0;
      *(undefined4 *)((int)param_2 + 0x2c) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x2464cf /* "Attacking a cache" */ /* "Attacking a cache" */ /* "Attacking a cache" */;
    }
  }
  else {
    ...
    *(undefined4 *)((int)param_2 + 0x28) = 0;
    *(undefined4 *)((int)param_2 + 0x2c) = 0;
    *(int *)(param_1 + 8) = unaff_EBX + 0x245f03 /* "I have an investigation!" */ /* "I have an investigation!" */ /* "I have an investigation!" */;
  }
  return param_1;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  return extraout_ECX + 0x1f65c5 /* "Strike" */ /* "Strike" */ /* "Strike" */;
}
...

{
  ...
  local_3c[2] = 0;
  local_30 = (int *)0x0;
  iVar2 = **(int **)(unaff_EBX + 0x46ac71 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
  local_2c = 0;
  local_20[0] = 0;
  this = extraout_ECX;
  if (0 < *(int *)(iVar2 + 0x37c)) {
    do {
      ...
      this = *(CINSRules **)(unaff_EBX + 0x46ac71 /* &g_pObjectiveResource */ /* &g_pObjectiveResource */ /* &g_pObjectiveResource */);
      iVar2 = *(int *)this;
...
LAB_0073c180:
  ...
  if ((-1 < local_3c[2]) && (local_3c[0] != 0)) {
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x46a7cd /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
              ((int *)**(undefined4 **)(unaff_EBX + 0x46a7cd /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_3c[0]);
  }
  return uVar3;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x45deb3 /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x45e043 /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x46ac43 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x45de6a /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */ /* vtable for CINSBotActionStrike+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x45dffa /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */ /* vtable for CINSBotActionStrike+0x198 */;
