...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x48c60d /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x48c7b5 /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */;
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x4d828b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar1,in_stack_00000004 + 0xf);
  ...
  (*(code *)(unaff_EBX + -0x4d828b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(in_stack_00000004 + 0x12,in_stack_00000004 + 0x13);
...

{
  ...
  if (piVar3 != (int *)0x0) {
    ...
    CINSBotBody::SetPosture(pCVar4,pCVar4,3,8,0x3f800000 /* 1.0f */,unaff_EBX + 0x277999 /* "Crouching in fire from cover start" */ /* "Crouching in fire from cover start" */ /* "Crouching in fire from cover start" */);
    ...
    (*pcVar2)(piVar5,uVar6,3,0x3f800000 /* 1.0f */,0,unaff_EBX + 0x2779bd /* "Aiming towards enemy in fire from cover start" */ /* "Aiming towards enemy in fire from cover start" */ /* "Aiming towards enemy in fire from cover start" */);
  ...
  if (*(float *)((int)param_2 + 0x50) <= (float)fVar19 &&
    ...
    if (cVar5 == '\0') {
      ...
      if (cVar5 != '\0') {
        ...
        puVar13 = puVar12 + 1;
        iVar7 = unaff_EBX + 0x41ea8d /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */;
        uVar10 = *puVar11;
        uVar1 = puVar11[1];
        uVar2 = puVar11[2];
        puVar12[1] = iVar7;
        pcVar4 = (code *)(unaff_EBX + -0x4d8fbb /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */);
        puVar12[2] = 0;
        ...
        puVar12[6] = uVar2;
        fVar19 = (float10)CountdownTimer::Now();
        fVar20 = (float)fVar19 + *(float *)(unaff_EBX + 0x21aa85 /* 10.0f */ /* 10.0f */ /* 10.0f */);
        ...
        *(undefined1 *)((int)piVar6 + 0x31) = 0;
        piVar6[0xb] = 0;
        piVar6[0xd] = 0;
        iVar15 = *(int *)(unaff_EBX + 0x49d2cd /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */ /* &vtable for CINSBotReload */);
        piVar6[0xf] = 0;
        ...
        *(int *)(param_1 + 8) = unaff_EBX + 0x276a11 /* "Need to Reload" */ /* "Need to Reload" */ /* "Need to Reload" */;
        return param_1;
      }
      if (*(char *)((int)param_2 + 0x54) != '\0') {
        ...
        piVar21 = (int *)0x3;
        (*pcVar4)(piVar8,uVar10,3,(float)fVar19,0,unaff_EBX + 0x276aad /* "Aiming towards enemy in fire from cover" */ /* "Aiming towards enemy in fire from cover" */ /* "Aiming towards enemy in fire from cover" */);
    ...
    fVar20 = (float)fVar19 - *(float *)(unaff_EBX + 0x1af3f1 /* 0.1f */ /* 0.1f */ /* 0.1f */);
    fVar19 = (float10)CountdownTimer::Now();
...
LAB_00709806:
      *(undefined4 *)param_1 = 3 /* Done */;
      *(undefined4 *)(param_1 + 4) = 0;
      *(int *)(param_1 + 8) = unaff_EBX + 0x276854 /* "Should Not Attack This Threat" */ /* "Should Not Attack This Threat" */ /* "Should Not Attack This Threat" */;
      return param_1;
    }
      ...
      *(undefined4 *)((int)param_2 + 0x58) = 0xbf800000 /* -1.0f */;
      ...
      if (*(float *)((int)param_2 + 0x58) < 0.0) {
        *(undefined4 *)((int)param_2 + 0x58) =
             *(undefined4 *)(**(int **)(unaff_EBX + 0x49d175 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc);
      }
      else {
        fVar20 = *(float *)(**(int **)(unaff_EBX + 0x49d175 /* &gpGlobals */ /* &gpGlobals */ /* &gpGlobals */) + 0xc) -
                 *(float *)((int)param_2 + 0x58);
        if (*(float *)(unaff_EBX + 0x21c625 /* 6.0f */ /* 6.0f */ /* 6.0f */) <= fVar20 && fVar20 != *(float *)(unaff_EBX + 0x21c625 /* 6.0f */ /* 6.0f */ /* 6.0f */)
           ) {
          *(undefined4 *)param_1 = 3 /* Done */;
          *(undefined4 *)(param_1 + 4) = 0;
    ...
    *(undefined1 *)((int)param_2 + 0x54) = 1;
    ...
    if (((*(char *)((int)param_2 + 0x61) != '\0') && (*(char *)((int)param_2 + 0x62) != '\0')) &&
      ...
      *(void **)(param_1 + 4) = pvVar16;
      *(int *)(param_1 + 8) = unaff_EBX + 0x276a3d /* "we have shitty cover" */ /* "we have shitty cover" */ /* "we have shitty cover" */;
      return param_1;
    }
    fVar19 = (float10)CountdownTimer::Now();
  ...
  CFmtStrN<256,false>::CFmtStrN(this_02,local_13c,unaff_EBX + 0x276a52 /* "AFC:" */ /* "AFC:" */ /* "AFC:" */);
  if (iVar7 == 9) {
    pCVar17 = (CINSNextBot *)(unaff_EBX + 0x2769dc /* "Trying Lean Left," */ /* "Trying Lean Left," */ /* "Trying Lean Left," */);
    ...
    pCVar17 = (CINSNextBot *)(unaff_EBX + 0x2769ee /* "Trying Lean Right," */ /* "Trying Lean Right," */ /* "Trying Lean Right," */);
    local_140 = local_137 + local_34;
    if (local_140 < local_38) {
      do {
        CVar3 = *pCVar17;
...
LAB_007099c4:
  if (*(char *)((int)param_2 + 0x61) != '\0') {
    pCVar17 = (CINSNextBot *)(unaff_EBX + 0x276a01 /* "ST," */ /* "ST," */ /* "ST," */);
    local_140 = local_137 + local_34;
    if (local_140 < local_38) {
      do {
        CVar3 = *pCVar17;
...
LAB_00709d4d:
  ...
  if (*(char *)((int)param_2 + 99) != '\0') {
    pCVar17 = (CINSNextBot *)(unaff_EBX + 0x276a05 /* "LL," */ /* "LL," */ /* "LL," */);
    local_140 = local_137 + local_34;
    if (local_140 < local_38) {
      do {
        CVar3 = *pCVar17;
...
LAB_00709cdd:
  ...
  if (*(char *)((int)param_2 + 100) != '\0') {
    pCVar17 = (CINSNextBot *)(unaff_EBX + 0x276a09 /* "RL," */ /* "RL," */ /* "RL," */);
    local_140 = local_137 + local_34;
    if (local_140 < local_38) {
      do {
        CVar3 = *pCVar17;
...
LAB_00709c6d:
  ...
  if (*(char *)((int)param_2 + 0x62) != '\0') {
    ...
    pCVar9 = (CINSNextBot *)(unaff_EBX + 0x276a0d /* "CR," */ /* "CR," */ /* "CR," */);
    pCVar17 = local_38;
    if (pCVar18 < local_38) {
      do {
        CVar3 = *pCVar9;
...

{
  ...
  return extraout_ECX + 0x275bf2 /* "AttackFromCover" */ /* "AttackFromCover" */ /* "AttackFromCover" */;
}
...

{
  ...
  if (pVVar2 != (Vector *)0x0) {
    ...
    fVar12 = *(float *)(unaff_EBX + 0x25552d /* 69.0f */ /* 69.0f */ /* 69.0f */) + *(float *)(pVVar2 + 0x210);
    ...
    local_6c[0] = unaff_EBX + 0x48ba45 /* vtable for INSVisionTraceFilterIgnorePlayers+0x8 */ /* vtable for INSVisionTraceFilterIgnorePlayers+0x8 */ /* vtable for INSVisionTraceFilterIgnorePlayers+0x8 */;
    local_5c = 0;
    local_58 = 0;
    ...
    local_b8 = fVar1;
    local_b4 = fVar12;
    (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x49dc2d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */) + 0x14))
              ((int *)**(undefined4 **)(unaff_EBX + 0x49dc2d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */),&local_bc,0x2006241,local_6c,local_11c
              );
    ...
    cVar3 = local_e5;
    if (*(float *)(unaff_EBX + 0x1affc9 /* 1.0f */ /* 1.0f */ /* 1.0f */) <= local_f0) {
      cVar3 = '\x01';
    }
    *(char *)(in_stack_00000004 + 0x61) = cVar3;
    ...
    local_b4 = *(float *)(unaff_EBX + 0x255535 /* 37.0f */ /* 37.0f */ /* 37.0f */) + *(float *)(pVVar2 + 0x210);
    local_7c = 0;
    ...
    *(char *)(in_stack_00000004 + 0x62) = cVar3;
    ...
    local_ac = local_40 - local_bc;
    local_a8 = local_3c - local_b8;
    local_b4 = *(float *)(unaff_EBX + 0x21f7e9 /* 12.0f */ /* 12.0f */ /* 12.0f */) + *(float *)(pVVar2 + 0x210);
    local_7c = 0;
    local_a4 = local_38 - local_b4;
    local_78 = 1;
    local_84 = 0;
    ...
    if (((*(char *)(in_stack_00000004 + 0x61) == '\0') ||
      ...
      if (cVar3 == '\0') {
        ...
        *(undefined1 *)(in_stack_00000004 + 100) = 0;
        ...
        local_78 = 1;
        fVar10 = *(float *)(unaff_EBX + 0x22f2cd /* 32.0f */ /* 32.0f */ /* 32.0f */);
        local_7c = 0;
        ...
        local_20 = fVar10;
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x49dc2d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */) + 0x14))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x49dc2d /* &enginetrace */ /* &enginetrace */ /* &enginetrace */),&local_bc,0x2006241,local_6c,
                   local_11c);
        iVar5 = (**(code **)(*piVar4 + 0x40 /* CBaseEntity::ComputeWorldSpaceSurroundingBox */))(piVar4);
        if (iVar5 != 0) {
          iVar5 = (**(code **)(*piVar4 + 0x40 /* CBaseEntity::ComputeWorldSpaceSurroundingBox */))(piVar4);
        ...
        local_78 = 1;
        local_7c = 0;
        fVar9 = *(float *)(unaff_EBX + 0x2575bd /* CSWTCH.200+0xb4 */ /* CSWTCH.200+0xb4 */ /* CSWTCH.200+0xb4 */);
      ...
      local_6c[0] = unaff_EBX + 0x48ba2d /* vtable for INSVisionTraceFilter+0x8 */ /* vtable for INSVisionTraceFilter+0x8 */ /* vtable for INSVisionTraceFilter+0x8 */;
      local_50 = 0;
      if ((-1 < local_54) && (local_5c != 0)) {
        (**(code **)(*(int *)**(undefined4 **)(unaff_EBX + 0x49dd2d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */) + 8))
                  ((int *)**(undefined4 **)(unaff_EBX + 0x49dd2d /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */ /* &GCSDK::GetPchTempTextBuffer */),local_5c);
      }
    }
    else {
      local_6c[0] = unaff_EBX + 0x48ba2d /* vtable for INSVisionTraceFilter+0x8 */ /* vtable for INSVisionTraceFilter+0x8 */ /* vtable for INSVisionTraceFilter+0x8 */;
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x48aad3 /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x48ac7b /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */;
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48aa8a /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */ /* vtable for CINSBotAttackFromCover+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x48ac32 /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */ /* vtable for CINSBotAttackFromCover+0x1b0 */;
