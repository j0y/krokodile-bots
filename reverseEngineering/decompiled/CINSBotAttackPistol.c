...

{
  ...
  *in_stack_00000004 = unaff_EBX + 0x48565d /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x485805 /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */;
  piVar1 = in_stack_00000004 + 0xe;
  in_stack_00000004[0xe] = unaff_EBX + 0x417ded /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_0 */
  ...
  *(undefined1 *)((int)in_stack_00000004 + 0x31) = 0;
  ...
  (*(code *)(unaff_EBX + -0x4dfc5b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar1,in_stack_00000004 + 0xf);
  ...
  in_stack_00000004[0x11] = unaff_EBX + 0x417ded /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */ /* vtable for CountdownTimer+0x8 */; /* CountdownTimer timer_1 */
  (*(code *)(unaff_EBX + -0x4dfc5b /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */ /* CountdownTimer::NetworkStateChanged */))(piVar2,in_stack_00000004 + 0x12);
...

{
  ...
  if (in_stack_00000008 != (CINSWeapon *)0x0) {
    ...
    if (piVar4 != (int *)0x0) {
      ...
      pfVar1 = *(float **)(unaff_EBX + 0x496be8 /* &vec3_origin */ /* &vec3_origin */ /* &vec3_origin */);
...

{
  ...
  if (in_stack_0000000c != (CINSWeapon *)0x0) {
    ...
    iVar4 = (**(code **)(**(int **)(unaff_EBX + 0x496e58 /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */) + 0x40))
                      (*(int **)(unaff_EBX + 0x496e58 /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */ /* &ins_bot_pistols_only */),uVar7,uVar8);
        ...
        if (fVar2 < (float)fVar6) {
          ...
          if (cVar1 == '\0') {
            ...
            if (cVar1 == '\0') {
              ...
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x27026a /* "Walking At Target" */ /* "Walking At Target" */ /* "Walking At Target" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */ /* 0.5f */);
            }
            else {
              (**(code **)(*(int *)in_stack_0000000c + 0x970 /* CINSNextBot::GetBodyInterface */))();
              uVar8 = 0x3f0ccccd /* 0.55f */;
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x270236 /* "Crouching From Suppression" */ /* "Crouching From Suppression" */ /* "Crouching From Suppression" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */ /* 0.5f */);
            }
          }
            ...
            cVar1 = (**(code **)(*piVar5 + 0x124 /* CINSBotBody::IsActualPosture */))(piVar5,0xd);
            if (cVar1 == '\0') {
              ...
              if ((float)fVar6 <= local_24) {
                ...
                uVar8 = 0x3f0ccccd /* 0.55f */;
                uVar7 = 7;
                iVar4 = unaff_EBX + 0x27021c /* "Crawling From Suppression" */ /* "Crawling From Suppression" */ /* "Crawling From Suppression" */;
                CINSBotBody::SetPosture();
              }
            }
            else {
              ...
              uVar8 = 0x3f0ccccd /* 0.55f */;
              uVar7 = 7;
              iVar4 = unaff_EBX + 0x270251 /* "Walking From Suppression" */ /* "Walking From Suppression" */ /* "Walking From Suppression" */;
              CINSBotBody::SetPosture();
              local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */ /* 0.5f */);
            }
          }
          ...
          uVar8 = 0x3f0ccccd /* 0.55f */;
          uVar7 = 7;
          iVar4 = unaff_EBX + 0x27027c /* "Sprinting At Target" */ /* "Sprinting At Target" */ /* "Sprinting At Target" */;
          CINSBotBody::SetPosture();
          local_24 = *(float *)(unaff_EBX + 0x214904 /* 0.5f */ /* 0.5f */ /* 0.5f */);
        }
        piVar5 = (int *)(**(code **)(*(int *)in_stack_0000000c + 0x97c /* CINSNextBot::GetIntentionInterface */))();
        iVar4 = (**(code **)(*piVar5 + 0xec /* IIntention::ShouldIronsight */))(piVar5,in_stack_0000000c + 0x2060,uVar7,uVar8,iVar4);
        if (iVar4 != 0) {
...

{
  ...
  if (piVar2 != (int *)0x0) {
    ...
    cVar3 = (*(float *)(unaff_EBX + 0x215ca8 /* 360.0f */ /* 360.0f */ /* 360.0f */) <= (float)fVar4) * '\x02';
  }
  return cVar3;
}
...

{
  ...
  __i686_get_pc_thunk_cx();
  *in_stack_00000004 = extraout_ECX + 0x4854c3 /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */;
  in_stack_00000004[1] = extraout_ECX + 0x48566b /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */;
  Action<CINSNextBot>::~Action((Action<CINSNextBot> *)(extraout_ECX + 0x496c13 /* &_DYNAMIC */ /* &_DYNAMIC */ /* &_DYNAMIC */));
  return;
}
...

{
  ...
  __i686_get_pc_thunk_bx();
  *in_stack_00000004 = unaff_EBX + 0x48547a /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */ /* vtable for CINSBotAttackPistol+0x8 */;
  in_stack_00000004[1] = unaff_EBX + 0x485622 /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */ /* vtable for CINSBotAttackPistol+0x1b0 */;
